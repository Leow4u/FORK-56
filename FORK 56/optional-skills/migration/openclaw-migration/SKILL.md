...
```bash
python ~/.work4you/skills/migration/openclaw-migration/scripts/openclaw_to_work4you.py
```

When using the terminal tool, prefer an absolute invocation pattern such as:

```json
{"command":"python /home/USER/.work4you/skills/migration/openclaw-migration/scripts/openclaw_to_work4you.py","workdir":"/home/USER"}
```

Dry run with the user-data preset:

```bash
python ~/.work4you/skills/migration/openclaw-migration/scripts/openclaw_to_work4you.py --preset user-data
```

Execute a user-data migration:

```bash
python ~/.work4you/skills/migration/openclaw-migration/scripts/openclaw_to_work4you.py --execute --preset user-data --skill-conflict skip
```

Execute a full compatible migration:

```bash
python ~/.work4you/skills/migration/openclaw-migration/scripts/openclaw_to_work4you.py --execute --preset full --migrate-secrets --skill-conflict skip
```

Execute with workspace instructions included:

```bash
python ~/.work4you/skills/migration/openclaw-migration/scripts/openclaw_to_work4you.py --execute --preset user-data --skill-conflict rename --workspace-target "/absolute/workspace/path"
```
