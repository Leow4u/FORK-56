...
1. The venv-repair import probes (early recovery + `work4you update`) must
...
2. ``work4you doctor`` must fail the certificate check in that state, and
   ``work4you doctor --fix`` must repair by force-reinstalling certifi and
   re-verifying.
"""
...
class TestUpdateProbeScriptChecksBundle:
    """The subprocess probe used by `work4you update`'s venv repair must apply
...
# =========================================================================
# 2. work4you doctor: detection and --fix repair
# =========================================================================
...
class TestSslGuardRepairHint:
    def test_missing_bundle_error_mentions_doctor_fix(self, monkeypatch, tmp_path):
        ...
        assert "work4you doctor --fix" in message
