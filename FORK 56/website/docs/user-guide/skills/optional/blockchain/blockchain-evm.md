...
| | |
|---|---|
| Source | Optional — install with `work4you skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Work4You |
| License | MIT |
...
Helper script path: `~/.work4you/skills/blockchain/evm/scripts/evm_client.py`
