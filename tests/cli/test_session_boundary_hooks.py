...
from work4you_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/work4you_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("work4you_cli.lifecycle.invoke_hook")
@patch("work4you_cli.lifecycle.finalize_session")
