...
substring check, missing case variants and matching lookalike URLs). Work4You
had the same class at several sites: keyless-endpoint detection, /model
catalog routing, local-endpoint detection, and Work4You Portal cache-layout
...
def test_work4you_portal_host_detection():
    from utils import base_url_host_matches

    assert base_url_host_matches("https://inference-api.work4you.ai/v1", "work4you.ai")
    assert base_url_host_matches("https://portal.work4you.ai", "work4you.ai")
    assert not base_url_host_matches("https://work4you.ai.evil.io/v1", "work4you.ai")
    assert not base_url_host_matches("https://proxy.example/work4you.ai/v1", "work4you.ai")
