...
| | |
|---|---|
| 来源 | 可选 — 通过 `work4you skills install official/blockchain/evm` 安装 |
| 路径 | `optional-skills/blockchain/evm` |
| 版本 | `1.0.0` |
| 作者 | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Work4You |
| 许可证 | MIT |
...
辅助脚本路径：`~/.work4you/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.work4you/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.work4you/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.work4you/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```