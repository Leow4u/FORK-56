...
// (#73044). Exercises the REAL work4you + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/work4you')
...
const conn = (over: Partial<Work4YouConnection> = {}): Work4YouConnection =>
  ({
    authMode: 'oauth',
