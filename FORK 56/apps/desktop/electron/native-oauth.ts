 ...
 * Apps) login to a gated Work4You gateway: system-browser + loopback redirect +
 ...
 * upstream IDP (Work4You Portal) issues a per-gateway-instance client_id and only
...
// work4you_cli/web_server.py status handler.
