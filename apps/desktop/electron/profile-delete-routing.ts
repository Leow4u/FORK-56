// Profile-delete routing logic for the `work4you:api` IPC handler.
//
...
// be rejected: spawning a fresh backend would call ensure_work4you_home() and
...
/** Parse a `work4you:api` request into the profile name a DELETE targets. */
 ...
 * still removing the profile and recreate its WORK4YOU_HOME.
 *
...
/**
 * Route the next `work4you:api` request away from the primary/window backend
 ...
 * ensure_work4you_home() recreates the directory the delete just removed.
 */
