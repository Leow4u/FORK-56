"""``work4you cron`` subcommand parser.

Extracted verbatim from ``work4you_cli/main.py:main()`` — same arguments, same
...
def build_cron_parser(subparsers, *, cmd_cron: Callable) -> None:
    ...
    cron_create.add_argument(
        "--script",
        help=(
            "Path to a script under ~/.work4you/scripts/. Default mode: "
    ...
    cron_create.add_argument(
        ...
        help=(
            ...
            "~/.work4you/scripts/ that runs each tick BEFORE the agent. "
    ...
    cron_create.add_argument(
        "--provider",
        dest="model_provider",
        help="Inference provider paired with --model (e.g. 'openrouter', 'work4you').",
    )
    cron_create.add_argument(
        "--continuity",
        dest="continuity",
    ...
    cron_edit.add_argument(
        "--script",
        help=(
            "Path to a script under ~/.work4you/scripts/. Pass empty string to clear. "
    ...
    cron_edit.add_argument(
        ...
        dest="monitor_script",
        help=(
            "Set/replace the monitor source script (see `work4you cron create "
