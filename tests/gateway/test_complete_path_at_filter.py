...
def _reset_fuzzy_cache(monkeypatch):
    ...
    # via _load_cfg(), which resolves through _work4you_home captured at module
    # import time — before the per-test WORK4YOU_HOME redirect applies. When the
