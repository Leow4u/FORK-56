...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Work4You\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (work4you-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "work4you@work4you.ai",
    "work4you-audit@example.com",
    "nousbot@work4you.ai",
    "work4you@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
