"""Tests for the work4you-tools-as-MCP server module surface.
...
from agent.transports.work4you_tools_mcp_server import (
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import work4you_tools_mcp_server as m
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.work4you_tools_mcp_server as m
