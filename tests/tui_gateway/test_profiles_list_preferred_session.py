...
conversation and the click lands in another (Leow4u/FORK-56#88200).
...
def home(tmp_path, monkeypatch):
    """Temp WORK4YOU_HOME with the default profile plus one named profile."""
    h = tmp_path / ".work4you"
    (h / "profiles" / "ops").mkdir(parents=True)
    monkeypatch.setenv("WORK4YOU_HOME", str(h))
    return h
