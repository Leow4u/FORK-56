...
# tree generates llms.txt — the index every LLM (Work4You included, via the
# work4you skill) reads to learn what Work4You can do — and
...
def _py_test_only(p: str) -> bool:
    ...
    Product jobs (Desktop E2E's ``work4you serve`` backend, the Docker image)
