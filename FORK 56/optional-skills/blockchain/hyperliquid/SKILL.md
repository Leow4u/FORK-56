...
```bash
python ~/.work4you/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.work4you/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.work4you/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
