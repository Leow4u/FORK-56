...
| | |
|---|---|
| Source | Optional — install with `work4you skills install official/security/1password` |
| Path | `optional-skills/security/1password` |
| Version | `1.0.0` |
| Author | arceus77-7, enhanced by Work4You |
| License | MIT |
...
Set `OP_SERVICE_ACCOUNT_TOKEN` in `${WORK4YOU_HOME:-~/.work4you}/.env` (the skill will prompt for this on first load).
