...
def isolated_home(monkeypatch):
    """Temp WORK4YOU_HOME with config + clean credential env vars."""
    test_home = tempfile.mkdtemp(prefix="work4you_test_31179_")
    work4you_home = os.path.join(test_home, ".work4you")
    os.makedirs(work4you_home)
...
def _fresh_modules():
    """Drop cached work4you modules so each test reloads against current env."""
    _drop_reload_targets()
