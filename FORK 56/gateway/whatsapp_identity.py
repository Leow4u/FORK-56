...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$WORK4YOU_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_work4you_dir("platforms/whatsapp/session", "whatsapp/session")
