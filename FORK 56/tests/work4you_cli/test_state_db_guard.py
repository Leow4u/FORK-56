...
from work4you_cli.backup import copy_db_and_verify, verify_sqlite_integrity
...
class TestPreUpdateBackupIntegrityGuard:
    ...
    WORK4YOU_HOME whose state.db is corrupted mid-flight (#68474)."""
    ...
    def work4you_home(self, tmp_path, monkeypatch):
        ...
        for mod in list(sys.modules.keys()):
            if mod.startswith("work4you_cli.config") or mod == "work4you_constants":
                del sys.modules[mod]
        return root

    def test_healthy_db_stays_quiet(self, work4you_home, capsys):
    ...
    def test_zeroed_db_after_snapshot_is_loud(self, work4you_home, capsys, monkeypatch):
