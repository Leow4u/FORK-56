...
def test_import_loads_env_from_work4you_home(tmp_path, monkeypatch):
    home = tmp_path / ".work4you"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-work4you-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-work4you-home"
