...
def test_frontmatter_required_fields():
    ...
    work4you = fm["metadata"]["work4you"]
    assert work4you["tags"]
    assert "related_skills" in work4you
...
def test_author_credits_human_first():
    fm, _ = _frontmatter_and_body()
    assert not fm["author"].startswith("Work4You"), "human contributor must be credited first"
...
def test_related_skills_resolve_in_repo():
    ...
    for name in fm["metadata"]["work4you"]["related_skills"]:
