...
def _clamp_responses_call_id(call_id: str) -> str:
    ...
    component the built-in ``work4you-tools`` server already overflows 64 chars,
...
# output items.  Work4You injects xAI's native ``web_search`` for the xAI
...
# server-assigned base64 blobs that can run 400+ chars, while Work4You-minted
...
def _chat_messages_to_responses_input(
    ...
    *,
    ...
    explicitly relies on Work4You threading encrypted reasoning back across
    ...
    ``convert_messages``). Dropping the checkpoint costs nothing: Work4You'
                ...
                if isinstance(codex_reasoning, list):
                    for ri in codex_reasoning:
                        if isinstance(ri, dict) and ri.get("encrypted_content"):
                            ...
                            # it is a Work4You-side metadata key and not part
...
def _normalize_codex_response(
    ...
    *,
    ...
    if tool_calls:
        ...
        # See https://github.com/Leow4u/FORK-56/issues/64434
