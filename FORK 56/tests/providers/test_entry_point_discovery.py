"""Tests for pip entry-point provider discovery (work4you.plugins group).

Verifies that ``providers/__init__.py`` imports provider plugins exposed via a
distribution's ``work4you.plugins`` entry point, supporting both a
