...
batch (tracker: [#77056](https://github.com/Leow4u/FORK-56/issues/77056)).
...
- **Two arms, one variable.** `baseline` and `fixes` runs differ ONLY by
  ...
  Work4You home, same model, same tasks, same reps.
...
1. Create a dedicated Work4You home with credentials for the models under test:
   ...
   WORK4YOU_HOME=$ABEVAL_HOME work4you plugins enable observability/nemo_relay
   ```
