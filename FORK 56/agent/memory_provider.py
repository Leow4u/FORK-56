...
Optional hooks (override to opt in):
  ...
  backup_paths() -> list[str]            — extra on-disk paths to include in `work4you backup`
"""
...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - work4you_home (str): The active WORK4YOU_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.work4you``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "work4you").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'work4you memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], work4you_home: str) -> None:
        ...
        Called by 'work4you memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``work4you_home`` is the active WORK4YOU_HOME directory path.
    ...
    def backup_paths(self) -> List[str]:
        """Return extra on-disk paths this provider stores OUTSIDE WORK4YOU_HOME.

        ``work4you backup`` only walks WORK4YOU_HOME, so any provider state kept
        ...
        of the archive, and ``work4you import`` restores them to their original
