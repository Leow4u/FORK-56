...
// over a solid Work4You-blue well and blends into it. This blue well is the ONLY place
// Work4You blue appears in the billing page — everything else stays on the app's own tokens.
const WORK4YOU_BLUE = '#0000f2'
...
/**
 * Small rounded thumbnail (~40px) rendering the tier art over a Work4You-blue well.
...
export function TierArt({ className, name, size = 40 }: { className?: string; name?: null | string; size?: number }) {
  ...
  return (
    <div
      ...
      style={{ background: WORK4YOU_BLUE, height: size, width: size }}
    >
      <img
        alt=""
