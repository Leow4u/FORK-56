...
from work4you_cli.dashboard_auth import clear_providers, list_providers
from work4you_cli.plugins import PluginManager, discover_plugins
...
class TestBasicProviderLoadsAfterUnblock:
    def test_disabled_basic_blocks_registration(self, work4you_home, monkeypatch):
    ...
    def test_unblock_then_rediscover_registers_provider(
        self, work4you_home, monkeypatch,
    ):
        password_hash = basic_plugin.hash_password("hunter2")
        cfg = {
            "dashboard": {
        ...
        _write_config(work4you_home, cfg)
