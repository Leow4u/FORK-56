...
When running Work4You inside Docker, the default `network_mode: host` gives the
...
The Work4You [SECURITY.md](../../SECURITY.md) §2 defines the trust model. The
...
#
# Usage:
#   WORK4YOU_UID=$(id -u) WORK4YOU_GID=$(id -g) docker compose up -d
#
...
services:
  gateway:
    ...
    environment:
      ...
      - NO_PROXY=work4you,work4you-dashboard,localhost
...
docker compose exec gateway \
  curl -sf --max-time 5 http://work4you-dashboard:9119/health && echo "OK: internal reachable" || echo "FAIL"
...
- [SECURITY.md](../../SECURITY.md) — Work4You trust model and vulnerability reporting
