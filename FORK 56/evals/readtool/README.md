...
benchmarked ten harnesses on hostile-file handling — and whose Work4You column
...
Every task runs the full Work4You agent (file + terminal + search toolsets)
...
Rules of engagement (from work4youbench discipline):
