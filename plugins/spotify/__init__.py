...
``_check_spotify_available()`` — when the user has not run ``work4you auth
spotify``, the tools remain registered (so they appear in ``work4you
...
The Spotify auth flow (``work4you auth spotify``), CLI plumbing, and docs
