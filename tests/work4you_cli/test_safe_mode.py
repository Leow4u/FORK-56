"""Tests for `work4you chat --safe-mode` isolation."""
...
_VARS = ("WORK4YOU_SAFE_MODE", "WORK4YOU_IGNORE_USER_CONFIG", "WORK4YOU_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["WORK4YOU_SAFE_MODE"] == "1"
        assert os.environ["WORK4YOU_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["WORK4YOU_IGNORE_RULES"] == "1"
        return True
