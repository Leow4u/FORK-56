...
class TestKimiEffortVocabulary:
    def test_k3_maps_full_work4you_ladder(self):
        expected = {
            "minimal": "low",
            "low": "low",
            "medium": "high",
        ...
        for work4you_level, wire_level in expected.items():
            kw = _kimi_kwargs(
                "kimi-k3", {"enabled": True, "effort": work4you_level}
            )
            assert kw["reasoning_effort"] == wire_level, work4you_level
