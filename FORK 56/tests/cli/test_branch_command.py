...
def session_db(tmp_path):
    ...
    os.environ["WORK4YOU_HOME"] = str(tmp_path / ".work4you")
    os.makedirs(tmp_path / ".work4you", exist_ok=True)
    from work4you_state import SessionDB
    db = SessionDB(db_path=tmp_path / ".work4you" / "test_sessions.db")
    yield db
    db.close()
...
def cli_instance(tmp_path, session_db):
    """Create a minimal Work4YouCLI-like object for testing _handle_branch_command."""
...
class TestBranchCommandCLI:
    ...
    def test_branch_creates_new_session(self, cli_instance, session_db):
        ...
        Work4YouCLI._handle_branch_command(cli_instance, "/branch")
    ...
    def test_branch_with_custom_name(self, cli_instance, session_db):
        ...
        Work4YouCLI._handle_branch_command(cli_instance, "/branch refactor approach")
