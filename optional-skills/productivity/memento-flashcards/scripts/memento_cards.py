...
Data file: $WORK4YOU_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_WORK4YOU_HOME = Path(os.environ.get("WORK4YOU_HOME", Path.home() / ".work4you"))
DATA_DIR = _WORK4YOU_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
