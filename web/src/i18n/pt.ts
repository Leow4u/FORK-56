...
export const pt: Translations = {
  ...
  status: {
    ...
    stopped: "Parado",
    updateWork4You: "Atualizar Work4You",
    updatingWork4You: "A atualizar Work4You…",
  ...
  cron: {
    ...
    scheduledJobs: "Automações agendadas",
    alwaysOnNote:
      "Automações agendadas só disparam com o agente em execução — mantenha-o sempre ativo para agendamentos autónomos.",
    runsTitle: "Execuções recentes",
    noRuns: "Sem execuções ainda",
    showRuns: "Histórico de execuções",
    noJobs: "Sem automações ainda. Comece por um blueprint abaixo, ou peça ao agente no chat.",
    last: "Última",
    next: "Próxima",
    pause: "Pausar",
    resume: "Retomar",
  ...
  pluginsPage: {
    ...
    removeConfirm: "Remover este plugin de ~/.work4you/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.work4you/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.work4you/skills/",
  ...
  config: {
    configPath: "~/.work4you/config.yaml",
    filters: "Filtros",
    sections: "Secções",
  ...
  env: {
    ...
    customHint: "Variáveis de ambiente arbitrárias armazenadas no seu .env que o Work4You não reconhece. Use-as para injetar variáveis de ambiente para skills, servidores MCP ou suas próprias ferramentas.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Distintivos colecionáveis do Work4You obtidos a partir do histórico real de sessões. Conquistas conhecidas mas ainda não obtidas aparecem como Descobertas; conquistas Secretas permanecem ocultas até surgir o primeiro comportamento correspondente.",
      scan_subtitle:
        "A analisar o histórico de sessões do Work4You. A primeira análise pode demorar 5–10 segundos em históricos extensos.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Mais recente",
      latest_hint_empty: "execute mais o Work4You",
    ...
    guide: {
      ...
      secret_body:
        "As secretas escondem o seu acionador exato. Assim que o Work4You detetar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",
      scan_status_header: "Estado da análise",
      scan_status_body:
        "O Work4You analisa o histórico local uma vez e depois os cartões aparecem automaticamente. Nada está bloqueado se isto demorar alguns segundos.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Work4You ",
    },
  },
  kanban: {
