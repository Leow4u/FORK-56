...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @work4you/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@work4you/shared'],
              message: 'Plugins import only @work4you/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
