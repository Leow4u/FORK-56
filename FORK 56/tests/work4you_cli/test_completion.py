...
def _make_parser() -> argparse.ArgumentParser:
    """Build a minimal parser that mirrors the real work4you structure."""
    p = argparse.ArgumentParser(prog="work4you")
...
class TestGenerateBash:
    def test_contains_completion_function_and_register(self):
        ...
        assert "complete -F _work4you_completion work4you" in out
