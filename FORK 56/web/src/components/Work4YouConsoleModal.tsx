...
interface Work4YouConsoleModalProps {
  open: boolean;
  onClose: () => void;
}
...
export function Work4YouConsoleModal({ open, onClose }: Work4YouConsoleModalProps) {
  ...
  return createPortal(
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="work4you-console-title"
    >
      <div
        className={cn(
          themedBody,
