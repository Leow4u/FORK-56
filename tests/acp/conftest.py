...
Keeps the ACP server tests offline: ``Work4YouACPAgent._build_model_state``
calls ``work4you_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import work4you_cli.inventory as inventory
