"""The `work4you` skill is what a running Work4You knows about itself.

`website/` is never packaged, so an installed Work4You has no local copy of the
user guide; skills ARE synced into `$WORK4YOU_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Work4You can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "work4you"
