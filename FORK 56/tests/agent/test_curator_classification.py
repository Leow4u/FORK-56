...
def test_reconcile_absorbed_into_beats_everything_else(curator_env):
    ...
    out = curator_env._reconcile_classification(
        ...
        destinations={"work4you-dev"},
        absorbed_declarations={
            "pr-review-format": {"into": "work4you-dev", "declared": True},
        },
    )
...
# `work4you curator status`). The full data has always been in REPORT.md on
...
# ---------------------------------------------------------------------------
# Pin hint — surfaces `work4you curator pin <umbrella>` in the rename block so
