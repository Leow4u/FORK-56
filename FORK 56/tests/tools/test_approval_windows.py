...
must match regardless of host OS (a Linux-hosted Work4You can still drive a
...
class TestWindowsPathVariant:
    ...
    @pytest.mark.parametrize("cmd", [
        ...
        r"copy C:\Users\me\AppData\Local\work4you\.env D:\exfil\e.txt",
        "cat C:/Users/me/AppData/Local/work4you/.env",
    ])
