...
uv run python3 "${WORK4YOU_HOME:-$HOME/.work4you}/skills/github/github-auth/scripts/git-credential-token.py"
```
...
elif [ -f ~/.work4you/.env ] && grep -q "^GITHUB_TOKEN=" ~/.work4you/.env; then
  export GITHUB_TOKEN=$(grep "^GITHUB_TOKEN=" ~/.work4you/.env | head -1 | cut -d= -f2 | tr -d '\n\r')
  echo "AUTH_METHOD=curl"
elif grep -q "github.com" ~/.git-credentials 2>/dev/null; then
  export GITHUB_TOKEN=$(uv run python3 "${WORK4YOU_HOME:-$HOME/.work4you}/skills/github/github-auth/scripts/git-credential-token.py")
  echo "AUTH_METHOD=curl"
else
