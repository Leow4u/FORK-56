...
class MemoryManager:
    ...
    def add_provider(self, provider: MemoryProvider) -> None:
        ...
        _core_tool_names = set(_WORK4YOU_CORE_TOOLS)
    ...
    def _strip_skill_scaffolding(text: str) -> Optional[str]:
        ...
        When a user invokes a /skill or /bundle, Work4You expands the turn into
    ...
    def _prefetch_provider(
        ...
        # Propagate the caller's contextvars (profile WORK4YOU_HOME override)
    ...
    def _submit_background(self, fn, *, kind: str = "write") -> None:
        ...
        dashboard, cron) is a ContextVar-scoped WORK4YOU_HOME override, and
    ...
    def initialize_all(self, session_id: str, **kwargs) -> None:
        ...
        Automatically injects ``work4you_home`` into *kwargs* so that every
        provider can resolve profile-scoped storage paths without importing
        ``get_work4you_home()`` themselves.
        """
        if "work4you_home" not in kwargs:
            from work4you_constants import get_work4you_home
            kwargs["work4you_home"] = str(get_work4you_home())
        for provider in self._providers:
            try:
