...
import { Work4YouConsoleModal } from "@/components/Work4YouConsoleModal";
...
export default function SystemPage() {
  ...
  // spawned `work4you import` runs non-interactively (stdin is /dev/null), so
            ...
            <div className="flex flex-col gap-3 border-t border-border pt-4 sm:flex-row sm:items-end">
              <div className="grid min-w-0 flex-1 gap-2">
                ...
                <Input
                  ...
                  placeholder="$WORK4YOU_HOME/backups/work4you-backup.zip"
                />
              </div>
              <Button
                size="sm"
