...
or change arbitrary Work4You configuration.
...
small host fact requested by the RFC. Settings writes use Work4You'
...
`WORK4YOU_HOME`, so one globally loaded plugin context follows multiplexed
...
```text
<WORK4YOU_HOME>/plugin-data/<plugin-data-namespace>/state.json
```
...
- **Profile isolation:** the data root resolves from the active context-local
  Work4You home on every operation.
...
The implementation is covered with real temporary-Work4You-home tests for:
...
- [Issue #64227](https://github.com/Leow4u/FORK-56/issues/64227)
- [RFC PR #58542](https://github.com/Leow4u/FORK-56/pull/58542) by Topher Ross
