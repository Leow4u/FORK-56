...
class TestWork4YouProfileParity:
    def test_tags(self, transport):
        legacy = transport.build_kwargs(
            model="work4you-3", messages=_msgs(), tools=None, provider_profile=get_provider_profile("work4you"),
        )
        profile = transport.build_kwargs(
            model="work4you-3", messages=_msgs(), tools=None,
