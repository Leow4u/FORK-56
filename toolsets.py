...
_WORK4YOU_CORE_TOOLS = [
    ...
    # spawned as a kanban worker (WORK4YOU_KANBAN_TASK env set) or the current
...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "or XAI_API_KEY). Off by default; enable in `work4you tools` → "
            "X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    ...
    "video_gen": {
        "description": (
            ...
            "``work4you tools`` → Video Generation."
        ),
    ...
    "bfl": {
        "description": (
            "Black Forest Labs FLUX 3 video generation through the Work4You tool "
    ...
    "desktop_ui": {
        ...
        "tools": [
            ...
            "open_preview", "close_preview", "read_preview", "drive_preview",
            "read_window_below",
    ...
    # Coding posture (base Work4You — CLI/TUI/desktop/ACP). Auto-selected in a
    ...
    # ==========================================================================
    # Full Work4You toolsets (CLI + messaging platforms)
    #
    ...
    # the `work4you send` CLI), not by the model deciding to send on its own.
    # ==========================================================================
    ...
    "work4you-cli": {
        ...
        "tools": _WORK4YOU_CORE_TOOLS,
        "includes": []
    },

    "work4you-cron": {
        # Mirrors work4you-cli so cron's "default" toolset is the same set of
        # core tools users see interactively — then `work4you tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as work4you-cli; gated by `work4you tools`",
        "tools": _WORK4YOU_CORE_TOOLS,
        "includes": []
    },
    ...
    "work4you-bluebubbles": {
        "description": "BlueBubbles iMessage bot toolset - Apple iMessage via local BlueBubbles server",
        "tools": _WORK4YOU_CORE_TOOLS,
        "includes": []
    },

    "work4you-homeassistant": {
    ...
    "work4you-webhook": {
        ...
        "tools": _WORK4YOU_WEBHOOK_SAFE_TOOLS,
        "includes": []
    },
    ...
    "work4you-gateway": {
        ...
        "tools": [],
        "includes": ["work4you-telegram", "work4you-discord", "work4you-whatsapp", "work4you-slack", "work4you-signal", "work4you-bluebubbles", "work4you-homeassistant", "work4you-email", "work4you-sms", "work4you-mattermost", "work4you-matrix", "work4you-dingtalk", "work4you-feishu", "work4you-wecom", "work4you-wecom-callback", "work4you-weixin", "work4you-qqbot", "work4you-webhook", "work4you-yuanbao"]
    }
}
...
def bundle_non_core_tools(toolset_name: str) -> Set[str]:
    """Return a ``work4you-*`` bundle's platform-specific tools, excluding core.

    Platform bundles are defined as ``_WORK4YOU_CORE_TOOLS + [platform extras]``.
    ...
    Bundle nesting is one level deep in practice (only ``work4you-gateway``
...
def resolve_toolset(name: str, visited: Set[str] = None, *, include_registry: bool = True) -> List[str]:
    ...
    if not toolset:
        # Auto-generate a toolset for plugin platforms (work4you-<name>).
        # Gives them _WORK4YOU_CORE_TOOLS plus any tools the plugin registered
        ...
        if include_registry and name.startswith("work4you-"):
            platform_name = name[len("work4you-"):]
            try:
                from gateway.platform_registry import platform_registry
                if platform_registry.is_registered(platform_name):
                    plugin_tools = set(_WORK4YOU_CORE_TOOLS)
                    try:
                        from tools.registry import registry
                        plugin_tools.update(
