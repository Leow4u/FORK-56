...
def _default_registry_path() -> Path:
    return get_work4you_home() / "state" / _REGISTRY_NAME
...
class HostSupervisor:
    ...
    def __init__(
        ...
        *,
        ...
        expected_work4you_home: str | None = None,
        autostart: bool = True,
    ) -> None:
        ...
        self.expected_work4you_home = expected_work4you_home if expected_work4you_home is not None else str(get_work4you_home())
    ...
    def _spawn_locked(self, *, reason: str) -> None:
        ...
        if self.env:
            env.update(self.env)
        env["WORK4YOU_COMPUTE_HOST_HEARTBEAT_SECS"] = str(self.heartbeat_secs)
    ...
    def _validate_hello(self) -> None:
        ...
        got_home = str(hello.get("work4you_home") or "")
        if got_home and got_home != self.expected_work4you_home:
            raise RuntimeError(f"compute host WORK4YOU_HOME mismatch: {got_home} != {self.expected_work4you_home}")
