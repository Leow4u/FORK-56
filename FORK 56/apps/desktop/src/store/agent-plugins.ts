...
/**
 * Feature store for backend (agent) plugins — the native Work4You plugins plus
 ...
 * primitives `work4you plugins` and the dashboard use, so all surfaces agree on
 ...
 *  WORK4YOU_HOME. Always refetches (it's a cheap local disk scan on the
