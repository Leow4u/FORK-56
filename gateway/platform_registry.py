...
class PlatformEntry:
    ...
    # status displays (``work4you setup``, ``work4you status``, the dashboard
    ...
    # Env vars this platform needs (for ``work4you setup`` display).
    ...
    # built-ins).  Used by ``work4you gateway setup`` to auto-enable the
...
class PlatformRegistry:
    ...
    def __init__(self) -> None:
        ...
        # Plugin adapters are isolated per resolved WORK4YOU_HOME and overlay the
        ...
        # plugin-discovery time added several seconds to *every* `work4you`
        # invocation -- including plain `work4you chat`, which never touches any
        ...
        # `work4you setup`/`gateway status`, send_message).
    ...
    def _resolve_all(self) -> None:
        ...
        gateway startup, ``work4you setup``/``gateway status``, channel
