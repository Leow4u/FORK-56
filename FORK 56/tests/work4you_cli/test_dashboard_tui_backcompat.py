"""Regression test: `work4you dashboard --tui` must not hard-crash.

Older Work4You desktop app shells (<= 0.15.x) spawn the backend as::

    work4you dashboard --no-open --tui --host 127.0.0.1 --port <PORT>
...
died before it became ready and the desktop GUI showed only "Work4You couldn't
...
def _run_cli(args, timeout=60):
    """Invoke the real work4you_cli.main parser in a subprocess.
