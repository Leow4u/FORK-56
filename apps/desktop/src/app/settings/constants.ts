...
// lib/personalities (mirrors work4you_cli/personality.py BUILTIN_PERSONALITIES).
...
export const EMPTY_SELECT_VALUE = '__work4you_empty__'
...
export const PROVIDER_GROUPS: ProviderPrefix[] = [
  {
    ...
    description: 'Hosted Work4You & Work4You-trained models',
    docsUrl: 'https://portal.work4you.ai',
    priority: 0
  },
  {
    prefix: 'FIREWORKS_',
    ...
    // Slot #2 — mirrors CANONICAL_PROVIDERS (after Work4You, ahead of OpenRouter).
  ...
  { prefix: 'WORK4YOU_QWEN_', name: 'DashScope (Qwen)', priority: 6 },
  {
    prefix: 'GLM_',
    name: 'GLM / Z.AI',
...
export const ENUM_OPTIONS: Record<string, string[]> = {
  ...
  // work4you_cli/config.py (local/groq/openai/mistral/elevenlabs).
