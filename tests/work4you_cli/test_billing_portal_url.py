"""Portal-URL resolution for Phase 2b billing errors (work4you_billing).
...
def _preview(monkeypatch):
    monkeypatch.setenv("WORK4YOU_PORTAL_BASE_URL", "https://nas-pr-412.work4you.wtf")


def test_absolutize_resolves_relative(_preview):
    assert (
        _absolutize_portal_url("/billing?topup=open")
        == "https://nas-pr-412.work4you.wtf/billing?topup=open"
    )
