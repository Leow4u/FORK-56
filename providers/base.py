...
def _profile_user_agent() -> str:
    """Return a ``work4you-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from work4you_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"work4you-cli/{_ver}"
    except Exception:
        return "work4you-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # work4you-cli UA so the catalog endpoint is reachable.
