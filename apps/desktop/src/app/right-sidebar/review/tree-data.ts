...
export function buildReviewFlatList(files: Work4YouReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: Work4YouReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
