...
from work4you_cli.work4you_account import Work4YouPortalAccountInfo, Work4YouPaidServiceAccessInfo
...
def test_credits_command_fully_removed():
    ...
    from work4you_cli.commands import resolve_command, COMMAND_REGISTRY
