...
@pytest.fixture()
def agent_env():
    """Spin up the mock provider + an isolated WORK4YOU_HOME, yield (agent, helpers)."""
    ...
    test_home = tempfile.mkdtemp(prefix="work4you_e2e_47967_")
    os.makedirs(os.path.join(test_home, ".work4you"))
    prev_home = os.environ.get("WORK4YOU_HOME")
    os.environ["WORK4YOU_HOME"] = os.path.join(test_home, ".work4you")
    ...
    for mod in list(sys.modules):
        if mod == "run_agent" or mod.startswith("agent.") or mod.startswith("tools.") or mod.startswith("work4you_"):
            del sys.modules[mod]
    ...
    try:
        ...
        if prev_home is None:
            ...
            os.environ["WORK4YOU_HOME"] = prev_home
