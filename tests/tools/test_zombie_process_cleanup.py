...
class TestDelegationCleanup:
    ...
    def test_run_single_child_calls_close(self, monkeypatch, tmp_path):
        ...
        from work4you_cli.observability import relay_runtime
        ...
        def run_conversation(**_kwargs):
            observed["work4you_home"] = get_work4you_home()
        ...
        assert observed["work4you_home"] == profile_home
    ...
    def test_timed_out_child_keeps_relay_session_until_its_turn_exits(
        ...
        profile_token = set_work4you_home_override(profile_home)
        ...
        # CI runners can be slow to schedule the mocked child thread; 0.1s
        # flaked when the timeout fired before child_started was set.
        ...
        try:
            ...
            release_child.set()
            reset_work4you_home_override(profile_token)
            relay_runtime._reset_for_tests()
