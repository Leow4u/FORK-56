...
Work4You supports multiple gateway processes running concurrently — one per profile
...
needed. On every other profile gateway, add to `~/.work4you/config.yaml`:
...
Or set the env var: `WORK4YOU_KANBAN_DISPATCH_IN_GATEWAY=false`
