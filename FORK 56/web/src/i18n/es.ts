...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateWork4You: "Actualizar Work4You",
    updatingWork4You: "Actualizando Work4You…",
  ...
  pluginsPage: {
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.work4you/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.work4you/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.work4you/skills/",
