"""Relay subscriber for the persisted Work4You shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Work4You counters from Relay lifecycle events."""

    def __init__(
        self,
        store: SharedMetricsStore,
        work4you_version: str,
        *,
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Work4You shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
