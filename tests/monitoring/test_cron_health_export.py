...
def test_registered_observable_metric_names_cover_snapshot_metrics(monkeypatch):
    ...
    gateway_snapshot = type("S", (), {"metrics": [
        _M("work4you.gateway.up"), _M("work4you.gateway.active_agents"),
        _M("work4you.gateway.busy"), _M("work4you.gateway.drainable"),
        _M("work4you.gateway.restart_requested"),
        _M("work4you.platform.up"), _M("work4you.platform.degraded"),
    ]})()
    cron_snapshot = type("S", (), {"metrics": [
        _M("work4you.cron.scheduler.heartbeat_age_seconds"),
        _M("work4you.cron.scheduler.last_success_age_seconds"),
        _M("work4you.cron.scheduler.catch_up_occurrences"),
        _M("work4you.cron.jobs.enabled"), _M("work4you.cron.jobs.running"),
        _M("work4you.cron.jobs.overdue"),
    ]})()
...
def test_monitoring_docs_distinguish_relay_health_scope_and_terminal_flush():
    ...
    assert "Work4You-owned Relay transport health" in text
