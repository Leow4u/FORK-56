...
providers (OpenRouter, Work4You, NVIDIA, Qwen, Ollama, DeepSeek, xAI, Kimi, etc.).
...
def _reasoning_config_for_model(model: str, reasoning_config: dict | None) -> dict | None:
    ...
    Work4You' internal effort set extends the wire vocabulary with ``ultra``
...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Work4You/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Work4You'
    ...
    # is stricter (low/high). Clamp Work4You' wider effort set to what each
...
def _raise_gemini_thinking_max_tokens(
    ...
    global Work4You cap of 4096 is enough for visible text, but Ultra/high
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Work4You-internal scaffolding markers — any top-level message key
        ...
        for msg_idx, msg in enumerate(messages):
            ...
            # Drop all Work4You-internal scaffolding markers (``_``-prefixed).
    ...
    def build_kwargs(
        ...
        **params,
        ...
        params (all optional):
            ...
            # Claude on OpenRouter/Work4You max output
        ...
        if is_kimi:
            ...
            if not _kimi_thinking_off:
                ...
                # Work4You' upper-ladder levels 400 or silently degrade. Mirror
                # the kimi-coding plugin's _K3_EFFORT_MAP; older Kimi models
                # keep the low/medium/high vocabulary with the stronger
                # Work4You levels capped at high instead of being dropped
        ...
        if is_tokenhub:
            ...
            if not _tokenhub_thinking_off:
                # TokenHub accepts low/medium/high. Map Work4You' full ladder
    ...
    def _build_kwargs_from_profile(self, profile, model, sanitized, tools, params):
        ...
        if extra_body:
            ...
            # This happens when a profile that emits extra_body (e.g. the Work4You
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        if message_tool_calls:
            ...
            for tc in message_tool_calls:
                ...
                # preserve an explicit blank name for Work4You's recovery path.
        ...
        # Bedrock (e.g. Work4You Portal) surface a Claude refusal this way — or via
