"""Tests for the interactive session browser (`work4you sessions browse`).
...
from work4you_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """work4you sessions browse should be parseable."""
