...
| | |
|---|---|
| Source | Optional — install with `work4you skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Work4You |
| License | MIT |
...
The script reads `${WORK4YOU_HOME:-~/.work4you}/.env` for two optional defaults:
...
Helper script: `~/.work4you/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${WORK4YOU_HOME:-~/.work4you}/.env`.
