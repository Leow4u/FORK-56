...
def main() -> None:
    ...
    work4you_home = Path(tempfile.mkdtemp(prefix="work4you-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "work4you-gateway-smoke",
    ...
    print(json.dumps({"work4you_home": str(work4you_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
