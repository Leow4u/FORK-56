...
| | |
|---|---|
| Source | Optional — install with `work4you skills install official/autonomous-ai-agents/grok` |
...
| Related skills | [`codex`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`claude-code`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`work4you`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-work4you) |
...
# Grok Build CLI — Work4You Orchestration Guide

Delegate coding tasks to [Grok Build](https://docs.x.ai/build/overview) (xAI's
autonomous coding agent CLI, the `grok` command) via the Work4You terminal. Grok
...
1. Prepare stable input files first with Work4You tools (`read_file`,
...
2. **Don't conflate Work4You' xAI auth with the `grok` CLI's auth.** Work4You'
...
7. **Verify auth before relying on it** — check `~/.grok/auth.json` or run a
   cheap `grok -p "Say ok."` smoke test; don't assume Work4You' xAI auth carries
   over.
