"""Core NeMo Relay adapter for Work4You tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Work4You tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Work4You Relay tool execution cannot run on an active event-loop thread"
    )
