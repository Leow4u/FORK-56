...
class TestScanMemoryContent:
    def test_clean_content_and_false_positives_pass(self):
        ...
        # Mentioning agent/work4you config files without modify intent.
        ...
        assert _scan_memory_content("Read .work4you/SOUL.md for agent personality") is None
        assert _scan_memory_content("Check .work4you/config.yaml for settings") is None
        # 'send' without a URL.
    ...
    def test_persistence_patterns_blocked(self):
        ...
        _blocked("edit .work4you/config.yaml to change settings", "work4you_config_mod")
        _blocked("update .work4you/SOUL.md with new personality", "work4you_config_mod")
