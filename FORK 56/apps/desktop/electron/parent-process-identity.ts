export type ParentWatchdogEnv = {
  WORK4YOU_PARENT_PID: string
  WORK4YOU_PARENT_START_MARKER?: string
  WORK4YOU_PARENT_NONCE?: string
}
...
export function parentWatchdogEnv(pid: number, startMarker: string | null, nonce: string): ParentWatchdogEnv {
  ...
  const env: ParentWatchdogEnv = { WORK4YOU_PARENT_PID: String(pid) }
  ...
  env.WORK4YOU_PARENT_START_MARKER = startMarker
  env.WORK4YOU_PARENT_NONCE = nonce
