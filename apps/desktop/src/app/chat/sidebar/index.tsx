...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/work4you'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('work4you:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('work4you:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
          ...
          <SidebarGroupContent>
            <SidebarMenu className="gap-px">
              {[...SIDEBAR_NAV, ...contributedNav].map(item => {
                ...
                return (
                  <SidebarMenuItem className={isNewSession ? 'mb-1' : undefined} key={item.id}>
