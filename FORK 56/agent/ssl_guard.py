"""Preventive SSL CA certificate checks for Work4You.
...
def _skip_ssl_guard_enabled() -> bool:
    return os.getenv("WORK4YOU_SKIP_SSL_GUARD", "").strip().lower() in _SKIP_VALUES


def _repair_hint() -> str:
    return (
        "Repair: run `work4you doctor --fix` (auto-reinstalls certifi), or "
