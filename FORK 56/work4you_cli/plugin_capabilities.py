...
this. Capabilities govern the *host API surfaces* Work4You hands out (which
...
until the user re-consents (``work4you plugins update`` surfaces the diff).
...
def parse_declared_capabilities(raw: Any, plugin_name: str = "?") -> List[str]:
    ...
    for a newer Work4You may declare ids this build doesn't know; they can
