"""Tests for the shared byte formatter (work4you_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from work4you_cli.backup import _format_size as backup
    from work4you_cli.checkpoints import _fmt_bytes as checkpoints
    from work4you_cli.doctor import _human_bytes as doctor
