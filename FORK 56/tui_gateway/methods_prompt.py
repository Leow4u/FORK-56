...
def _(rid, params: dict) -> dict:
    from work4you_cli.input_sanitize import sanitize_user_prompt_text
    ...
    # over another app when they are back in Work4You.
        ...
        if (
            ...
            if not is_truthy_value(params.get("confirm_truncate")):
                ...
                return _err(
                    ...
                    "(update your Work4You client if a rewind was intended)",
                )
...
def _(rid, params: dict) -> dict:
    ...
    def run():
        ...
        try:
            ...
            # WORK4YOU_HOME override (the ContextVar set on the session-create
            ...
            home_token = (
                set_work4you_home_override(_profile_home_str)
...
def _(rid, params: dict) -> dict:
    ...
    prompt = "\n".join(
        ...
        for line in [
            ...
            "Restart exactly the app intended for the Preview URL, not Work4You Desktop itself.",
            ...
            "Before declaring success, verify the Preview URL responds with the intended app, not Work4You Desktop. If it serves Work4You/Desktop UI or another unrelated app, stop that process and report failure.",
    ...
    def run():
        ...
        try:
            ...
            # the session's WORK4YOU_HOME override (the ContextVar set on the
...
def _(rid, params: dict) -> dict:
    # `text` is a JSON string describing the OS window underneath the Work4You
