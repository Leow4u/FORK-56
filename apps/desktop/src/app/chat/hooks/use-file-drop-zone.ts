...
import { type DroppedFile, extractDroppedFiles, WORK4YOU_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, WORK4YOU_PATHS_MIME) ? 'files' : null
