...
// by main.ts (`setBackgroundThrottling` driven by the merged `work4you:active-work`
...
// (the "Work4You idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Work4You" wake word has NO preceding click,
