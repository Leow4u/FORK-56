/**
 * Work4You Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__WORK4YOU_PLUGIN_SDK__`` and
 * ``window.__WORK4YOU_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__WORK4YOU_PLUGIN_SDK__`` because:
 *   1. The runtime object is assembled from many internal modules
 *      (``@/lib/api``, ``@work4you-research/ui``, …). Deriving the type would
 ...
 *
 * Versioning: bump ``Work4YouPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@work4you/dashboard-plugin-sdk`` types package, or
 ...
 *     (pulls @work4you-research/ui types into the contract) or is the loose
 ...
 * of calling ``fetch`` with a hand-read ``window.__WORK4YOU_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__WORK4YOU_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__WORK4YOU_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface Work4YouPluginSDK {
  ...
  /**
   * Shared UI primitives (Work4You DS / shadcn). Typed permissively at the
...
declare global {
  interface Window {
    __WORK4YOU_PLUGIN_SDK__?: Work4YouPluginSDK;
    __WORK4YOU_PLUGINS__?: PluginRegistry;
  }
}
