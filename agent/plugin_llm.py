...
Plugins built on Work4You often need to make their own LLM calls
...
Today the only stable plugin surfaces extend an existing Work4You
...
:class:`~work4you_cli.plugins.PluginContext`:
...
embedded slugs, no shorthands. This mirrors Work4You' main config
...
handles every provider, fallback chain, and per-task override Work4You
supports.
"""
...
class PluginLlm:
    ...
    Instances are constructed by :class:`work4you_cli.plugins.PluginContext`
