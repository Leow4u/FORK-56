...
Work4You saves conversation trajectories in ShareGPT-compatible JSONL format
...
It follows the Work4You function-calling prompt template with:
...
Trajectory saving is a `run_agent.py` / library-level switch — the `work4you` CLI
