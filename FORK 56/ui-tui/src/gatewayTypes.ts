import type { BillingBlock, UsageModelData } from '@work4you/shared/billing'
import type { Work4YouSkin } from '@work4you/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@work4you/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = Work4YouSkin
...
// Wire shapes now live in @work4you/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
