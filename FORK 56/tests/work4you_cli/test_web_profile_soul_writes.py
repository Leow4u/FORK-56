...
def client(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("WORK4YOU_DASHBOARD_SESSION_TOKEN", "soul-test-token")
...
def profile_dir(tmp_path, monkeypatch) -> Path:
    """Create a real profile directory under the test WORK4YOU_HOME."""
    monkeypatch.setenv("WORK4YOU_HOME", str(tmp_path))
...
class TestSoulWriteDurability:
    ...
    def test_existing_soul_survives_an_interrupted_save(
        ...
        # WORK4YOU_HOME patch the client/profile_dir fixtures installed.
