"""``work4you setup`` subcommand parser.
...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser = subparsers.add_parser(
        ...
        "work4you setup model|tts|terminal|gateway|tools|telemetry|agent",
    )
    ...
    setup_parser.add_argument(
        "--portal",
        action="store_true",
        help="One-shot Work4You Portal setup: log in via OAuth, pick a Work4You "
        "model, set Work4You as the inference provider, and opt into the Tool "
