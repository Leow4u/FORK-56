...
Used by ``work4you kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``work4you_cli/goals.py`` — same aux
...
WORK4YOU_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    env_int("WORK4YOU_KANBAN_SPECIFY_MAX_TOKENS", 6000),
)
...
def _profile_author() -> str:
    """Mirror of ``work4you_cli.kanban._profile_author``. Kept local to
    avoid a circular import when kanban.py imports this module."""
    return (
        os.environ.get("WORK4YOU_PROFILE")
    ...
    *,
    ...
    try:
        ...
        resp = call_llm(
            ...
            temperature=0.3,
            max_tokens=WORK4YOU_KANBAN_SPECIFY_MAX_TOKENS,
