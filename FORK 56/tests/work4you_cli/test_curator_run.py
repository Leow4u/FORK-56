"""Tests for `work4you curator run` CLI behavior."""
...
def test_run_defaults_to_synchronous(monkeypatch, capsys):
    ...
    import work4you_cli.curator as curator_cli
...
def test_dry_run_default_reports_synchrowork4you_wording(monkeypatch, capsys):
    import agent.curator as curator_state
    import work4you_cli.curator as curator_cli
    ...
    assert "Read the report with `work4you curator status`" in out
