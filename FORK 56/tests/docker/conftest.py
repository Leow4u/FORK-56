...
Override the image with ``WORK4YOU_TEST_IMAGE`` env var to point at a pre-built
...
IMAGE_TAG = os.environ.get("WORK4YOU_TEST_IMAGE", "work4you-harness:latest")
...
def built_image() -> str:
    ...
    Override with ``WORK4YOU_TEST_IMAGE`` env var to point at a pre-built
    image (faster local iteration).
    """
    if os.environ.get("WORK4YOU_TEST_IMAGE"):
        return IMAGE_TAG
