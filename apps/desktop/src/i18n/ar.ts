...
export const ar = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverrideDesc: 'أزل WORK4YOU_DESKTOP_REMOTE_URL و WORK4YOU_DESKTOP_REMOTE_TOKEN لاستخدام الإعداد المحفوظ أدناه.',
  ...
  onboarding: {
    ...
    autoBrowser: provider => `فتحنا ${provider} في المتصفح. صرّح لـ Work4You هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
