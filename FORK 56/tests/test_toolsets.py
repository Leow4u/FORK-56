...
class TestToolsetConsistency:
    ...
    def test_work4you_platforms_share_core_tools(self):
        """All work4you-* platform toolsets share the same core tools.

        Platform-specific additions (e.g. ``discord`` / ``discord_admin``
        on work4you-discord, gated on DISCORD_BOT_TOKEN) are allowed on top —
        the invariant is that the core set is identical across platforms.
        """
        platforms = ["work4you-cli", "work4you-telegram", "work4you-discord", "work4you-whatsapp", "work4you-slack", "work4you-signal", "work4you-homeassistant"]
...
class TestDefaultPlatformWebSearchCoverage:
    def test_work4you_whatsapp_toolset_includes_web_search(self):
        assert "web_search" in resolve_toolset("work4you-whatsapp")
...
class TestResolveToolsetMemo:
    ...
    def test_second_resolution_is_cached(self, monkeypatch):
        ...
        first = resolve_toolset("work4you-cli")
        second = resolve_toolset("work4you-cli")
        ...
        assert (
            "work4you-cli", True, registry_id, generation
    ...
    def test_memo_result_matches_fresh_resolution(self):
        ...
        toolsets_mod._resolve_toolset_memo.clear()
        first = resolve_toolset("work4you-cli", include_registry=False)
        second = resolve_toolset("work4you-cli", include_registry=False)
        assert first == second
