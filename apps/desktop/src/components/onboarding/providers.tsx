      ...
      <div className="min-w-0">
        <div className="flex items-center gap-2">
          ...
          {loggedIn ? (
            ...
            <span className="rounded-[2.5px] bg-primary px-1.5 py-0.5 text-[0.64rem] font-medium text-primary-foreground">
...
/** Quick-key row for API-key providers (Fireworks leads the expanded list after Work4You, OpenRouter further down). */
