...
class OpenRouterProfile(ProviderProfile):
    ...
    def fetch_models(
        ...
        *,
        ...
        Note: Tool-call capability filtering is applied by work4you_cli/models.py
    ...
    def build_extra_body(
        ...
        #
        # Mirrors the Work4You Portal profile, which resolves the same way
    ...
    def build_api_kwargs_extras(
        ...
        **context: Any,
        ...
        if supports_reasoning:
            ...
            # model default to adaptive. See work4you#42991 (disable case)
            ...
            # live token-spend probe in work4you#43432). Route the existing
