...
Work4You tools are self-registering functions grouped into toolsets and executed through a central registry/dispatch system.
...
2. **Plugin tools** — `work4you_cli.plugins.discover_plugins()` loads user/project/pip plugins that may register additional tools.
...
Toolsets are named bundles of tools. Work4You resolves them through:

- explicit enabled/disabled toolset lists
- platform presets (`work4you-cli`, `work4you-telegram`, etc.)
- dynamic MCP toolsets
- curated special-purpose sets like `work4you-acp`
