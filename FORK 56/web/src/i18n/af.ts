...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateWork4You: "Werk Work4You op",
    updatingWork4You: "Besig om Work4You op te werk…",
  ...
  pluginsPage: {
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.work4you/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.work4you/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.work4you/skills/",
