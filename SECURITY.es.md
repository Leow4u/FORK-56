# Política de Seguridad de Work4You

Este documento describe el modelo de confianza de Work4You, identifica el
...
Reporta de forma privada a través de [GitHub Security Advisories](https://github.com/Leow4u/FORK-56/security/advisories/new)
o **security@work4you.ai**. No abras issues públicos para
vulnerabilidades de seguridad. **Work4You no opera un programa de
...
- Detalles del entorno (`work4you version`, SHA del commit, SO, versión de Python).
...
Work4You es un agente personal de un solo inquilino. Su postura es
...
- **Proceso del agente.** El intérprete Python que ejecuta Work4You,
...
- **Envolvente de confianza.** El conjunto de recursos a los que un operador ha otorgado
  implícitamente acceso a Work4You al ejecutarlo — típicamente, todo lo que
  la propia cuenta de usuario del operador puede alcanzar en el host.
- **Postura.** Una declaración explícita en la documentación o código de Work4You
...
Work4You admite dos posturas de aislamiento a nivel de SO. Abordan
...
Work4You admite esto de dos maneras:

- **La propia imagen Docker de Work4You y la configuración de Compose.** Más
...
Bajo una envoltura de proceso completo, las heurísticas en proceso de Work4You
...
Work4You filtra el entorno que pasa a sus componentes en proceso de
...
Un plugin malicioso o con errores no es una vulnerabilidad en Work4You
en sí mismo. Los errores en la ruta de instalación o descubrimiento de plugins de Work4You
...
4. **Dentro del conjunto autorizado, todos los llamadores tienen la misma confianza.**
   Work4You no modela capacidades por llamador dentro de un único adaptador.
...
- Violaciones de la documentación del modelo de confianza: código que se comporta
  contrariamente a lo que esta política, la propia documentación de Work4You o
  las expectativas razonables del operador predecirían — incluyendo casos donde
  Work4You ha documentado una postura sobre cómo su salida debe ser
...
- **Configuraciones documentadas de emergencia.** Compensaciones seleccionadas por el operador
  ...
  la seguridad de work4you-home, y similares. Los informes contra esas
...
- **Habilidades y plugins contribuidos por la comunidad.** Las habilidades de terceros
  ...
  están en la superficie de revisión del operador, no en la superficie de confianza de Work4You
  (§2.4, §2.5). Una habilidad o plugin que haga algo
  malicioso es el modo de falla esperado de uno que no fue
  revisado, no una vulnerabilidad en Work4You. Los errores en la ruta de
  instalación de habilidades o plugins de Work4You que impidan al
...
- Work4You incluye guardias de cadena de suministro para lanzamientos de servidores
