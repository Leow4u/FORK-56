...
Config: ~/.work4you/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.work4you/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_work4you_home()`` helper (WORK4YOU_HOME-aware and
...
RULES_FILE = get_work4you_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_work4you_home() / "feishu_comment_pairing.json"
