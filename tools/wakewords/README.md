...
`hey_work4you.onnx` / `hey_work4you.tflite` — the on-device "Hey Work4You" hotword
...
- **Label:** the model registers as `hey_work4you` (matches the filename).
