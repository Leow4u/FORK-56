...
export const en: Translations = {
  ...
  status: {
    ...
    updateWork4YouConfirmMessage:
      "This runs work4you update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateWork4YouConfirmNow: "Update now",
    updateWork4YouConfirmTitle: "Update Work4You?",
    updatingWork4You: "Updating Work4You…",
  ...
  cron: {
    ...
    scheduledJobs: "Scheduled automations",
    alwaysOnNote:
    ...
    noRuns: "No runs yet",
    showRuns: "Run history",
    noJobs: "No automations yet. Start from a blueprint below, or just ask the agent in chat.",
    last: "Last",
    next: "Next",
    pause: "Pause",
    resume: "Resume",
  ...
  pluginsPage: {
    ...
    removeConfirm: "Remove this plugin from ~/.work4you/plugins/?",
    removeHint: "Only user-installed plugins under ~/.work4you/plugins can be removed.",
  ...
  skills: {
    ...
    planNote: "Skills are playbooks. Tools are built-in functions. MCP connects other apps.",
    searchPlaceholder: "Search skills and toolsets...",
    enabledOf: "{enabled}/{total} enabled",
    all: "All",
    categories: "Categories",
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.work4you/skills/",
