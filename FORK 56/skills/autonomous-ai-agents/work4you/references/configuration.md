...
Full reference: https://work4you.ai/docs/user-guide/configuration
...
`work4you config check` reports sections missing from an older config.

### Toolsets

Enable/disable via `work4you tools` (interactive) or `work4you tools enable/disable NAME`.
Full enumeration: `TOOLSETS` dict in `toolsets.py` (`_WORK4YOU_CORE_TOOLS` is the default bundle most platforms inherit).
