 ...
 * plugins resolve `@work4you/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __WORK4YOU_PLUGIN_SDK__: sdk,
  __WORK4YOU_REACT__: React,
  __WORK4YOU_REACT_JSX__: jsxRuntime,
  __WORK4YOU_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@work4you/plugin-sdk': shimUrl('__WORK4YOU_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__WORK4YOU_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__WORK4YOU_REACT_JSX__'),
    react: shimUrl('__WORK4YOU_REACT__')
  }
