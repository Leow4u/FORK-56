...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('work4you.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('work4you.desktop.unreadFinishedSessions')
