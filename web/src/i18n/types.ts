...
export interface Translations extends Partial<DesktopI18nSections> {
  ...
  status: {
    ...
    updateWork4YouConfirmMessage?: string;
    updateWork4YouConfirmNow?: string;
    updateWork4YouConfirmTitle?: string;
    updatingWork4You: string;
  ...
  // ── Achievements plugin (plugins/work4you-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
