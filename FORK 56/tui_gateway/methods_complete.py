...
def _(rid, params: dict) -> dict:
    ...
    def _profile_mention_items(prefix: str) -> list[dict]:
        ...
        under the 'work4you' alias when no real profile claims that name.
        """
        out: list[dict] = []
        try:
            ...
            if "work4you".startswith(prefix.lower()) and "work4you" not in seen:
                out.append(
                    {
                        "text": "@work4you",
                        "display": "@work4you",
...
def _(rid, params: dict) -> dict:
    try:
        from work4you_cli.inventory import build_model_options_payload
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        from work4you_cli.inventory import build_models_payload
        ...
        # Save the key to ~/.work4you/.env via the unified credential lifecycle
