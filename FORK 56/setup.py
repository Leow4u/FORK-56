...
Work4You (see website/docs/getting-started/platform-support.md). The
...
build sandbox. ``nix/python.nix`` sets ``WORK4YOU_NIX_BUILD=1`` on the
Work4You package derivation, so only that build may create an artifact.
...
_IN_NIX_BUILD = os.environ.get("WORK4YOU_NIX_BUILD") == "1"

_BLOCK_MESSAGE = (
    "Building wheels or sdists for work4you is not supported.\n"
    "Work4You is distributed via the shell installer, Docker image, or Nix.\n"
    "See: https://work4you.ai/docs/getting-started/installation\n"
    "\n"
    "If you are developing, use an editable install instead:\n"
    "  uv sync          # or: uv pip install -e .\n"
    "\n"
    "If you are building with Nix (uv2nix), this error should not fire —\n"
    "the Work4You Nix derivation sets WORK4YOU_NIX_BUILD=1. If it does, file a bug."
)
