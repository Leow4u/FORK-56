...
Usage:
  ...
  <server_name> matches the files in $WORK4YOU_HOME/mcp-tokens/<server>.json etc.
...
def _work4you_home():
    # Prefer Work4You' own resolver (profile-safe); fall back to env then ~/.work4you.
    try:
        from work4you_constants import get_work4you_home
        return str(get_work4you_home())
    except Exception:
        return os.environ.get("WORK4YOU_HOME") or os.path.expanduser("~/.work4you")


def _tokens_dir():
    return os.path.join(_work4you_home(), "mcp-tokens")
    ...
    status, hdrs, body = _post(
        ...
        data={
            ...
            "params": {"protocolVersion": "2025-06-18", "capabilities": {},
                       "clientInfo": {"name": "work4you-diag", "version": "1.0"}},
        },
        headers={
