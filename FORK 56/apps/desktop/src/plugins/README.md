...
Drop a `<name>/plugin.{ts,tsx}` here that default-exports a `Work4YouPlugin` and
...
`$WORK4YOU_HOME/desktop-plugins/<name>/plugin.js` (the disk door) — see the
`work4you-desktop-plugins` skill.
