...
export const uk: Translations = {
  ...
  status: {
    ...
    stopped: "Зупинено",
    updateWork4You: "Оновити Work4You",
    updatingWork4You: "Оновлення Work4You…",
  ...
  pluginsPage: {
    ...
    removeConfirm: "Видалити цей плагін з ~/.work4you/plugins/?",
    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.work4you/plugins.",
  ...
  skills: {
    ...
    filters: "Фільтри",
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.work4you/skills/",
