...
| | |
|---|---|
| Source | Optional — install with `work4you skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Work4You"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${WORK4YOU_HOME:-~/.work4you}/.env`:
