...
# by /etc/cont-init.d/01-work4you-setup (installed by the Dockerfile). This
...
# on the pre-s6 contract "entrypoint.sh sets up state then execs work4you"
...
echo "[work4you] WARNING: docker/entrypoint.sh is a deprecated shim under " \
