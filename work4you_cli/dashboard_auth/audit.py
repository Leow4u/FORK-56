...
from ``work4you_constants`` or other work4you_cli modules — so it can be
...
def _resolve_log_path() -> Path:
    """``$WORK4YOU_HOME/logs/dashboard-auth.log``.

    Uses ``work4you_constants.get_work4you_home()`` (a leaf module — no import
    ...
    return get_work4you_home() / "logs" / "dashboard-auth.log"
