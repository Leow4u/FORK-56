"""Tests for `_can_open_graphical_browser()` in work4you_cli.auth.

Guards the fix for the May 2026 report where `work4you auth add xai-oauth`
...
from work4you_cli.auth import _can_open_graphical_browser
