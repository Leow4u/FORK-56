// Backend subcommand routing for the desktop-managed Work4You process.
//
// The desktop app launches its own headless backend via `work4you serve` — it
...
// app hasn't updated yet, or an older `work4you` resolved from PATH) only knows
 ...
 * @param {string} [profile] optional Work4You profile to pin via `--profile`.
 */
 ...
 * `-m work4you_cli.main` and any `--profile <name>`). Returns a copy; if there is
...
/**
 * True when a runtime's `work4you_cli/subcommands/dashboard.py` source registers
