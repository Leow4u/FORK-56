"""Windows ConPTY bridge for the `work4you dashboard` chat tab.

Drop-in counterpart to ``work4you_cli.pty_bridge.PtyBridge`` for native
Windows. Mirrors the exact public surface the ``/api/pty`` WebSocket
handler in ``work4you_cli.web_server`` consumes: ``spawn``, ``read``,
