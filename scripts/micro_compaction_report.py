#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Work4You logs.
...
With no LOGFILE, reads ``$WORK4YOU_HOME/logs/agent.log`` (default ~/.work4you).
...
def default_log() -> Path:
    home = os.environ.get("WORK4YOU_HOME") or str(Path.home() / ".work4you")
