 ...
 * confirm button carries the recovery: Work4You → `/topup`, other providers → their
...
export function billingDialogCopy(block: BillingBlock): BillingDialogCopy {
  if (block.is_nous) {
    return {
      cancelLabel: 'Dismiss',
      confirmLabel: 'Top up',
      detail: 'Your Work4You credit balance is exhausted — top up to keep going.',
      title: 'Out of Work4You credits'
    }
  }
