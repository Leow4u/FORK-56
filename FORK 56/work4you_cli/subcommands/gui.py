"""``work4you gui`` subcommand parser.
...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser.add_argument(
        "--work4you-root",
        help="Override the Work4You source root used by Desktop (sets WORK4YOU_DESKTOP_WORK4YOU_ROOT)",
    )
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets WORK4YOU_DESKTOP_CWD)",
    )
    gui_parser.add_argument(
        "--skip-build",
        action="store_true",
