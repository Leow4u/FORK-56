"""Durable aggregation and local export for Work4You shared metrics."""
...
from work4you_cli.sqlite_util import write_txn
...
_PACKAGE_SCHEMA_VERSION = "work4you.shared_metrics.v2"
...
class SharedMetricsStore:
    ...
    def __init__(
        ...
        root = get_work4you_home() / "telemetry" / "shared_metrics"
        ...
        return [
            {
                ...
                "resource": {
                    "work4you_version": row["work4you_version"],
    ...
    def _ensure_schema(self) -> None:
        with self._connection(busy_timeout_ms=_SCHEMA_BUSY_TIMEOUT_MS) as connection:
            # Serialize first-run creation and upgrades across Work4You processes.
            with write_txn(connection):
    ...
    def _create_package_in_transaction(
        ...
        resource = {
            "work4you_version": period_row["work4you_version"],
