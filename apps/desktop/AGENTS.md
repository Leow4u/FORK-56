...
How to build Work4You Desktop well. This is a judgment guide, not an inventory —
...
- The **backend** is authoritative for anything another Work4You surface can also
...
- A **runtime home change** (switching the underlying `WORK4YOU_HOME` profile) is
...
its shape. "Plugin" means several unrelated things across Work4You — do not assume
