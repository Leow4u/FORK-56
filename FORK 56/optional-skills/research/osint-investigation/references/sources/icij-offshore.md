...
- **Note:** The previous Open Refine reconciliation endpoint at
  ...
  the ZIP locally (default `~/.cache/work4you-osint/icij/`, refreshes after
...
First call downloads the ~70 MB ZIP under `~/.cache/work4you-osint/icij/`
(or `$WORK4YOU_OSINT_CACHE/icij/`). Subsequent calls reuse the cache for 30 days.
