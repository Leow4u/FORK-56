...
SKILL_MD = (
    ...
    / "optional-skills/productivity/google-workspace/SKILL.md"
)
...
class TestGoogleWorkspaceCredentialFiles:
    ...
    def test_entries_are_registered_when_files_exist(self, tmp_path):
        ...
        work4you_home.mkdir()
        (work4you_home / "google_token.json").write_text("{}")
        (work4you_home / "google_client_secret.json").write_text("{}")
        ...
        try:
            ...
            assert "/root/.work4you/google_token.json" in container_paths
            assert "/root/.work4you/google_client_secret.json" in container_paths
        finally:
            clear_credential_files()
