...
thinking phase.  Work4You's default cloud-stream stale detector
(``WORK4YOU_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``WORK4YOU_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
