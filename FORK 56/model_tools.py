...
def _is_dispatcher_owned_worker() -> bool:
    """False when WORK4YOU_KANBAN_* is present but this execution does not own it
...
def _run_async(coro):
    ...
    if loop and loop.is_running():
        ...
        # async tools resolve get_work4you_home() under the active profile.
...
#   - cli.py, work4you_cli/*      -> inline on startup (no event loop)
    ...
    if quiet_mode:
        ...
        if profile_scope != CHECK_FN_CACHE_BYPASS:
            cache_key = (
                ...
                cfg_fp,
                bool(os.environ.get("WORK4YOU_KANBAN_TASK")),
...
def _compute_tool_definitions(
    ...
    if enabled_toolsets is not None:
        ...
        if (
            ...
            # Dispatcher-spawned workers are scoped by WORK4YOU_KANBAN_TASK and
    ...
    # This ensures that even if a composite toolset (like work4you-cli)
    ...
    if disabled_toolsets:
        for toolset_name in disabled_toolsets:
            if validate_toolset(toolset_name):
                ...
                if toolset_name.startswith("work4you-") or (get_toolset(toolset_name) or {}).get("posture"):
                    # Platform bundles (work4you-*) include _WORK4YOU_CORE_TOOLS, and
                    ...
                    if (not quiet_mode and toolset_name.startswith("work4you-")
...
def _resolve_active_context_length() -> int:
    ...
    """
    try:
        from work4you_cli.config import load_config as _load
        cfg = _load() or {}
        ...
        # bypasses the persistent cache for some providers (Work4You portal,
...
def _normalize_json_strings_for_schema(value: Any, schema: Any) -> Any:
    ...
    Ported from cline/cline#11803, adapted to work4you's coercion layer.
