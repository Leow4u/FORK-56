...
export const ar = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      loadingSettings: 'جار تحميل إعدادات Work4You',
      loadingSessions: 'جار تحميل الجلسات الأخيرة',
      retryingRemoteBackend: 'جارٍ إعادة الاتصال بخادم Work4You البعيد…',
      startingDesktopConnection: 'جار بدء اتصال سطح المكتب',
      startingWork4YouDesktop: 'جار تشغيل Work4You Desktop...'
    },
    errors: {
      backgroundExited: 'خرجت عملية Work4You الخلفية.',
      backgroundExitedDuringStartup: 'خرجت عملية Work4You الخلفية أثناء بدء التشغيل.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: 'خلفية Work4You أقدم من إصدار سطح المكتب الحالي وقد لا تعمل كما يجب. حدثهما ليتوافقا.',
    updateWork4You: 'تحديث Work4You',
    ...
    errors: {
      ...
      methodNotAllowed: 'رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل Work4You Desktop.',
    ...
    native: {
      ...
      inputBody: 'ينتظر Work4You ردّك.',
      turnDoneTitle: 'أنهى Work4You',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'هل تريد إعادة كل الإعدادات إلى افتراضيات Work4You؟',
    ...
    plugins: {
      ...
      blurb:
        'امتدادات واجهة تُحمّل داخل هذا التطبيق — إما مضمّنة مع البناء، أو موضوعة في مجلد desktop-plugins (بما فيها التي يكتبها Work4You). تعطيل الإضافة يفرغها مباشرة ويبقى بعد إعادة التشغيل.',
      count: n => `${n} مثبتة`,
    ...
    appearance: {
      ...
      pet: {
        title: 'حيوان أليف',
        intro:
          'تبنَّ تعويذة petdex متحركة تطفو فوق التطبيق وتتفاعل مع ما يفعله Work4You — تجري أثناء تنفيذ الأدوات، وتحتفل عند النجاح، وتعبس عند الأخطاء.',
        restartHint:
          'تحتاج الحيوانات الأليفة إلى إعادة تشغيل سريعة — بدأ التطبيق العامل قبل إضافة هذه الميزة. أغلق Work4You وأعد فتحه، ثم ارجع إلى هنا.',
        on: 'تشغيل',
        off: 'إيقاف',
        scaleTitle: 'الحجم',
    ...
    about: {
      heading: 'حول Work4You',
      version: value => `الإصدار ${value}`,
      versionUnavailable: 'الإصدار غير متاح',
      bundleOutOfSync: 'إصدار التطبيق قديم',
      bundleOutOfSyncDesc:
        'تم تحديث وقت تشغيل Work4You، لكن تطبيق سطح المكتب نفسه لا يزال إصدارًا قديمًا — لن تظهر ميزات الواجهة الجديدة (مثل Bot Mode) حتى يتم تحديث التطبيق. شغّل التحديث أدناه لإعادة بناء التطبيق. إذا لم يختفِ هذا التحذير، فأعد التثبيت من أحدث مثبّت لسطح المكتب.',
      ...
      automaticUpdatesDesc: 'اسمح لـ Work4You بالتحقق من التحديثات وتثبيتها.',
    ...
    config: {
      ...
      loading: 'جار تحميل إعدادات Work4You...',
    ...
    gateway: {
      ...
      intro:
        'يشغّل Work4You Desktop بوابة محلية خاصة افتراضياً. استخدم بوابة بعيدة عندما تريد أن يتحكم هذا التطبيق بخلفية Work4You تعمل مسبقاً على جهاز آخر أو خلف وكيل موثوق. اتصالات البوابة إعداد على مستوى الجهاز؛ ويتم اكتشاف الملفات الشخصية من البوابات المتصلة.',
      envOverrideTitle: 'متغيرات البيئة تتحكم في جلسة سطح المكتب هذه.',
      envOverrideDesc:
        'أزل WORK4YOU_DESKTOP_REMOTE_URL و WORK4YOU_DESKTOP_REMOTE_TOKEN لاستخدام الإعداد المحفوظ أدناه.',
      localTitle: 'بوابة محلية',
      localDesc: 'تشغيل خلفية Work4You خاصة على localhost. هذا هو الافتراضي ويعمل دون اتصال.',
      remoteTitle: 'بوابة بعيدة',
      remoteDesc:
        'صل واجهة سطح المكتب هذه بخلفية Work4You بعيدة. البوابات المستضافة تستخدم OAuth أو اسم مستخدم وكلمة مرور، والبوابات الذاتية قد تستخدم رمز جلسة.',
      remoteUrlTitle: 'رابط البوابة البعيدة',
      remoteUrlDesc: 'الرابط الأساسي لخلفية لوحة التحكم البعيدة. يمكن استخدام بادئات مسار مثل /work4you.',
      ...
      restartingMessage: 'سيعيد Work4You Desktop الاتصال باستخدام الإعدادات المحفوظة.',
      savedMessage: 'تم الحفظ للتشغيل القادم.',
      connectedTo: (baseUrl, version) => `متصل بـ ${baseUrl}${version ? ` · Work4You ${version}` : ''}`,
    ...
    profileScope: {
      ...
      editsProfile: profile => `هذه الصفحة تعدّل الملف الشخصي «${profile}» فقط. الملفات الأخرى غير مرتبطة.`
    },
    mcp: {
      ...
      deepLinkDescription:
        'طلب رابط إضافة خادم MCP هذا إلى Work4You. راجع الإعدادات الكاملة أدناه — فهي قادمة من الرابط وليست من Work4You.',
    ...
    providers: {
      ...
      intro: 'سجل الدخول باشتراكك دون نسخ مفتاح API. يشغّل Work4You تسجيل الدخول من المتصفح لك داخل التطبيق.',
      connected: 'متصل',
      collapse: 'طي',
    ...
    toolsets: {
      ...
      ready: 'جاهز',
      work4youIncluded: 'مُضمّن مع اشتراك Work4You — سجّل الدخول إلى Work4You Portal للتفعيل.',
  ...
  commandCenter: {
    ...
    selectWorkspacePlaceholder: 'افتح مجلدًا أو أنشئ مشروعًا',
    branches: 'الفروع',
    ...
    pets: {
      ...
      staleBackend: 'أعد تشغيل Work4You لاستخدام الحيوانات الأليفة — الخادم الخلفي أقدم من هذه الميزة.',
    ...
    generatePet: {
      ...
      staleBackend: 'حدّث Work4You لتوليد الحيوانات الأليفة.',
      backgroundHint: 'يمكنك إغلاق هذا — سيُعلِمك Work4You عند الانتهاء.',
    ...
    work4youActiveSessions: (version, count) => `Work4You ${version} لديه ${count} جلسة نشطة`,
  ...
  messaging: {
    ...
    unknown: 'غير معروف',
    hintPendingRestart: 'أعد تشغيل البوابة لتطبيق هذا التغيير.',
    hintGatewayStopped: 'البوابة متوقفة — أعد تشغيلها للاتصال.',
    hintSetupFirst: 'أضف بيانات الاعتماد أدناه واحفظها — سيتم تشغيل القناة وتتصل بعد إعادة تشغيل البوابة.',
    hintEnableToConnect: 'تم حفظ بيانات الاعتماد. شغّل القناة ثم أعد تشغيل البوابة للاتصال.',
    restartGateway: 'إعادة تشغيل البوابة',
    ...
    testPassed: name => `نجح اختبار ${name}`,
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'لم يحفظ Work4You تغيير النموذج هذا.'
    },
    search: 'بحث',
    loading: 'جار التحميل...',
    states: {
    ...
    createDesc: 'اضبط مهمة يشغلها Work4You تلقائيا.',
    nameLabel: 'الاسم',
    namePlaceholder: 'مثال: الملخص الصباحي',
    promptLabel: 'الرسالة',
    promptPlaceholder: 'ماذا تريد من Work4You أن يفعل؟',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'هذا يزيل المشروع المحفوظ من Work4You. تبقى الملفات ومستودعات git وأشجار العمل دون تغيير.',
      ...
      worktreeStaleBackend:
        'حدِّث خادم Work4You لإنشاء أشجار العمل عبر هذا الاتصال البعيد — فهو أقدم من واجهة git worktree.',
  ...
  composer: {
    ...
    urlHintPre: 'سيقرأ Work4You الرابط ضمن السياق.',
    attach: 'إرفاق',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'اطلب من Work4You فتح PR',
  ...
  updates: {
    stages: {
      ...
      pydeps: 'جار الإنهاء...',
      update: 'جار تحديث Work4You...',
      rebuild: 'جار إعادة بناء تطبيق سطح المكتب...',
      restart: 'جار إعادة تشغيل Work4You...',
      done: 'اكتمل التحديث',
    ...
    unsupportedMessage: 'لا يمكن لهذا الإصدار من Work4You تحديث نفسه من داخل التطبيق.',
    ...
    availableBody: 'إصدار جديد من Work4You جاهز للتثبيت.',
    ...
    availableBodyInstaller:
      'مثبّت Work4You جديد جاهز. يُنزَّل في الخلفية — انقر «التحديث الآن» عندما تكون جاهزا. ما زال المثبّت يحتاج إلى هذه النقرة؛ ويستبدل التطبيق في نحو دقيقة.',
    availableBodyChrome:
      'تحديث تطبيق Work4You جاهز. يُنزَّل ويُفك في الخلفية — انقر «أعد التشغيل للإنهاء» عندما يصبح الشريط جاهزا. تبقى بيئة التشغيل الحالية كما هي.',
    ...
    manualBody: 'لقد ثبّتت Work4You من سطر الأوامر، لذا تُجرى التحديثات من هناك أيضا. الصق هذا في طرفيتك:',
    manualPickedUp: 'سيلتقط Work4You الإصدار الجديد في المرة التالية التي تشغّله فيها.',
    guiSkewTitle: 'تحديث تطبيق سطح المكتب',
    guiSkewBody:
      'تم تحديث الواجهة الخلفية، لكن حزمة تطبيق سطح المكتب هذه لم تتغير. حدّث أو أعد تثبيت تطبيق Work4You لسطح المكتب (ملف AppImage / ‎.deb / ‎.rpm) لمطابقته.',
    copy: 'نسخ',
    copied: 'تم النسخ',
    done: 'تم',
    applyingBody:
    ...
    applyingBodyChrome:
      'جارٍ فك هيكل سطح المكتب. تبقى هذه النافذة مفتوحة حتى ينتهي ذلك، ثم يعيد Work4You التشغيل لثوانٍ. لا تُعِد فتحه بنفسك.',
    applyingBodyBackend:
    ...
    blockerTitle: 'إغلاق المعاينات المحلية لتحديث Work4You؟',
    blockerBody: 'يحتاج Work4You إلى إيقاف هذه المعاينات المحلية قبل التحديث. لن يؤدي ذلك إلى تعديل ملفاتك أو حذفها.',
    foreignBlockerTitle: 'أغلق العمليات الأخرى لتحديث Work4You',
    foreignBlockerBody:
      'لا يمكن لـ Work4You إغلاق هذه العمليات تلقائيًا بأمان. أغلق التطبيق أو الطرفية أو الخدمة التي تشغّل كل عملية، ثم حاول التحديث مرة أخرى.',
    mixedBlockerBody:
      'يمكن لـ Work4You إغلاق المعاينات المحلية المدرجة أدناه. يجب إغلاق العمليات الأخرى يدويًا قبل متابعة التحديث.',
  ...
  install: {
    ...
    oneTimeTitle: 'يحتاج Work4You إلى تثبيت لمرة واحدة',
    ...
    settingUpTitle: 'جار إعداد وكيل Work4You',
    finishingTitle: 'جار الإنهاء',
    failedDesc:
      'فشلت إحدى خطوات التثبيت. على Windows، قد يحدث هذا إذا كان هناك نسخة أخرى من Work4You CLI أو تطبيق سطح المكتب قيد التشغيل. أوقف أي نسخ Work4You قيد التشغيل، ثم أعد المحاولة. تحقق من التفاصيل أدناه أو من سجل سطح المكتب للحصول على النص الكامل.',
    activeDesc:
      'هذا إعداد لمرة واحدة. يقوم مثبّت Work4You بتنزيل التبعيات وتهيئة جهازك. ستتخطى عمليات التشغيل اللاحقة هذه الخطوة.',
  ...
  onboarding: {
    ...
    recommended: 'موصى به',
    connected: 'متصل',
    featuredPitch: 'اشتراك واحد، أكثر من 300 نموذج متقدم — الطريقة الموصى بها لتشغيل Work4You',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'مستضاف ذاتيا',
        description:
          'وجّه Work4You إلى نقطة نهاية محلية أو مستضافة ذاتيا متوافقة مع OpenAI (vLLM، llama.cpp، Ollama، إلخ).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'يفتح صفحة تحقق في المتصفح — يتصل Work4You تلقائياً',
      loopback: 'يفتح المتصفح لتسجيل الدخول — يتصل Work4You تلقائياً',
    ...
    authorizeThere: 'صرّح لـ Work4You هناك.',
    copyAuthCode: 'انسخ رمز التفويض وألصقه أدناه.',
    pasteAuthCode: 'ألصق رمز التفويض',
    reopenAuthPage: 'إعادة فتح صفحة التفويض',
    autoBrowser: provider =>
      `فتحنا ${provider} في المتصفح. صرّح لـ Work4You هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `حجم ${label} هو ${size}. سيعرض Work4You أول 512 KB فقط.`,
    ...
    web: {
      ...
      tryAgain: 'إعادة المحاولة',
      restarting: 'جار إعادة تشغيل Work4You...',
      askRestart: 'اطلب من Work4You إعادة تشغيل الخادم',
      lookingRestart: taskId => `يبحث Work4You عن خادم معاينة لإعادة تشغيله (${taskId})`,
      restartingTitle: 'جار إعادة تشغيل خادم المعاينة',
      restartingMessage: 'يعمل Work4You في الخلفية. راقب كونسول المعاينة لمتابعة التقدم.',
      ...
      restartFailedMessage: 'تعذّر على Work4You إعادة تشغيل الخادم.',
      stillWorking:
        'لا يزال Work4You يعمل، لكن لم تصل نتيجة إعادة التشغيل بعد. قد يكون أمر الخادم قيد التشغيل في المقدمة.',
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: 'انتهت المهلة في انتظار البوابة. هل `work4you gateway` قيد التشغيل؟'
    }
  },
  errors: {
