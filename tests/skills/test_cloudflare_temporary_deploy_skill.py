...
class TestRealWorldOutput:
    ...
    REAL = (
        ...
        "Uploaded work4you-temp-hello (0.74 sec)\n"
        "Deployed work4you-temp-hello triggers (0.42 sec)\n"
        "  https://work4you-temp-hello.serene-temple.workers.dev\n"
    )
    ...
    def test_all_fields_from_real_output(self):
        r = pdo.parse(self.REAL)
        assert r["live_url"] == "https://work4you-temp-hello.serene-temple.workers.dev"
