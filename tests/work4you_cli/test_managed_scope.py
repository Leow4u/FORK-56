"""Unit tests for work4you_cli.managed_scope (resolver + loaders + key helpers)."""
import textwrap
...
def test_managed_dir_env_scrubbed_by_default():
    """conftest must scrub WORK4YOU_MANAGED_DIR so a dev-shell value can't leak in."""
    import os

    assert "WORK4YOU_MANAGED_DIR" not in os.environ
