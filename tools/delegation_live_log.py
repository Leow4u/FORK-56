...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.work4you)."""
    from work4you_constants import get_work4you_dir

    return get_work4you_dir("cache/delegation", "delegation_cache") / "live"
...
class LiveTranscriptWriter:
    ...
    def __init__(self, delegation_id: str, task_index: int, goal: str,
        ...
        try:
            ...
            header = [
                "=== Work4You subagent live transcript ===",
