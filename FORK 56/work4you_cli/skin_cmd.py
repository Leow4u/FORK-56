"""``work4you skin`` — list, switch, and tweak skins from the CLI.
...
def _skin_set(key: str, value: str, skin: str | None) -> int:
    ...
    print(f"✓ {key} = {value} in {display_work4you_home()}/skins/{target}.yaml (live within ~1s)")
    return 0
