...
function fontFamilyFromConfig(config: Work4YouConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const [staleConfig, setStaleConfig] = useState<Work4YouConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setWork4YouConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="work4you-terminal-font-families"
          ...
          <datalist id="work4you-terminal-font-families">
