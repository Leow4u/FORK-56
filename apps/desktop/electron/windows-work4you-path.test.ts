...
test('chooseUpdaterArgs: gentle --update when both updater runtime files exist', () => {
  assert.deepEqual(
    chooseUpdaterArgs({ hasBootstrapMarker: true, hasVenvWork4You: true, hasVenvPython: true }, 'main'),
    ['--update', '--branch', 'main']
  )
})
...
test('chooseUpdaterArgs: partial updater runtimes use --repair', () => {
  assert.deepEqual(
    chooseUpdaterArgs({ hasBootstrapMarker: true, hasVenvWork4You: false, hasVenvPython: true }, 'main'),
    ['--repair', '--branch', 'main']
  )
  assert.deepEqual(
    chooseUpdaterArgs({ hasBootstrapMarker: true, hasVenvWork4You: true, hasVenvPython: false }, 'main'),
    ['--repair', '--branch', 'main']
  )
})
