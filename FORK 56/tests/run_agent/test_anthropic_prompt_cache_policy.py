...
class TestThirdPartyAnthropicGateway:
    ...
    def test_modern_providers_yaml_through_real_loader(self, tmp_path, monkeypatch):
        ...
        # WORK4YOU_HOME at a fresh tempdir needs no cache invalidation.
        agent = _make_agent(
            provider="custom:anthropic-proxy",
            base_url="https://gateway.example.com/anthropic",
            api_mode="anthropic_messages",
...
class TestQwenAlibabaFamily:
    ...
    def test_qwen_on_work4you_portal_caches_with_envelope_layout(self):
        # Work4You Portal Qwen takes the same envelope-layout cache_control
    ...
    def test_non_qwen_non_claude_on_work4you_portal_does_not_cache(self):
...
class TestWork4YouPortalAnthropicWire:
