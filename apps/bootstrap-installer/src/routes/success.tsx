...
/*
 * Success screen. WORK4YOU wordmark stays as the visual anchor
 ...
 * Work4You.exe doesn't exist). We catch the Tauri error and surface it
 * inline rather than silently doing nothing — the previous version
 * had `onClick={() => void launchWork4YouDesktop()}` which swallowed
...
export default function Success() {
  ...
  return (
    <div className="work4you-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>Work4You is ready</span>
          </span>
          <span aria-hidden="true">Work4You is ready</span>
        </p>
