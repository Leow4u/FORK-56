...
anthropic, work4you, copilot), a long-context compression restart, a length-
...
class TurnRetryState:
    ...
    work4you_auth_retry_attempted: bool = False
    work4you_paid_entitlement_refresh_attempted: bool = False
