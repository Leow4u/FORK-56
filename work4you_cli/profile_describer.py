...
Used by ``work4you profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``work4you_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Work4You kanban board.
...
Rules:
  ...
  - Never write "Work4You profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_work4you_home())
        else:
