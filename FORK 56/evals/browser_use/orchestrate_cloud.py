...
Backends:
    work4you-cloud   - Work4You Portal-provisioned Browser Use cloud browser
...
Usage:
    BUBENCH_BASE_TREE=... BUBENCH_PR_TREE=... \
        python3 orchestrate_cloud.py --backend work4you-cloud [--reps 2]
...
parser.add_argument("--backend", required=True, choices=["work4you-cloud", "browserbase"])
...
provider = Work4YouCloud() if args.backend == "work4you-cloud" else Browserbase()
