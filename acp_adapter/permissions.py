"""ACP permission bridging for Work4You dangerous-command approvals."""
...
# Maps ACP permission option ids to Work4You approval result strings.
...
def _build_permission_options(
    *, allow_permanent: bool, smart_denied: bool = False,
    ...
    """Return ACP options that match Work4You approval semantics."""
    ...
    if not smart_denied:
        options.append(PermissionOption(
            ...
            # hint while keeping Work4You semantics in the option id.
            kind="allow_always",
...
def _map_outcome_to_work4you(outcome: object, *, allowed_option_ids: set[str]) -> str:
    """Map an ACP permission outcome into Work4You approval strings."""
    ...
    if option_id not in allowed_option_ids:
        ...
        return "deny"
    return _OPTION_ID_TO_WORK4YOU.get(option_id, "deny")
...
def make_approval_callback(
    ...
    """
    Return a Work4You-compatible approval callback that bridges to ACP.
    ...
    def _callback(
        ...
        **_: object,
        ...
        return _map_outcome_to_work4you(
            response.outcome,
