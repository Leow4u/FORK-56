...
description: "Which operating systems, distribution methods, and features Work4You supports."
---

# Platform Support

Work4You maintains support for many platforms and distribution methods, but we can't support every possible install method.
...
| [**Windows 10 / 11**](../user-guide/windows-native.md) (x86_64, aarch64)      | [Work4You Desktop](https://work4you.ai/), [`install.ps1`](./installation.md#windows-native)                    | A few features are [not available](../user-guide/windows-native.md#feature-matrix).                                                                       |
...
| [**Docker Container**](../user-guide/docker.md#quick-start) (x86_64, aarch64) | [`docker pull`](../user-guide/docker.md#quick-start)                                                                           | Docker installs do not support `work4you update`. Updating is done by running a new image.                                                                  |
...
- installs via `pypi` (e.g. `uv tool install work4you`, `pip install work4you`, etc.)
- installs via `brew` (`brew install work4you`)
