...
| | |
|---|---|
| Source | Optional — install with `work4you skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing work4you tool access (web_search, file ops). Stateless. |
