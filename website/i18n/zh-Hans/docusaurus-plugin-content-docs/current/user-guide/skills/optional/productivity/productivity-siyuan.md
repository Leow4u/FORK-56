...
| | |
|---|---|
| 来源 | 可选 — 使用 `work4you skills install official/productivity/siyuan` 安装 |
...
| 相关 skill | [`obsidian`](/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`notion`](/user-guide/skills/optional/productivity/productivity-notion) |
...
```yaml
# In ~/.work4you/config.yaml under mcp_servers:
mcp_servers:
  siyuan:
    command: npx
