...
Entry point: ``work4you whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``work4you_cli/main.py``).
...
Work4You gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Work4You to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Work4You needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Work4You gateway in another terminal:")
    print("         work4you gateway")
    print()
    ...
    print()
    print("  Docs: https://work4you.ai/docs/user-guide/")
