...
| | |
|---|---|
| Source | Optional — install with `work4you skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`work4you`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-work4you), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Work4You via the native MCP client. This is the preferred
...
Then configure Work4You to connect via HTTP:
