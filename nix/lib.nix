      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via WORK4YOU_BUNDLED_SKILLS /
            # WORK4YOU_OPTIONAL_SKILLS (see work4you.nix), not via the
            ...
            # __init__.py) shipped via symlinks + WORK4YOU_BUNDLED_LOCALES
            # / WORK4YOU_OPTIONAL_MCPS, not via the wheel. Excluding them
