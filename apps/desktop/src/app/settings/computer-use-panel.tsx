...
import type { ComputerUseStatus } from '@/types/work4you'
import { getActionStatus, getComputerUseStatus, grantComputerUsePermissions } from '@/work4you'
 ...
 * cua-driver's own `com.trycua.driver` identity — not Work4You — and are
        ...
        <div className="min-w-0">
          {status.can_grant ? (
            <p className="text-[0.72rem] text-muted-foreground">
              Grants attach to CuaDriver&apos;s own identity (com.trycua.driver), not Work4You — so the dialog is
