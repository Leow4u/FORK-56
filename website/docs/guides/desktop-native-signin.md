...
description: "How the Work4You Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Work4You Desktop app connects to a **gated gateway** (a hosted or
...
For Work4You specifically, native sign-in means:
...
desktop app* and an OAuth client *to the upstream identity provider* (Work4You
...
dashboard-auth subsystem. OAuth providers (e.g. the bundled **Work4You** provider)
...
- [Run Work4You with Work4You Portal](./run-work4you-with-work4you-portal.md)
