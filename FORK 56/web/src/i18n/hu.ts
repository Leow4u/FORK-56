...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateWork4You: "Work4You frissítése",
    updatingWork4You: "Work4You frissítése…",
  ...
  pluginsPage: {
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.work4you/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.work4you/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.work4you/skills/ mappából töltődnek be",
  ...
  achievements: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet a Work4Yout",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
