...
# 5. Symlinks the 'work4you' CLI command into a user-facing bin dir
...
if is_termux; then
    ...
    if [ -n "$UV_CMD" ]; then
        ...
        _uv_log="$(mktemp 2>/dev/null || echo "/tmp/work4you-uv-install.$$.log")"
...
# ============================================================================
# PATH setup — symlink work4you into a user-facing bin dir
# ============================================================================

echo -e "${CYAN}→${NC} Setting up work4you command..."

WORK4YOU_BIN="$SCRIPT_DIR/venv/bin/work4you"
COMMAND_LINK_DIR="$(get_command_link_dir)"
COMMAND_LINK_DISPLAY_DIR="$(get_command_link_display_dir)"
mkdir -p "$COMMAND_LINK_DIR"
ln -sf "$WORK4YOU_BIN" "$COMMAND_LINK_DIR/work4you"
echo -e "${GREEN}✓${NC} Symlinked work4you → $COMMAND_LINK_DISPLAY_DIR/work4you"
...
# ============================================================================
# Seed bundled skills into ~/.work4you/skills/
# ============================================================================

WORK4YOU_SKILLS_DIR="${WORK4YOU_HOME:-$HOME/.work4you}/skills"
mkdir -p "$WORK4YOU_SKILLS_DIR"

echo ""
echo "Syncing bundled skills to ~/.work4you/skills/ ..."
if "$SCRIPT_DIR/venv/bin/python" "$SCRIPT_DIR/tools/skills_sync.py" 2>/dev/null; then
    echo -e "${GREEN}✓${NC} Skills synced"
else
    # Fallback: copy if sync script fails (missing deps, etc.)
    if [ -d "$SCRIPT_DIR/skills" ]; then
        cp -rn "$SCRIPT_DIR/skills/"* "$WORK4YOU_SKILLS_DIR/" 2>/dev/null || true
...
echo "Other commands:"
echo "  work4you status        # Check configuration"
if is_termux; then
    echo "  work4you gateway       # Run gateway in foreground"
else
    echo "  work4you gateway install # Install gateway service (messaging + cron)"
fi
echo "  work4you cron list     # View scheduled jobs"
echo "  work4you doctor        # Diagnose issues"
echo ""
