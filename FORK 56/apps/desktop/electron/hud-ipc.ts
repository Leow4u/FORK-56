...
export function registerHudIpc({
  ...
  ipcMain.handle('work4you:hud:open', async (_event, request) => {
    openHudWindow(
  ...
  ipcMain.handle('work4you:hud:frost', (_event, showing) => {
  ...
  // reaches the bar.
  ipcMain.on('work4you:hud:ignore-mouse', (_event, ignore) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('work4you:hud:move-by', (event, delta) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('work4you:hud:set-bounds', (event, bounds) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('work4you:hud:session', (event, sessionId) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.handle('work4you:hud:close', async () => {
    closeHudWindow()
