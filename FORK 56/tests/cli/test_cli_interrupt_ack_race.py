...
Root cause: ``Work4YouCLI.chat()`` fires ``agent.interrupt(msg)`` from its
...
def _make_cli():
    """Build a Work4YouCLI with prompt_toolkit stubbed (same pattern as
