...
messages to/from the Work4You agent.  Zero external dependencies — uses
...
class IRCAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config, **kwargs):
        ...
        try:
            ...
            self.port = 6697
        self.nickname = os.getenv("IRC_NICKNAME") or extra.get("nickname", "work4you-bot")
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        await self._send_raw(f"USER {self.nickname} 0 * :Work4You")
    ...
    async def disconnect(self) -> None:
        ...
        if self._writer and not self._writer.is_closing():
            try:
                await self._send_raw("QUIT :Work4You shutting down")
    ...
    async def _handle_line(self, raw: str) -> None:
        ...
        if command == "433":
            # Retry with incrementing suffix: work4you_, work4you_1, work4you_2...
...
def check_requirements() -> bool:
    ...
    # work4you setup / requirements check path.
...
def interactive_setup() -> None:
    """Interactive `work4you gateway setup` flow for the IRC platform.
    ...
    print_info("Connect Work4You to an IRC network. Uses Python stdlib — no extra packages needed.")
    ...
    channel = prompt(
        "Channel to join (e.g. #work4you — comma-separate for multiple)",
    ...
    print()
    print_success("IRC configuration saved to ~/.work4you/.env")
...
async def _standalone_send(
    ...
    *,
    ...
    nickname = os.getenv("IRC_NICKNAME") or extra.get("nickname", "work4you-bot")
    ...
    nick_base = nickname.rstrip("_0123456789-")[:24] or "work4you-bot"
    ...
    try:
        ...
        await _raw(f"USER {standalone_nick} 0 * :Work4You (cron)")
