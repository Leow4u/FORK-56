...
row taxonomy is inferred from the atlas shape so Work4You can render both legacy
...
# rows (1536x1872), while older Work4You/petdex sheets used 9 columns x 8 rows
...
class PetState(str, Enum):
    ...
    These are Work4You' activity state names. They are not always identical to the
...
# Legacy Work4You/petdex row order (top -> bottom) used by the older 8-row,
...
# Canonical Work4You activity names -> accepted row-name aliases in descending
