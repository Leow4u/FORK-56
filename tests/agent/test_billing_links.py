...
def test_is_work4you_inference_route_helper():
    assert is_work4you_inference_route("work4you", "") is True
    assert is_work4you_inference_route("", "https://inference-api.work4you.ai/v1") is True
    assert is_work4you_inference_route("openai", "https://api.openai.com/v1") is False
