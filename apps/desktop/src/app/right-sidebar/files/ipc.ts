...
import type { Work4YouReadDirEntry, Work4YouReadDirResult } from '@/global'
...
export type ProjectTreeEntry = Work4YouReadDirEntry
...
function ignoredBy(rules: GitignoreRule[], entry: Work4YouReadDirEntry) {
...
async function filterIgnored(entries: Work4YouReadDirEntry[], rootPath: string, dirPath: string) {
...
export async function readProjectDir(dirPath: string, rootPath = dirPath): Promise<Work4YouReadDirResult> {
