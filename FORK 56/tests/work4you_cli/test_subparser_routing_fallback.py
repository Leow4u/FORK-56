...
The main() function in work4you_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `work4you -c model`
...
def _build_parser():
    """Build a minimal replica of the work4you top-level parser."""
