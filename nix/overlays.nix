# nix/overlays.nix — Expose pkgs.work4you for external NixOS configs
#
...
# `pkgs.work4you`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    work4you = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
