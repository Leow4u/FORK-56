...
import { deleteLearningNode, type ProfileScope } from '@/work4you'

export const ARCHIVE_SKILL_DESCRIPTION = 'The skill is archived and can be restored with `work4you curator restore`.'
