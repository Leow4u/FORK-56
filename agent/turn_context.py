...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``work4you logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Work4You only initiates compaction in "work4you" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Work4You preflight compression for codex app-server "
                "(mode=%s); Work4You will not start thread compaction here.",
    ...
    if agent._memory_manager:
        ...
        # to surface it. Rendered by Work4You (via _emit_status), so it always
