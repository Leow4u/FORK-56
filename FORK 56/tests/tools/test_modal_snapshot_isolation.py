...
def _restore_tool_modules():
    original_work4you_home = os.environ.get("WORK4YOU_HOME")
    original_modules = {
        name: module
    ...
    try:
        ...
        if original_work4you_home is None:
            os.environ.pop("WORK4YOU_HOME", None)
        else:
            os.environ["WORK4YOU_HOME"] = original_work4you_home
...
def _install_modal_test_modules(
    ...
    *,
    ...
    os.environ["WORK4YOU_HOME"] = str(work4you_home)
    sys.modules["work4you_cli.config"] = types.SimpleNamespace(
        get_work4you_home=lambda: work4you_home,
    )
    ...
    async def _lookup_aio(_name: str, create_if_missing: bool = False):
        return types.SimpleNamespace(name="work4you", create_if_missing=create_if_missing)
    ...
    return {
        "snapshot_store": work4you_home / "modal_snapshots.json",
