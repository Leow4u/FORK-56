"""Regression: ``work4you update`` should take a managed checkout off autocrlf=true.
...
``work4you update`` has to repair them.
...
from work4you_cli.update_cmd import _normalize_managed_eol
