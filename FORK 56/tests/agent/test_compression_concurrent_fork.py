...
Damien's incident (Discord, 2026-05-28): a long Work4You session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``work4you_state`` module, whose ``SessionDB``
    ...
    namespace = {"__name__": "work4you_state"}
    source = '''
class SessionDB:
...
_NominalSessionDBImpostor.__module__ = "work4you_state"
