...
class TestDefaultInteractionDispatch:
    ...
    async def test_update_prompt_click_writes_response_file(self, tmp_path, monkeypatch):
        """update_prompt:y click writes 'y' to ~/.work4you/.update_response."""
        adapter = self._make_adapter()
        work4you_home = tmp_path / "work4you_home"
        work4you_home.mkdir()
        monkeypatch.setattr(
            "work4you_constants.get_work4you_home",
            lambda: work4you_home,
        )
        ...
        response = work4you_home / ".update_response"
