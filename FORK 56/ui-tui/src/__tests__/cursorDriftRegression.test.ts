 ...
 *
 * Symptom: in `work4you --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@work4you/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using work4you --tui and as i type multiline my caret at the end will often ' +
