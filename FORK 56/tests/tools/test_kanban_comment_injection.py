...
def worker_home(tmp_path, monkeypatch):
    ...
    for var in ("WORK4YOU_KANBAN_DB", "WORK4YOU_KANBAN_WORKSPACES_ROOT", "WORK4YOU_KANBAN_HOME", "WORK4YOU_KANBAN_BOARD"):
...
def test_seed_then_inject_new_comment(worker_home, monkeypatch):
    ...
    monkeypatch.setenv("WORK4YOU_PROFILE", "worker-bot")
    agent = FakeAgent()
