...
**Tool Search** is Work4You' opt-in progressive-disclosure layer for that
...
:::info Built-in Work4You tools never defer
The tools that make up Work4You' core capability set (`terminal`,
`read_file`, `write_file`, `patch`, `search_files`, `todo`, `memory`,
`browser_*`, `web_search`, `web_extract`, `clarify`, `execute_code`,
`delegate_task`, `session_search`, and the rest of
`_WORK4YOU_CORE_TOOLS`) are *always* loaded directly. Only MCP tools and
...
When the model invokes `tool_call`, Work4You **unwraps the bridge** and
...
- **No JS sandbox.** Work4You uses the simpler "structured tools" mode
