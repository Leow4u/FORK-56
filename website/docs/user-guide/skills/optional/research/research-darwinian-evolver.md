...
| | |
|---|---|
| Source | Optional — install with `work4you skills install official/research/darwinian-evolver` |
...
import upstream classes into Work4You itself.
...
Open `~/.work4you/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Work4You core.
   Custom driver scripts under `~/.work4you/skills/...` are user-side and fine.
