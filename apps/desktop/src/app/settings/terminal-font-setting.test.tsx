...
vi.mock('@/work4you', () => ({
  saveWork4YouConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setWork4YouConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useWork4YouConfigRecord: () => ({ data: mocks.loadedConfig })
}))
