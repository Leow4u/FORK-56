...
def _enable_managed_work4you_tools(monkeypatch):
    """Ensure managed_work4you_tools_enabled() returns True even after module reloads.
    ...
    work4you_cli.work4you_account — so the function body returns True.
    """
    monkeypatch.setattr(
...
def _install_fake_tools_package():
    ...
    # work4you_cli.auth (imported transitively by work4you_account /
...
def test_browser_use_explicit_local_mode_stays_local_even_when_managed_gateway_is_ready(tmp_path):
    ...
    env.update({
        ...
        "TOOL_GATEWAY_USER_TOKEN": "work4you-token",
