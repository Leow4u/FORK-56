...
DEFAULT_UA = (
    "work4you-osint-investigation/0.2 "
    "(+https://github.com/Leow4u/FORK-56; "
    "set WORK4YOU_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("WORK4YOU_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
