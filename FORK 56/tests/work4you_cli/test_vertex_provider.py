...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (work4you_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_work4you_overlays():
    """work4you_cli.providers.get_provider("vertex") backs
