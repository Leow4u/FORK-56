...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/work4you'
...
const VERSION = 3
const PREFIX = 'HML' // "Work4You Memory Loadout" — namespaces our codes like WoW's leading bytes.
