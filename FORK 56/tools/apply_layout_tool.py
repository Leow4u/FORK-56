#!/usr/bin/env python3
"""Apply a layout preset in the Work4You desktop GUI.
...
_TIMEOUT_NOTE = "Layout apply is only available in the Work4You desktop app."
...
APPLY_LAYOUT_SCHEMA = {
    "name": "apply_layout",
    "description": (
        "Apply a saved layout preset to the Work4You desktop app when the user asks to "
