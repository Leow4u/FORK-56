...
| | |
|---|---|
| Source | Optional — install with `work4you skills install official/web-development/page-agent` |
...
- User wants **Work4You itself to drive a browser** → use Work4You' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
