...
def work4you_home(monkeypatch, tmp_path):
    """Isolate WORK4YOU_HOME so the tests don't pollute the real config.
...
class TestPatchCRLFPreservation:
    def test_patch_on_crlf_file_stays_pure_crlf(self, work4you_home, tmp_path):
    ...
    def test_patch_multiline_replacement_on_crlf(self, work4you_home, tmp_path):
...
class TestWriteFileCRLFPreservation:
    ...
    def test_overwrite_lf_file_stays_lf(self, work4you_home, tmp_path):
