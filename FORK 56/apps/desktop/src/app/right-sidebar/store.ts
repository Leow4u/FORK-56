...
const TAKEOVER_KEY = 'work4you.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Work4You can't clear via the API — the user
 *  sees exactly what runs instead of Work4You silently deleting their creds. */
