"""Work4You Portal provider profile."""

from typing import Any

from agent.portal_tags import get_conversation_context, work4you_portal_tags
from agent.transports.codex import _cache_scope_from_session_id
from providers import register_provider
from providers.base import ProviderProfile


class Work4YouProfile(ProviderProfile):
    """Work4You Portal — product tags, reasoning with Work4You-specific omission."""

    def resolve_aux_model(self, *, vision: bool = False) -> str:
        """Ask the Portal which cheap model it currently recommends.

        ``/api/work4you/recommended-models`` is the authoritative, tier-aware
        source (free vs paid), so the auxiliary fast tier tracks the live
        catalog instead of a hardcoded id that 404s the day Work4You retires it.
        ...
        try:
            ...
            return get_work4you_recommended_aux_model(vision=vision) or ""
        except Exception:
            return ""
    ...
    def build_extra_body(
        ...
        body: dict[str, Any] = {"tags": work4you_portal_tags(session_id=session_id)}
        ...
        #
        # Resolve it exactly like ``work4you_portal_tags`` resolves the
    ...
    def build_api_kwargs_extras(
        ...
        **context,
        ...
        """Work4You: passes full reasoning_config, but OMITS when disabled."""
        extra_body = {}
        if supports_reasoning:
            if reasoning_config is not None:
                rc = dict(reasoning_config)
                if rc.get("enabled") is False:
                    pass  # Work4You omits reasoning when disabled
                else:
...
work4you = Work4YouProfile(
    name="work4you",
    aliases=("work4you-portal", "work4you"),
    env_vars=("WORK4YOU_API_KEY",),
    display_name="Work4You",
    description="Work4You — Work4You model family",
    signup_url="https://work4you.ai/",
    fallback_models=(
        "work4you-3-405b",
        "work4you-3-70b",
    ),
