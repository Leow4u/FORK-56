 ...
 * `<work4you home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'work4you.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'work4you.desktop.disabledPlugins.v1'
