#!/usr/bin/env python3
"""Build the Work4You Skills Index — a centralized JSON catalog of all skills.
...
`work4you skills search/install` can use it without hitting the GitHub API.
...
# Ensure WORK4YOU_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Work4You Skills Index...", flush=True)
