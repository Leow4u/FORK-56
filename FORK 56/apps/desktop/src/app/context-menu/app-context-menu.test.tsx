...
function installBridge(partial: Partial<Window['work4youDesktop']> = {}) {
...
describe('AppContextMenu', () => {
  ...
  it('offers the resolved copy only for loopback links on a remote gateway', async () => {
    ...
    installBridge({
      reachPreviewUrl: reachPreviewUrl as unknown as Window['work4youDesktop']['reachPreviewUrl'],
      writeClipboard: writeClipboard as unknown as Window['work4youDesktop']['writeClipboard']
    })
    mountMenu()
  ...
  it('runs edit verbs after the menu closed, with focus back on the editable', async () => {
    ...
    installBridge({ contextMenuEdit: contextMenuEdit as unknown as Window['work4youDesktop']['contextMenuEdit'] })
    mountMenu()
  ...
  it('grays out paste until the clipboard reports text', async () => {
    ...
    installBridge({ readClipboard: readClipboard as unknown as Window['work4youDesktop']['readClipboard'] })
    mountMenu()
    const host = attach('<textarea>text</textarea>')
