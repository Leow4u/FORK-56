...
def _make_agent():
    work4you_home = Path(tempfile.mkdtemp(prefix="work4you-test-home-"))
    (work4you_home / "logs").mkdir(parents=True, exist_ok=True)
    with (
        patch(
        ...
        patch("run_agent._work4you_home", work4you_home),
