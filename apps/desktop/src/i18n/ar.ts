...
export const ar = defineLocale({
  ...
  sidebar: {
    ...
    projects: {
      ...
      ideaLabel: 'الفكرة',
      ideaPlaceholder: 'ما موضوع هذا المشروع؟',
  ...
  updates: {
    ...
    availableBodyInstaller:
      'ينزّل Work4You هذا التحديث في الخلفية بينما تواصل العمل. انقر «تحديث» عندما يظهر. يُغلق التطبيق لحظة ثم يُفتح محدّثا.',
    availableBodyChrome: 'تحديث تطبيق Work4You جاهز. يُنزَّل ويُفك في الخلفية — انقر «تحديث» عندما يصبح الشريط جاهزا. تبقى بيئة التشغيل الحالية كما هي.',
