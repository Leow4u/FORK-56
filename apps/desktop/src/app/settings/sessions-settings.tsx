...
// / Program Files), which buried any files Work4You wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.work4youDesktop` is
    ...
    const settings = window.work4youDesktop?.settings
