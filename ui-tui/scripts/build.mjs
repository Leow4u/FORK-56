...
await build({
  ...
  // Skip the prebuilt @work4you/ink bundle and inline the source instead:
  ...
  alias: { '@work4you/ink': resolve(root, 'packages/work4you-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The work4you_cli launcher
