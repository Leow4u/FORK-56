...
export function getNested(obj: Work4YouConfigRecord, path: string): unknown {
  let cur: unknown = obj
 ...
 */
export function clearsEnabledToolsets(prev: Work4YouConfigRecord, next: Work4YouConfigRecord): boolean {
...
export function setNested(obj: Work4YouConfigRecord, path: string, value: unknown): Work4YouConfigRecord {
...
function personalityOptions(config: Work4YouConfigRecord): string[] {
...
function commandProviderNames(config: Work4YouConfigRecord, section: 'tts' | 'stt'): string[] {
