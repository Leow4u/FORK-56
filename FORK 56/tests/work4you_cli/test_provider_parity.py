...
the SAME provider universe as ``work4you model`` (the CLI/TUI picker).
...
def test_every_work4you_model_provider_is_configurable_in_desktop():
    """PARITY CONTRACT: GUI (keys ∪ accounts) ⊇ `work4you model` universe."""
    ...
    assert not missing, (
        "providers shown in `work4you model` but not configurable in the desktop "
