...
The setup is fully agent-driven — ask Work4You to set up Google Workspace and it walks you through each step. The flow:
...
3. **Authorize** — Work4You generates an auth URL, you approve in the browser, paste back the redirect URL
...
| Problem | Fix |
|---------|-----|
| `NOT_AUTHENTICATED` | Run setup (ask Work4You to set up Google Workspace) |
