...
# ``data:`` field before Work4You receives a completion chunk.  Keeping this
...
#
# See: https://github.com/Leow4u/FORK-56/issues/27344
...
# case: a stream dies mid-response and Work4You persists a content-less
...
def classify_api_error(
    ...
    *,
    ...
    # work4you_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from work4you_cli.plugins import get_plugin_error_classification
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, Work4You) run before
    ...
    if status_code == 404:
        # Work4You API currently surfaces HA/NAS credit depletion as a paid model
