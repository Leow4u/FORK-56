...
const FOCUS_EVENT = 'work4you:composer-focus'
const INSERT_EVENT = 'work4you:composer-insert'
const ATTACH_IMAGES_EVENT = 'work4you:composer-attach-images'
const INSERT_REFS_EVENT = 'work4you:composer-insert-refs'
const SUBMIT_EVENT = 'work4you:composer-submit'
const VOICE_TOGGLE_EVENT = 'work4you:composer-voice-toggle'
const MODEL_MENU_EVENT = 'work4you:composer-model-menu'
