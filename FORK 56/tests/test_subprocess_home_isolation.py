...
Work4You state stays profile-scoped through WORK4YOU_HOME. Host subprocesses should
...
See: https://github.com/Leow4u/FORK-56/issues/25114
See: https://github.com/Leow4u/FORK-56/issues/36144
See: https://github.com/Leow4u/FORK-56/issues/29015
"""
...
class TestGetSubprocessHome:
    ...
    def test_host_auto_keeps_real_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        work4you_home = real_home / ".work4you" / "profiles" / "coder"
        profile_home = work4you_home / "home"
    ...
    def test_real_mode_repairs_parent_home_already_pointing_at_profile(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("WORK4YOU_REAL_HOME", str(real_home))

        from work4you_constants import get_subprocess_home, get_real_home
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        self._container_mode(monkeypatch)
        base = tmp_path / ".work4you" / "profiles"
        ...
        monkeypatch.setenv("WORK4YOU_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("WORK4YOU_HOME", str(base / "beta"))
...
class TestMakeRunEnvHomeInjection:
    ...
    def test_host_auto_preserves_real_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        assert result["WORK4YOU_REAL_HOME"] == str(real_home)
    ...
    def test_profile_mode_injects_profile_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        assert result["HOME"] == str(work4you_home / "home")
        assert result["WORK4YOU_REAL_HOME"] == str(real_home)
    ...
    def test_no_injection_when_work4you_home_unset(self, monkeypatch):
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from work4you_cli.profiles import _PROFILE_DIRS
    ...
    def test_create_profile_bootstraps_home_dir(self, tmp_path, monkeypatch):
        ...
        from work4you_cli.profiles import create_profile
