...
const shortModelLabel = (model: string) => houseModelDisplayName(model)
...
export function StatusRule({
  ...
  // Dev-only readout (WORK4YOU_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (WORK4YOU_DEV_CREDITS), lowest priority,
