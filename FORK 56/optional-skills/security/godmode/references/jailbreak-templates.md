...
## 5. GODMODE FAST — Work4You 4 405B (Zero Refusal)

**Model:** `work4you/work4you-4-405b`
**Strategy:** Work4You models are already uncensored, so this combo is about speed — instant token streaming with zero refusal checking needed. Uses the same Pliny Love divider format as a formality.
...
Pick a template above and set it in `~/.work4you/config.yaml`:
