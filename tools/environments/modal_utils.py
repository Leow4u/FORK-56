"""Shared Work4You-side execution flow for Modal transports.

This module deliberately stops at the Work4You boundary:
- command preparation
...
def wrap_modal_stdin_heredoc(command: str, stdin_data: str) -> str:
    ...
    marker = f"WORK4YOU_EOF_{uuid.uuid4().hex[:8]}"
