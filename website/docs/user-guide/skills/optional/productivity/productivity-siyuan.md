...
| | |
|---|---|
| Source | Optional — install with `work4you skills install official/productivity/siyuan` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`notion`](/docs/user-guide/skills/optional/productivity/productivity-notion) |
...
3. Store it in `${WORK4YOU_HOME:-~/.work4you}/.env`:
   ```
