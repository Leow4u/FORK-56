...
| | |
|---|---|
| 来源 | 可选 — 使用 `work4you skills install official/finance/stocks` 安装 |
| 路径 | `optional-skills/finance/stocks` |
| 版本 | `0.1.0` |
| 作者 | Mibay (Mibayy), Work4You |
| 许可证 | MIT |
...
```
SCRIPT=~/.work4you/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.work4you/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
