"""Tests for the specifier module + `work4you kanban specify` CLI surface.
...
from work4you_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `work4you kanban …` argparse surface directly."""
