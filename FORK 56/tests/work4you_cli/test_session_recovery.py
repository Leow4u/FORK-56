...
from work4you_state import FTS_STORAGE_VERSION, SCHEMA_VERSION, SessionDB
...
def test_snapshot_blocks_connections_opened_during_the_copy(
    ...
    from work4you_cli import session_recovery as recovery_module
...
def test_cli_allow_partial_salvages_rows_across_a_corrupt_leaf(
    ...
    env = os.environ.copy()
    env["WORK4YOU_HOME"] = str(tmp_path / "isolated-work4you-home")
