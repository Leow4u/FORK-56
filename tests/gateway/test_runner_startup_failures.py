...
async def test_start_gateway_verbosity_imports_redacting_formatter(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("work4you_logging.setup_logging", lambda work4you_home, mode: tmp_path)
    monkeypatch.setattr("work4you_logging._add_rotating_handler", lambda *args, **kwargs: None)
