...
def clean_env(monkeypatch):
    ...
    monkeypatch.delenv("WORK4YOU_LOCAL_STT_COMMAND", raising=False)
    monkeypatch.delenv("WORK4YOU_LOCAL_STT_LANGUAGE", raising=False)
...
class TestTranscribeLocalCommand:
    def test_command_provider_uses_sanitized_child_env(self, monkeypatch):
        """Salvage of #56332: command STT must not inherit Work4You secrets."""
    ...
    def test_command_fallback_with_template(self, monkeypatch, sample_ogg, tmp_path):
        ...
        monkeypatch.setenv("WORK4YOU_LOCAL_STT_LANGUAGE", "en")
...
def mock_xai_http_module():
    ...
    fake_module = MagicMock()
    fake_module.work4you_xai_user_agent = MagicMock(return_value="work4you-xai/test")
...
class TestTranscribeXAI:
    ...
    def test_sends_language_and_format(self, monkeypatch, sample_ogg, mock_xai_http_module):
        ...
        monkeypatch.setenv("WORK4YOU_LOCAL_STT_LANGUAGE", "fr")
