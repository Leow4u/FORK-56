...
[A2A](https://a2a-protocol.org) is the open Agent2Agent protocol (v1.0, stewarded by the Linux Foundation) for communication between independent AI agents. The Work4You A2A plugin works in **both directions**: your agent can call other A2A agents as tools, and other agents can send tasks to your Work4You over HTTP.

It interoperates with any A2A-compliant peer — another Work4You, LangChain, CrewAI, Google ADK agents, or anything built on the official `a2a-sdk`.

## When to use A2A

- **Work4You ↔ Work4You across machines** — let your desktop agent hand tasks to a Work4You on a server, or vice versa, each with its own memory, tools, and credentials.
...
- **Being a callable service** — expose your Work4You so other frameworks' agents can send it tasks.
...
With the platform enabled, Work4You serves:
...
- **Audit log** — every exchange appends to `~/.work4you/a2a_audit.jsonl`.
