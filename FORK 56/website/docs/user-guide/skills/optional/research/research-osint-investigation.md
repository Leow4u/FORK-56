...
| | |
|---|---|
| Source | Optional — install with `work4you skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Work4You (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $WORK4YOU_OSINT_CACHE/icij/ (default: ~/.cache/work4you-osint/icij/).
...
# Set WORK4YOU_OSINT_UA=your-app/1.0 (your@email) to identify yourself
