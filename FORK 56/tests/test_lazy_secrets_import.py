"""Regression test: work4you update must not load cryptography eagerly."""
...
assert 'work4you_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running work4you update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so work4you_cli is importable,
...
import work4you_cli.main
from work4you_cli.update_cmd import _cmd_update_check
