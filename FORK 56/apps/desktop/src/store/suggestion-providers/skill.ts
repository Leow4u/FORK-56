 ...
 *  Working in `~/www/work4you`, the draft says "work4you" constantly
 *  — a "Use skill: work4you" pill on every mention is noise (the reported
 *  annoyance that prompted this guard). Boundary containment, not exact
 *  segment equality, so worktree dirs (`work4you-suggest`) suppress too. */
 ...
 *  segment of a qualified form (`github/work4you-dev`, `plugin:skill`). */
