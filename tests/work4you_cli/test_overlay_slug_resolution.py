...
WORK4YOU_OVERLAYS keys may be models.dev IDs (e.g. "github-copilot") while
_PROVIDER_MODELS and config.yaml use Work4You IDs ("copilot").  The slug
...
def test_copilot_uses_work4you_slug():
...
def test_mapped_provider_credential_pool_visibility(monkeypatch):
    ...
    monkeypatch.setattr(
        "work4you_cli.auth._load_auth_store",
