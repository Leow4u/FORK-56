...
class TestConfigWriting:
    ...
    def test_plugin_provider_active_overrides_managed_work4you_active_label(self, monkeypatch):
        from work4you_cli import tools_config
        ...
        assert tools_config._is_provider_active(work4you_row, config) is False
