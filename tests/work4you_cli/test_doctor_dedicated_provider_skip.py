"""Regression: work4you doctor must not run a generic Bearer-auth health
...
def test_build_apikey_providers_list_skips_dedicated_check_providers():
    from work4you_cli import doctor
