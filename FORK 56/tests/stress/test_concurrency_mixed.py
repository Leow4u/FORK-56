...
def worker_loop(worker_id: int, work4you_home: str, result_file: str) -> None:
...
def reclaimer_loop(work4you_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="work4you_mixed_stress_")
    print(f"WORK4YOU_HOME = {home}")
