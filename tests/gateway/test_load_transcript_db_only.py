...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.work4you/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at work4you_state import time, before pytest's WORK4YOU_HOME monkeypatch
    fires — the autouse fixture's WORK4YOU_HOME override doesn't help here.)
    """
