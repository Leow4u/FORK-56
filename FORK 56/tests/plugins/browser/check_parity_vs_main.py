...
Run from the PR worktree:
    ...
    cd ~/.work4you/work4you/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.work4you/work4you``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.work4you/work4you
PR_DIR = REPO_ROOT  # the worktree we're in
assert (MAIN_DIR / "tools" / "browser_tool.py").exists(), (
    f"MAIN_DIR={MAIN_DIR} doesn't look like a work4you checkout"
)
assert (PR_DIR / "tools" / "browser_tool.py").exists(), (
    f"PR_DIR={PR_DIR} doesn't look like a work4you checkout"
)
...
# Isolated WORK4YOU_HOME for the config write.
