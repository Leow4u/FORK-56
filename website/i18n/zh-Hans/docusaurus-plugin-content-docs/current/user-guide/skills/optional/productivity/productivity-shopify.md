...
| | |
|---|---|
| 来源 | 可选 — 通过 `work4you skills install official/productivity/shopify` 安装 |
...
| 相关 skill | [`airtable`](/user-guide/skills/optional/productivity/productivity-airtable), [`xurl`](/user-guide/skills/optional/social-media/social-media-xurl) |
