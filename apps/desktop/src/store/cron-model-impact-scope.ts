...
function identityForConnection(connection: Work4YouConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: Work4YouConnection | null): void {
