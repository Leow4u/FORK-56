"""Tests for ``work4you peer`` — cross-machine bot-to-bot DMs."""
...
from work4you_cli.subcommands import peer as peer_cmd
...
class _FakePeer(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if self.path == "/api/sessions":
            ...
            return self._json({"object": "work4you.session", "session": {"id": "bc_1", "title": body.get("title")}}, 201)
