...
def test_dry_run_prints_plan_without_mutating(monkeypatch, tmp_path, capsys):
    ...
    monkeypatch.setattr(uninstall, "get_work4you_home", lambda: work4you_home)
    monkeypatch.setattr(uninstall, "_is_default_work4you_home", lambda home: False)
    ...
    assert str(work4you_home) in output
    assert project_root.exists()
    assert work4you_home.exists()
