"""Tests for the ``/reload-skills`` CLI slash command (``Work4YouCLI._reload_skills``).
...
def _make_cli():
    """Build a minimal Work4YouCLI shell exposing ``_reload_skills``."""
    import cli as cli_mod

    obj = object.__new__(cli_mod.Work4YouCLI)
