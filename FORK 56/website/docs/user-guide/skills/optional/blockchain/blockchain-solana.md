...
| | |
|---|---|
| Source | Optional — install with `work4you skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Work4You |
| License | MIT |
...
Helper script path: ~/.work4you/skills/blockchain/solana/scripts/solana_client.py
