...
def openclaw_residue_hint_cli() -> str:
    """Banner shown the first time Work4You starts and finds ``~/.openclaw/``.

    Points users at ``work4you claw migrate`` (non-destructive port of config,
    memory, and skills) first. ``work4you claw cleanup`` is mentioned as the
    ...
    return (
        ...
        "To port your config, memory, and skills over to Work4You, run "
        "`work4you claw migrate`.\n"
        "If you've already migrated and want to archive the old directory, "
        "run `work4you claw cleanup` (renames it to ~/.openclaw.pre-migration — "
