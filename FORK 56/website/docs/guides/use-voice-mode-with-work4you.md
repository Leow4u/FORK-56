---
sidebar_position: 8
title: "Use Voice Mode with Work4You"
description: "A practical guide to setting up and using Work4You voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Work4You
...
:::tip
[Work4You Portal](/integrations/work4you-portal) bundles both the LLM and TTS through one OAuth — voice mode works end-to-end with no extra credentials.
:::
...
- you want Work4You sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Work4You.
...
## Step 1: make sure normal Work4You works first
...
Work4You supports both local and cloud speech stacks.
...
4. Work4You transcribes and responds
...
- asking Work4You to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Work4You loop.

## Tuning CLI behavior

### Silence threshold

If Work4You starts/stops too aggressively, tune:
...
Work4You stays a normal chat bot, but can speak replies.
...
- you want Work4You to function like a portable research or ops assistant
...
Work4You joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Work4You detects speech boundaries
- transcripts are posted in the associated text channel
- Work4You responds in text and audio
...
1. get text Work4You working
2. run `work4you setup tts` to enable voice support
