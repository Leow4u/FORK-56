...
def test_resolved_api_call_timeout_priority(monkeypatch, tmp_path):
          ...
          openrouter:
            ...
            models:
              openai/gpt-4o-mini:
                timeout_seconds: 42
        """)
    monkeypatch.setenv("WORK4YOU_API_TIMEOUT", "999")
    ...
    from work4you_cli import timeouts as to_mod
    ...
    monkeypatch.delenv("WORK4YOU_API_TIMEOUT", raising=False)
