...
export const ZOOM_STORAGE_KEY = 'work4you:desktop:zoomLevel'
 ...
 * but forgot to emit 'work4you:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('work4you:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
