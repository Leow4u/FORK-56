...
- Unlimited timeout (WORK4YOU_CRON_TIMEOUT=0)
- Backward compat: WORK4YOU_CRON_TIMEOUT env var still works
...
class TestInactivityTimeout:
    ...
    def test_unlimited_timeout(self):
        """WORK4YOU_CRON_TIMEOUT=0 means no timeout at all."""
        agent = FakeAgent(idle_seconds=0.0)
    ...
    def test_timeout_env_var_parsing(self, monkeypatch):
        """WORK4YOU_CRON_TIMEOUT env var is respected."""
        monkeypatch.setenv("WORK4YOU_CRON_TIMEOUT", "1200")
...
class TestSysPathOrdering:
    ...
    def test_work4you_time_importable(self):
        ...
        from cron.scheduler import _work4you_now
        assert callable(_work4you_now)
