...
export const $pullRequestsByBranch = atom<Record<string, Work4YouBranchPullRequest>>({})
...
export const $prBranchBySession = persistentAtom<Record<string, string>>(
  'work4you.desktop.prBranchBySession',
  {},
  Codecs.stringRecord
)
...
const $prScannedSessions = persistentAtom<string[]>('work4you.desktop.prScannedSessions', [], Codecs.stringArray)
...
export function pullRequestBucket(pr: Work4YouBranchPullRequest | undefined): PullRequestBucket {
  if (!pr) {
    return 'none'
  }
