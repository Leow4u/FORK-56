...
class TestWork4YouParity:
    """Work4You: product tags, reasoning, omit when disabled."""

    def test_tags(self, transport):
        from agent.portal_tags import work4you_portal_tags
        kw = transport.build_kwargs(
            model="work4you-3-llama-3.1-405b",
            messages=_simple_messages(),
            tools=None,
            provider_profile=get_provider_profile("work4you"),
        )
