...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # Fireworks AI — serverless pricing for the models work4you typically routes
...
def resolve_billing_route(
    ...
    if provider_name == "work4you" or base_url_host_matches(base_url or "", "inference-api.work4you.ai"):
        return BillingRoute(provider="work4you", model=model, base_url=base_url or _WORK4YOU_DEFAULT_BASE_URL, billing_mode="official_models_api")
