...
test('runBillingRecovery routes Work4You to in-app Settings, never an external link', () => {
  runBillingRecovery(makeBlock({ is_nous: true, provider: 'work4you', provider_label: 'Work4You Portal' }))
