"""``work4you gateway`` and ``work4you proxy`` subcommand parsers.
...
def build_gateway_parser(
    ...
    gateway_migrate_legacy = gateway_subparsers.add_parser(
        "migrate-legacy",
        help="Remove legacy work4you.service units from pre-rename installs",
        description=(
            "Stop, disable, and remove legacy Work4You gateway unit files "
            "(e.g. work4you.service) left over from older installs. Profile "
            "units (work4you-gateway-<profile>.service) and unrelated "
    ...
    gateway_enroll = gateway_subparsers.add_parser(
        ...
        description=(
            ...
            "Authenticates as your Work4You Portal account (the connector derives the "
            ...
            "GATEWAY_RELAY_SECRET / GATEWAY_RELAY_DELIVERY_KEY into ~/.work4you/.env. "
            "Requires being logged in (work4you setup). Not available in managed installs."
        ),
    )
    ...
    gateway_enroll.add_argument(
        ...
        help=(
            ...
            "GATEWAY_RELAY_WAKE_URL in ~/.work4you/.env and forwarded at provision. "
    ...
    proxy_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "to an OAuth-authenticated provider (e.g. Work4You Portal). External "
    ...
    proxy_start.add_argument(
        "--provider",
        default="work4you",
        help="Upstream provider: work4you or xai (default: work4you). See `work4you proxy providers`.",
    )
    proxy_start.add_argument(
        "--host",
        default=None,
