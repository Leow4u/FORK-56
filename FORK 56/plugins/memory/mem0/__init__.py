...
Configuration
-------------
Secret (lives in $WORK4YOU_HOME/.env or the environment):
...
Behavioral settings (live in $WORK4YOU_HOME/mem0.json, set via `work4you memory
setup`):
  ...
  agent_id           — Agent identifier (default: work4you)
...
_DEFAULT_USER_ID = "work4you-user"
...
def _load_config() -> dict:
    """Load config from env vars, with $WORK4YOU_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "work4you"),
        "oss": {},
    }
    ...
    config_path = get_work4you_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, work4you_home):
        """Write config to $WORK4YOU_HOME/mem0.json."""
        import json
    ...
    def post_setup(self, work4you_home: str, config: dict) -> None:
        ...
        post_setup(work4you_home, config)
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $WORK4YOU_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "work4you")
