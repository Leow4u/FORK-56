...
existing Work4You-facing JSON contract and falls back to the Python client
...
from _work4you_home import get_work4you_home
...
def _gws_binary() -> str | None:
    override = os.getenv("WORK4YOU_GWS_BIN")
    if override:
        return override
