...
def ledger_env(tmp_path, monkeypatch):
    """Isolated WORK4YOU_HOME + skills dir for skill_manage and the ledger."""
    ...
    monkeypatch.setattr(skill_ledger, "get_work4you_home", lambda: home)
    monkeypatch.setattr(skill_usage, "get_work4you_home", lambda: home)
...
def test_rollback_refuses_paths_outside_work4you_home(ledger_env):
    """A hand-edited ledger entry pointing outside WORK4YOU_HOME must not
