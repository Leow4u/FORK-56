"""Behavior tests for work4you_cli.inventory.
...
def _work4you_row(model: str = "openai/gpt-5.5") -> dict:
    return {
        "slug": "work4you",
        "name": "Work4You",
        "models": [model],
...
def test_list_authenticated_providers_force_fresh_is_keyword_only():
    """``force_fresh_work4you_tier`` must be keyword-only on the public listing API.
    ...
    param = sig.parameters["force_fresh_work4you_tier"]
...
def test_explicit_only_filters_ambient_credentials_but_keeps_current_and_custom_rows():
    rows = [
        ...
        {"slug": "copilot", "name": "Copilot", "models": ["gpt-5.4"],
         "total_models": 1, "is_current": False, "is_user_defined": False,
         "source": "work4you"},
        {"slug": "work4you", "name": "Work4You", "models": ["anthropic/claude-sonnet-5"],
         "total_models": 1, "is_current": False, "is_user_defined": False,
         "source": "work4you"},
...
def test_user_defined_rows_carry_alias_set_for_gui_current_match():
    ...
    rows = [
        ...
        _work4you_row() | {"is_current": False},
    ]
    ...
    assert "aliases" not in by_slug["work4you"]
...
def test_build_models_payload_forwards_refresh_flag():
    ...
    with patch("work4you_cli.model_switch.list_authenticated_providers", side_effect=_capture):
...
def test_list_authenticated_providers_refresh_busts_cache():
    ...
    with patch("work4you_cli.models.clear_provider_models_cache") as clear:
