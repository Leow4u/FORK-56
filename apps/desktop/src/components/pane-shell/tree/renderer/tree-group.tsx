        ...
        <div className="relative min-h-0 min-w-0 flex-1 overflow-hidden">
          {isEmpty ? (
            <div className="grid h-full place-items-center">
              ...
              <DecodeText className="text-(--ui-text-quaternary)" cursor prefix={1} text="WORK4YOU" />
            </div>
          ) : (
...
function ZoneDropOverlay({ node }: { node: GroupNode }) {
  ...
  return (
    <div
      ...
      style={{ animation: `work4you-zone-fade ${OVERLAY_FADE_MS}ms linear both` }}
    >
      <div
        className={cn(
          DROP_SHEET_CLASS,
