...
renders natively:
  ...
  * Docs catalog          -> a copy-paste command + a ``work4you://`` deep-link
...
def blueprint_deeplink(blueprint: AutomationBlueprint, values: Optional[Dict[str, Any]] = None) -> str:
    """Build the ``work4you://blueprint/<key>?slot=val`` deep-link URL."""
    ...
    return f"work4you://blueprint/{quote(blueprint.key)}{qs}"
