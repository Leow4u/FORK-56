...
import type { ScrollBoxHandle } from '@work4you/ink'
import { evictInkCaches } from '@work4you/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.WORK4YOU_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
