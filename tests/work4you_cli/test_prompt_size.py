"""Tests for the ``work4you prompt-size`` diagnostic (issue #34667)."""
...
from work4you_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(work4you_home, memory_text="", user_text=""):
    mem_dir = work4you_home / "memories"
...
def _seed_skill(work4you_home, name, description):
    skill_dir = work4you_home / "skills" / "demo" / name
...
def test_runs_offline_without_credentials(isolated_home, monkeypatch):
    ...
    for var in ("OPENROUTER_API_KEY", "OPENAI_API_KEY", "WORK4YOU_API_KEY",
                "ANTHROPIC_API_KEY"):
