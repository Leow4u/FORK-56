...
export const ja: Translations = {
  ...
  status: {
    ...
    updatingWork4You: "Work4You を更新しています…",
  ...
  pluginsPage: {
    ...
    removeConfirm: "このプラグインを ~/.work4you/plugins/ から削除しますか？",
    removeHint: "削除できるのは ~/.work4you/plugins 配下のユーザーがインストールしたプラグインのみです。",
  ...
  skills: {
    ...
    categories: "カテゴリ",
    filters: "フィルター",
    noSkills: "スキルが見つかりません。スキルは ~/.work4you/skills/ から読み込まれます",
