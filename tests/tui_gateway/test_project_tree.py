...
def test_junk_root_never_becomes_an_auto_project():
    ...
    resolve = _resolver(
        {
            "/home/me/.work4you": ("/home/me/.work4you", "/home/me/.work4you"),
            "/www/app": ("/www/app", "/www/app"),
        }
    )
    junk = _session("/home/me/.work4you", branch="main")
...
def test_broad_default_non_git_cwd_stays_unscoped():
    detached = _session("/home/test/.work4you")
    ...
    tree = pt.build_tree(
        ...
        hydrate=True,
        is_junk_cwd=lambda path: path in {"/home/test", "/home/test/.work4you"},
    )
...
def test_deleted_sibling_worktree_folds_into_parent_home_checkout():
    ...
    resolve = _resolver({"/www/work4you": ("/www/work4you", "/www/work4you")})
    sessions = [
        _session("/www/work4you", branch="main"),
    ...
    assert _lane_ids(project) == ["/www/work4you::branch::main"]
    main = project["repos"][0]["groups"][0]
    assert main["isMain"] and main["path"] == "/www/work4you"
