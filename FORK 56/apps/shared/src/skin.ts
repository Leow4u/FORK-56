/**
 * Canonical Work4You skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$WORK4YOU_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`work4you_cli/skin_engine.py`),
 ...
 *   • CLI     → `work4you_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
