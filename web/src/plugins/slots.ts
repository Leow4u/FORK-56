 ...
 * `window.__WORK4YOU_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Work4You brand in the top bar
 ...
 *  `window.__WORK4YOU_PLUGINS__.registerSlot(...)`.
 *
