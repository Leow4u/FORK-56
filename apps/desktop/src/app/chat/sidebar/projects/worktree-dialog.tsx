...
const branchActionLabel = (branch: Work4YouGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<Work4YouGitBranch[]>([])
  ...
  const convert = async (branch: Work4YouGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
