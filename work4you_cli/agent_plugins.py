...
supported components into records consumed by Work4You' existing skill and MCP
...
def _translate_remote(config: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    The returned record targets Work4You' existing URL-based MCP runtime.
...
def has_enabled_agent_plugin_mcp(raw_config: Mapping[str, Any]) -> bool:
    ...
    Directory scanning belongs to :mod:`work4you_cli.plugins` so startup gating
    ...
    from work4you_cli.plugins import has_enabled_agent_plugin_mcp as _probe
