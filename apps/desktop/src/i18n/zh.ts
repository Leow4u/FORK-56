...
export const zh: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      retryingRemoteBackend: '正在重新连接远程 Work4You 后端…',
      startingDesktopConnection: '正在启动桌面连接',
      startingWork4YouDesktop: '正在启动 Work4You 桌面版…'
    },
    errors: {
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed: '桌面后端拒绝了该请求 (405 Method Not Allowed)。请尝试重启 Work4You Desktop。',
  ...
  settings: {
    ...
    plugins: {
      title: '桌面插件',
      blurb:
        '加载到此应用中的界面扩展——随构建捆绑，或放入 desktop-plugins 文件夹（包括 Work4You 编写的插件）。禁用会即时卸载插件并在重启后保持。',
      count: n => `已安装 ${n} 个`,
      openFolder: '打开插件文件夹',
      rescan: '重新扫描',
      reveal: '在文件管理器中显示',
      ...
      agent: {
        ...
        updateBackendToManage: '请更新 Work4You 后端以便在桌面端管理此插件。',
      ...
      installModal: {
        ...
        agentLabel: '智能体插件',
        desktopLabel: '桌面 UI',
        agentTargetLocal: profile => `安装到 ${profile} 后端（~/.work4you/plugins/）`,
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'Work4You 运行时已更新,但桌面应用本身仍是旧构建——在应用更新之前,新的界面功能(如 Bot Mode)不会显示。请运行下方的更新以重新构建应用。如果此警告仍未消除,请从最新的桌面安装程序重新安装。',
      ...
      removeApp: '移除应用',
      removeAppDesc: '从这台电脑卸载桌面应用。你的智能体、对话和设置都会保留。',
      removeAppConfirmTitle: '移除应用？',
      removeAppConfirm: '这会移除桌面应用，并关闭应用以完成卸载。你的智能体、对话和设置都会保留。',
      removeAppWorking: '正在移除…',
      removeAppCancel: '取消',
      removeAppFailed: '无法移除应用。',
      never: '从未',
      justNow: '刚刚',
    ...
    connections: {
      title: '已注册网关',
      intro: '管理本机以及通过远程、SSH 或 Work4You Cloud 连接可访问的每个 Work4You 网关。',
      stagedNote:
      ...
      updateSkippedCloud: '由 Work4You Cloud 托管',
      kindLocal: '本地',
      kindRemote: '远程网关',
      ...
      headersDesc:
        '随发往此网关的每个 HTTP 和 WebSocket 请求一起发送——用于 Cloudflare Access 等访问代理（CF-Access-Client-Id / CF-Access-Client-Secret）。值加密存储。由 Work4You 管理的请求头（Authorization、Cookie、Host 等）会被忽略。',
      ...
      cloudAddHint: '提示：在上方登录 Work4You Cloud 可自动发现你的智能体——此表单仅用于手动注册已知的实例 URL。',
      save: '保存连接',
      saving: '保存中…',
      cancel: '取消',
      empty: '尚未注册任何连接。'
    ...
    gateway: {
      ...
      envOverride: '环境变量覆盖',
      intro:
        'Work4You Desktop 默认会启动自己的本地网关。当你希望此应用控制另一台机器上或可信代理后的现有 Work4You 后端时，可以使用远程网关。网关连接属于本机级设置；profile 是从所连接的网关中发现的。',
      envOverrideTitle: '环境变量正在控制此桌面会话。',
      envOverrideDesc:
        '取消设置 WORK4YOU_DESKTOP_REMOTE_URL 和 WORK4YOU_DESKTOP_REMOTE_TOKEN 后才会使用下面保存的设置。',
      modeTitle: '连接模式',
      localTitle: '本地网关',
      localDesc: '在 localhost 启动私有 Work4You 后端。这是默认方式，并且可离线工作。',
      remoteTitle: '远程网关',
      remoteDesc: '将此桌面外壳连接到远程 Work4You 后端。',
      remoteAuthHint: '托管网关使用 OAuth 或用户名密码；自托管网关也可能使用会话 token。',
      cloudTitle: 'Work4You Cloud',
      cloudDesc: '只需登录 Work4You Cloud 一次，即可从你账户下的智能体中选择——无需粘贴 URL。',
      cloudSignInTitle: 'Work4You Cloud',
      cloudSignIn: '登录 Work4You Cloud',
      cloudSignedIn: '已登录 Work4You Cloud',
      cloudNeedsSignIn: '登录 Work4You Cloud 以发现你账户下的智能体。',
      ...
      cloudNoAgents: {
        ...
        linkText: 'Work4You 门户',
        after: '中创建一个，然后刷新。'
      },
      cloudRefresh: '刷新',
      cloudConnect: '连接',
      cloudConnecting: '正在连接…',
      cloudDiscoverFailed: '无法加载你的 Work4You Cloud 智能体',
      cloudConnectFailed: '无法连接到该智能体',
      cloudSignInFailed: 'Work4You Cloud 登录失败',
      cloudSignedOutTitle: '已退出 Work4You Cloud',
      cloudSignedOutMessage: '已清除 Work4You Cloud 会话。',
      ...
      remoteUrlDesc: '远程 dashboard 后端的基础 URL。支持路径前缀，例如 /work4you。',
      ...
      savedTitle: '网关设置已保存',
      restartingMessage: 'Work4You Desktop 将使用已保存设置重新连接（界面保持打开）。',
      ...
      sshTitle: '通过 SSH 连接',
      sshDesc:
        'Work4You 会通过 SSH 在远程启动并以隧道连接到本应用——无需自行启动或暴露任何服务。前提：已具备到该主机的密钥 SSH 访问。',
      ...
      sshWork4YouPathTitle: 'Work4You 路径（可选）',
      sshWork4YouPathDesc: '远程 work4you 可执行文件的完整路径。留空 = 自动检测。',
      sshWork4YouPathPlaceholder: '自动检测',
      sshTestConnection: '测试 SSH',
      sshConnect: '连接',
      sshButtonsHint: '“保存”将在下次启动时生效，“连接”则立即重新连接。',
      sshReachable: (host, platform) => `可连接：${host}（${platform}）——已找到 Work4You`,
      sshIncompleteHost: '连接前请输入 SSH 主机。',
      sshErrUnreachable: '无法通过 SSH 连接到该主机。请检查主机、端口和网络。',
      sshErrAuth:
        'SSH 认证失败。请将密钥加载到 ssh-agent（ssh-add），或在 ~/.ssh/config 中设置 IdentityFile——Work4You 以非交互方式运行 ssh。',
      sshErrHostKey: '自上次连接以来主机密钥已更改。请确认这是预期的，然后运行 ssh-keygen -R <host> 并重新连接。',
      sshErrNotInstalled:
        '远程主机上未安装 Work4You。请在远程安装（curl -fsSL https://work4you.ai/install.sh | sh）或设置 Work4You 路径。',
      sshErrPlatform: '不支持的远程平台。Work4You Desktop 的 SSH 模式支持 Linux、macOS 和 Windows 远程主机。',
      sshErrTimeout: 'SSH 连接超时。主机可能无法访问或处于休眠状态。',
      sshErrUpdateRequired: '使用 Desktop SSH 连接前，请更新远程主机上的 Work4You。',
    ...
    mcp: {
      ...
      deepLinkDescription:
        '一个链接请求将此 MCP 服务器添加到 Work4You。请检查下方的完整配置——它来自该链接，而非 Work4You。',
    ...
    providers: {
      ...
      localEndpoint: {
        title: '本地 / 自定义端点',
        description: '将 Work4You 指向任意 OpenAI 兼容端点（Zyphra、vLLM、llama.cpp、Ollama 等）。'
      },
      loading: '正在加载提供方...'
    },
    sessions: {
    ...
    toolsets: {
      ...
      useBackend: '使用此后端',
      work4youIncluded: '包含在 Work4You 订阅中；登录 Work4You Portal 即可激活。',
      work4youAuthNeededTitle: '登录 Work4You Portal',
      work4youAuthNeededMessage: provider => `已保存 ${provider}，但在登录 Work4You Portal 之前不会激活。`,
      work4youAuthSignIn: '登录',
      work4youAuthDoneTitle: '已连接 Work4You Portal',
      work4youAuthDoneMessage: '订阅后端现已激活。',
      work4youAuthFailed: 'Work4You Portal 登录未完成',
  ...
  skills: {
    ...
    newSkillCategoryPlaceholder: '分类（可选）',
    edit: '编辑',
    archive: '归档',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: '设置', detail: '配置 Work4You 桌面端' },
    ...
    work4youActiveSessions: (version, count) => `Work4You ${version} · 活跃会话 ${count}`,
    restartGateway: '重启网关',
    openBrowser: '打开浏览器',
  ...
  messaging: {
    ...
    unknown: '未知',
    hintPendingRestart: '重启网关以应用此更改。',
    hintGatewayStopped: '网关已停止——重启网关以建立连接。',
    hintSetupFirst: '在下方填写凭据并保存——保存后频道会开启，并在网关重启后连接。',
    hintEnableToConnect: '凭据已保存。打开该频道，然后重启网关即可连接。',
    restartGateway: '重启网关',
    ...
    telegramQuickSetup: {
      ...
      expiresIn: (value: string) => `将于 ${value} 后过期`,
      expired: '已过期',
      sessionExpired: 'Telegram 配对已过期。请重新开始二维码设置。',
      startFailed: 'Telegram 二维码设置启动失败',
      ready: '就绪',
      allowedUsers: '允许的用户',
      ownerDetected: '已检测到所有者',
      addAtLeastOne: '请至少添加一个 Telegram 用户 ID。',
      userIdPlaceholder: 'Telegram 用户 ID',
      userIdMustBeNumeric: '允许的 Telegram 用户 ID 必须是数字。',
      add: '添加',
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot 用户 ID', placeholder: '@work4you:example.org' },
  ...
  profiles: {
    ...
    inUse: '使用中',
    useProfile: '使用此配置档案',
    personaPlaceholder: '描述这个代理应如何行动。',
    soulOptional: '可选',
    ...
    deleting: '删除中…',
    createDesc: '配置档案是相互独立的 Work4You 环境：各自拥有独立的配置、技能和 SOUL.md。',
    nameLabel: '名称',
    cloneFrom: '克隆来源',
    cloneFromNone: '无（空白）',
  ...
  sidebar: {
    ...
    projects: {
      ...
      worktreeStaleBackend: '请更新 Work4You 后端以在此远程连接上创建工作树 —— 该后端早于 git 工作树 API。',
  ...
  updates: {
    ...
    availableBodyInstaller:
      'Work4You 会在你继续使用时于后台下载此更新。出现「更新」后再点击。应用会短暂关闭，然后以新版本重新打开。',
    availableBodyChrome: '新的 Work4You 应用更新已就绪。会在后台下载并解包——芯片就绪后点“更新”。现有运行时保持不变。',
    updateNow: '立即更新',
    ...
    guiSkewBody:
      '后端已更新，但此桌面应用包未更改。请更新或重新安装 Work4You 桌面应用（你的 AppImage / .deb / .rpm）以保持一致。',
    copy: '复制',
    copied: '已复制',
    done: '完成',
    applyingBody:
    ...
    blockerTitle: '关闭本地预览以更新 Work4You？',
    blockerBody: 'Work4You 需要在更新前停止这些本地预览。这不会修改或删除你的文件。',
    foreignBlockerTitle: '关闭其他进程以更新 Work4You',
    foreignBlockerBody: 'Work4You 无法安全地自动关闭这些进程。请关闭拥有这些进程的应用、终端或服务，然后重试更新。',
    mixedBlockerBody: 'Work4You 可以关闭下方列出的本地预览。其他进程必须手动关闭，更新才能继续。',
  ...
  install: {
    ...
    setupChoiceTitle: '设置 Work4You Desktop',
    setupChoiceDesc: '将此应用连接到你已运行的 Work4You 网关，或在这台电脑上本地安装 Work4You。',
    connectExistingTitle: '连接到现有 Work4You',
    connectExistingShort: '连接现有环境',
    connectExistingDesc: '使用会话令牌或浏览器登录连接远程后端。不会启动本地安装。',
    installLocalTitle: '本地安装 Work4You',
    installLocalDesc: '下载 Work4You，创建 Python 环境，并在这台电脑上运行后端。',
    localStartUnavailable: '无法启动本地安装。请重启 Work4You Desktop 后重试。',
    remoteSetupTitle: '连接到现有 Work4You',
    remoteSetupDesc: '输入网关 URL。Work4You Desktop 会检测需要令牌还是浏览器登录。',
    remoteUrlTitle: '网关 URL',
    remoteUrlDesc: '使用 Work4You 网关的基础 URL；远程地址请包含 https://。',
    remoteUrlPlaceholder: 'https://gateway.example.com/work4you',
    probing: '正在检测网关认证方式...',
    probeError: '无法连接到该 Work4You 网关。',
    identityProvider: '你的身份提供方',
    authTitle: '认证',
    ...
    activeDesc: '这是一次性设置。Work4You 安装器正在下载依赖并配置你的机器。之后启动会跳过此步骤。',
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro 模型需要付费 Work4You 订阅。',
    free: '免费',
    freeTier: '免费层',
  ...
  desktop: {
    ...
    restartToUseSaveImage: '重启 Work4You 桌面版后可使用保存图片。',
    restartToSaveImages: '重启 Work4You 桌面版以保存图片',
