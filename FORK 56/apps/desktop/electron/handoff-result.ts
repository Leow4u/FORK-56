 ...
 * console. It writes WORK4YOU_HOME/.work4you-update-result.json on every exit
 ...
 * ever surfaces, and the user may not reopen Work4You within 30 minutes.
...
export function handoffResultPath(work4youHome: string): string {
  return path.join(work4youHome, '.work4you-update-result.json')
}
...
export function readAndConsumeHandoffResult(
  ...
  const file = handoffResultPath(work4youHome)
  let raw: string
