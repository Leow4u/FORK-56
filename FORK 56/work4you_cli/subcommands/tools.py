"""``work4you tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'work4you tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # work4you tools list [--platform cli]
    ...
    # work4you tools disable <name...> [--platform cli]
    ...
    # work4you tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `work4you tools` runs after you pick a provider that\n"
