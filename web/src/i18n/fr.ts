...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateWork4You: "Mettre à jour Work4You",
    updatingWork4You: "Mise à jour de Work4You…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Work4You (parité avec `work4you plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.work4you/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.work4you/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.work4you/skills/",
