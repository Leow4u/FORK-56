...
Set your Tenor API key in your environment (add to `${WORK4YOU_HOME:-~/.work4you}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/Leow4u/FORK-56/blob/main/skills/media/gif-search/url)`
