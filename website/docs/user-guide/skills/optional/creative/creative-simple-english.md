...
| | |
|---|---|
| Source | Optional — install with `work4you skills install official/creative/simple-english` |
| Path | `optional-skills/creative/simple-english` |
| Version | `1.2.0` |
| Author | AminBlg (https://github.com/AminBlg/SimpleEnglish), ported by Work4You |
| License | MIT |
