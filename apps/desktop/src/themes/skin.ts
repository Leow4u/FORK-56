/**
 * Work4You skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$WORK4YOU_HOME/skins/` (or a
 * built-in) resolved by `work4you_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Work4You authors from a prompt lights up all three surfaces from one file.
 *
 ...
 */
export function skinToDesktopTheme(skin: Work4YouSkin): DesktopTheme | null {
