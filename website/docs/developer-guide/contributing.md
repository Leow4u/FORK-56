...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Work4You — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Work4You! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Work4You core? Start with [Build a Work4You Plugin](../developer-guide/plugins/index.md)
- Building a new built-in core tool for Work4You itself? Start with [Adding Tools](./adding-tools.md)
...
You can also run a fully isolated Work4You instance (throwaway WORK4YOU_HOME, separate Electron
userData, distinct Electron app name to avoid the single-instance lock):

```bash
scripts/dev-sandbox.sh python -m work4you_cli.main
scripts/dev-sandbox.sh --persistent python -m work4you_cli.main desktop  # state survives restarts, but lives in the worktree :)
```
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.work4you/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.work4you` — use `get_work4you_home()` from `work4you_constants` for code paths and `display_work4you_home()` for user-facing messages. See [AGENTS.md](https://github.com/Leow4u/FORK-56/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
Projects built on (or reviewed by) Work4You can keep reviewer checklists inside the repository under `.agents/checks/`. Each file is a focused, plain-markdown checklist that an agent loads before reviewing a change touching the matching area:
...
When you ask Work4You to review a PR in a repository that has `.agents/checks/`, tell it (or teach it via a skill) to read the relevant checklists first and report against them. This gives review agents the project-specific bar that generic review prompts miss.
...
- **Discord**: [work4you.ai](https://work4you.ai)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/Leow4u/FORK-56/blob/main/LICENSE).
