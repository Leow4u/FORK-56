"""Session <-> workspace grouping key (work4you_state.workspace_key).

The key is what `work4you sessions list --workspace` groups/filters on. It is a
...
from work4you_state import workspace_key
