...
def _get_work4you_version() -> str:
    """Return the work4you package version, or 'dev' if unavailable."""
    try:
...
def build_user_agent() -> str:
    ...
    Format::
        ...
        QQBotAdapter/<qqbot_version> (Python/<py_version>; <os>; Work4You/<work4you_version>)

    Example::

        QQBotAdapter/1.0.0 (Python/3.11.15; darwin; Work4You/0.9.0)
    """
    py_version = f"{sys.version_info.major}.{sys.version_info.minor}.{sys.version_info.micro}"
    os_name = platform.system().lower()
    work4you_version = _get_work4you_version()
    return f"QQBotAdapter/{QQBOT_VERSION} (Python/{py_version}; {os_name}; Work4You/{work4you_version})"
