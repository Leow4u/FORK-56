...
def _isolate(tmp_path, monkeypatch):
    """Isolate WORK4YOU_HOME so tests don't touch real config."""
...
def cli_obj(_isolate):
    """Create a minimal Work4YouCLI instance for banner testing."""
    with patch("cli.load_cli_config", return_value={
        ...
        obj = Work4YouCLI.__new__(Work4YouCLI)
        obj.model = "test-model"
        obj.enabled_toolsets = ["work4you-core"]
        obj.compact = False
...
class TestLowContextWarning:
    ...
    def test_warning_for_below_minimum_context(self, cli_obj):
        """Warning shown when context is below Work4You' minimum."""
    ...
    def test_no_warning_at_boundary(self, cli_obj):
        """No warning at exactly Work4You' minimum context length."""
    ...
    def test_no_warning_above_boundary(self, cli_obj):
        """No warning above Work4You' minimum context length."""
