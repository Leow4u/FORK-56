...
import type { SessionInfo, UsageStats } from '@/types/work4you'
...
const COMPOSER_MODEL_KEY = 'work4you.desktop.composer.model'
const COMPOSER_PROVIDER_KEY = 'work4you.desktop.composer.provider'
const COMPOSER_MODEL_SOURCE_KEY = 'work4you.desktop.composer.model-source'
const COMPOSER_EFFORT_KEY = 'work4you.desktop.composer.reasoning-effort'
const COMPOSER_FAST_KEY = 'work4you.desktop.composer.fast'
...
const LAST_SESSION_KEY = 'work4you.desktop.lastSessionId'
const LAST_ROUTE_KEY = 'work4you.desktop.lastRoute'
...
function workspaceCwdKey(connection: Work4YouConnection | null = $connection.get()): string {
...
export async function syncConfiguredDefaultProjectDir(): Promise<string> {
  const settings = window.work4youDesktop?.settings?.getDefaultProjectDir
...
export async function ensureDefaultWorkspaceCwd(): Promise<void> {
  const sanitize = window.work4youDesktop?.sanitizeWorkspaceCwd
...
export const $connection = atom<Work4YouConnection | null>(null)
...
export const setConnection = (next: Updater<Work4YouConnection | null>) => {
...
// until config loads, and re-seeded on every profile switch by useWork4YouConfig.
