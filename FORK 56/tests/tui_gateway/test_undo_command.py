...
def server(work4you_home):
    ...
    # and re-captures module-level paths like _work4you_home against this
...
@pytest.fixture()
def db(work4you_home):
    return SessionDB(db_path=work4you_home / "state.db")
