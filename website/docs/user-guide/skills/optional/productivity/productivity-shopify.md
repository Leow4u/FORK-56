...
| | |
|---|---|
| Source | Optional — install with `work4you skills install official/productivity/shopify` |
...
| Related skills | [`airtable`](/docs/user-guide/skills/optional/productivity/productivity-airtable), [`xurl`](/docs/user-guide/skills/optional/social-media/social-media-xurl) |
...
4. Save to `${WORK4YOU_HOME:-~/.work4you}/.env`:
   ```
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Work4You","productType":"Apparel","tags":["test"]}}'
```
