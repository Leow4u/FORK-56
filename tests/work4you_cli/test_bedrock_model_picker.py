...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (WORK4YOU_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via WORK4YOU_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in WORK4YOU_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from work4you_cli.providers import WORK4YOU_OVERLAYS
        assert "bedrock" in WORK4YOU_OVERLAYS
