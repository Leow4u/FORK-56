...
class TestGetCopilotModelContext:
    ...
    @patch("work4you_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("work4you_cli.models._urlopen_model_catalog_request")
    ...
    @patch("work4you_cli.models.fetch_github_model_catalog", return_value=[])
