"""
A2A (Agent-to-Agent) plugin for Work4You.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes Work4You as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`work4you gateway setup` flow for A2A."""
    ...
    print_info("Expose Work4You as an A2A-discoverable agent and call other A2A agents.")
