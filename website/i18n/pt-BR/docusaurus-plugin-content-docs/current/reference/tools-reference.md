...
| `drive_preview` | Inventaria, clica, escreve e faz scroll na página aberta no painel de pré-visualização. O ponteiro e o teclado são reais; as ações seguintes devolvem só o que mudou. | — |
