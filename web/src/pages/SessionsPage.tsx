...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    work4you_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__work4you_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id), {
          ...
          headers: {
            "X-Work4You-Session-Token":
              (window as unknown as { __WORK4YOU_SESSION_TOKEN__?: string })
                .__WORK4YOU_SESSION_TOKEN__ ?? "",
          },
        });
