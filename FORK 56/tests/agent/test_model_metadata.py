...
class TestDefaultContextLengths:
    ...
    def test_deepseek_v4_models_1m_context(self):
        ...
        # / Work4You Portal) to 1M without probing down to the legacy 128K
...
# =========================================================================
# Work4You Portal context-window resolution (provider="work4you")
# =========================================================================

class TestWork4YouPortalContextResolution:
    """Work4You Portal /v1/models is authoritative for what Work4You infra enforces
    ...
    def test_empty_model_never_fuzzy_matches_endpoint_catalog(self, mock_fetch):
        ...
        the Work4You portal) and poisoned the resolved context length."""
        import agent.model_metadata as mm
        ...
        assert mm._resolve_endpoint_context_length(
            "grok-4.6", "https://inference-api.work4you.ai/v1"
        ) == 500_000
    ...
    def test_stale_cache_is_bypassed_and_overwritten_by_portal(
        ...
        """Users upgrading from pre-fix builds have ``qwen3.6-plus@…work4you… =
