...
class TestCliResumeRestartsWork:
    def test_resume_after_budget_exhaustion_queues_continuation(self, work4you_home):
    ...
    def test_resume_without_goal_queues_nothing(self, work4you_home):
...
class TestGatewayResumeRestartsWork:
    ...
    @pytest.mark.asyncio
    async def test_resume_without_goal_enqueues_nothing(self, work4you_home):
        runner, adapter = _make_runner()
