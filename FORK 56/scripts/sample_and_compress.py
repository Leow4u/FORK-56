...
DEFAULT_DATASETS = [
    "Work4You/swe-terminus-agent-glm-kimi-minimax",
    "Leow4u/FORK-56-megascience-sft1",
    "Leow4u/FORK-56-Thinking-GLM-4.7-SFT2",
    "Leow4u/FORK-56-Thinking-GLM-4.7-SFT1",
    "Work4You/terminal-tasks-glm-work4you"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "Work4You/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload Work4You/{output_name} {final_output}")
