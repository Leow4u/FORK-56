"""
Work4You CLI - Unified command-line interface for Work4You.

Provides subcommands for:
- work4you chat          - Interactive chat (same as ./work4you)
- work4you gateway       - Run gateway in foreground
- work4you gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `work4you setup` on a fresh Pi.
    ...
    work4you_cli/stdio.py::configure_windows_stdio() runs later from the entry
