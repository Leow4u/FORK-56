...
from cli import Work4YouCLI, _build_compact_banner, _rich_text_from_ansi
from work4you_cli.skin_engine import get_active_skin, set_active_skin
...
class TestCompactBannerSkinIntegration:
    ...
    def test_poseidon_compact_banner_uses_skin_branding_instead_of_work4you_work4you(self):
