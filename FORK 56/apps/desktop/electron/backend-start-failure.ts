 ...
 * startWork4You() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startWork4You() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startWork4You`, re-emits
