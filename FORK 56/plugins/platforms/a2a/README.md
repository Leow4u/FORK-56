# A2A — Agent-to-Agent protocol for Work4You
...
peer (another Work4You, LangChain, CrewAI, Google ADK, OpenClaw, …). Stdlib only —
no `a2a-sdk` dependency.

## Enable

```bash
work4you gateway setup      # pick A2A, or:
```
...
When the `a2a` platform is enabled, Work4You serves a v1.0 Agent Card at
...
- Every exchange is logged to `~/.work4you/a2a_audit.jsonl`.
- Conversations persist to `~/.work4you/a2a_conversations/` — they survive context
