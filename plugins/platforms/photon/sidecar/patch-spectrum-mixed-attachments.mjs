...
// `message.content.text` before Work4You can see it. We rewrite the two inbound
...
const MARKER = "Work4You patch: Preserve mixed text + attachment iMessage payloads";
