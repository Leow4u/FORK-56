...
All notable changes to `@work4you/ui` are documented here. Format based on [Keep a Changelog](https://keepachangelog.com/en/1.1.0/).
...
- Storybook autodocs enabled for all components ([#21](https://github.com/Work4You/design-language/pull/21)).

## 0.14.2

### Added

- `Checkbox` component built on Radix primitive ([#20](https://github.com/Work4You/design-language/pull/20)).
...
Versions `0.1.0`–`0.1.3` were published to npm before git tags were added in this repository. See [npm version history](https://www.npmjs.com/package/@work4you/ui?activeTab=versions) for install pins.
