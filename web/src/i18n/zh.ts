...
export const zh: Translations = {
  ...
  status: {
    ...
    updatingWork4You: "正在更新 Work4You…",
  ...
  pluginsPage: {
    ...
    headline: "发现、安装、启用和更新 Work4You 插件（对齐 `work4you plugins` CLI）。",
    ...
    removeConfirm: "从 ~/.work4you/plugins/ 删除此插件？",
    removeHint: "仅可移除用户安装在 ~/.work4you/plugins 下的插件。",
  ...
  skills: {
    ...
    categories: "分类",
    filters: "筛选",
    noSkills: "未找到技能。技能从 ~/.work4you/skills/ 加载",
