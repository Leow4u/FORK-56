...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Work4You gateway adapter.

    Each inbound phone number gets its own Work4You session (multi-tenant).
...
# static dict in work4you_cli/gateway.py, and the _send_sms dispatch in
