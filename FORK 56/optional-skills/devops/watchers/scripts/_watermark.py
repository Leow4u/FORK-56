...
def _state_dir() -> Path:
    ...
    # Default: $WORK4YOU_HOME/watcher-state/, falling back to ~/.work4you/watcher-state/.
    work4you_home = os.environ.get("WORK4YOU_HOME") or str(Path.home() / ".work4you")
    return Path(work4you_home) / "watcher-state"
