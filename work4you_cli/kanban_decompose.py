...
Invoked by ``work4you kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Work4You board.
...
def _profile_author() -> str:
    """Mirror of ``work4you_cli.kanban._profile_author``."""
    return (
