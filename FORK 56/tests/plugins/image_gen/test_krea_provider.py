...
class TestGenerate:
    ...
    def test_aspect_ratio_mapping(self):
        """Work4You 'square' must map to Krea '1:1' in the wire payload."""
        from plugins.image_gen.krea import KreaImageGenProvider
...
# ---------------------------------------------------------------------------
# Managed Work4You gateway path
# ---------------------------------------------------------------------------


def _managed_cfg(
    origin: str = "https://krea-gateway.example.com",
    token: str = "work4you-tok-abc",
):
    ...
    return SimpleNamespace(
        ...
        work4you_user_token=token,
        managed_mode=True,
    )


class TestManagedGateway:
    def test_managed_submit_uses_gateway_origin_and_work4you_token(self, monkeypatch):
        """Managed mode submits to the gateway origin with the Work4You token."""
