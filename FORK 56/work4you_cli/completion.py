"""Shell completion script generation for work4you CLI.
...
_work4you_profiles() {{
    local profiles_dir="$HOME/.work4you/profiles"
...
complete -F _work4you_completion work4you
"""
...
_work4you_profiles() {{
    local -a profiles
    profiles=(default)
    if [[ -d "$HOME/.work4you/profiles" ]]; then
        profiles+=($HOME/.work4you/profiles/*(N/:t))
    fi
...
def generate_fish(parser: argparse.ArgumentParser) -> str:
    ...
    lines: list[str] = [
        ...
        "    echo default",
        "    if test -d $HOME/.work4you/profiles",
        "        for d in $HOME/.work4you/profiles/*/",
        "            basename $d",
        "        end",
        "    end",
        "end",
        ...
        "complete -c work4you -f",
        "",
        "# Complete profile names after -p / --profile",
        "complete -c work4you -f -s p -l profile"
