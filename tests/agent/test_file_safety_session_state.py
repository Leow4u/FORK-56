...
manipulation. Work4You keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point WORK4YOU_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_work4you_home /
    get_default_work4you_root) instead of monkeypatching private helpers —
    ...
    WORK4YOU_HOME=<root>/profiles/<name> makes get_default_work4you_root()
