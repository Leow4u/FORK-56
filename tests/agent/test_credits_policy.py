...
class TestIsFreeTierModel:
    ...
    def test_pricing_cache_peek_zero_priced_model(self, monkeypatch):
        ...
        # The agent holds the /v1-suffixed URL (DEFAULT_WORK4YOU_INFERENCE_URL) —
        # the helper must normalize it down to the picker's cache key.
        base = "https://inference-api.work4you.ai/v1"
        ...
        assert is_free_tier_model("some/zero-priced", "https://inference-api.work4you.ai/") is True
        assert is_free_tier_model("some/zero-priced", "https://inference-api.work4you.ai/v1/") is True
    ...
    def test_exception_fails_open_to_false(self, monkeypatch):
        ...
        assert is_free_tier_model("some/model", "https://inference-api.work4you.ai") is False
