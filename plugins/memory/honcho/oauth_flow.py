...
# The loopback redirect registered for the Work4You OAuth client. IP-literal so
...
def begin_authorization(
    ...
    *,
    ...
    (``work4you-desktop`` / ``work4you-cli``) so the consent side can attribute
...
_CALLBACK_HTML = (
    ...
    b"<div>Connected to Honcho. You can close this tab and return to Work4You.</div>"
)
...
def start_loopback_flow_background(
    *,
    ...
    # the request, where a context-local WORK4YOU_HOME override can't reach.
