...
cd apps/desktop
XCURSOR_SIZE=24 WORK4YOU_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/work4you-typing
# → /tmp/work4you-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/work4you-typing.before.heapsnapshot
# → /tmp/work4you-typing.after.heapsnapshot
```
