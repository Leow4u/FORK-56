# nix/packages.nix — Work4You package built with uv2nix
{ inputs, ... }:
{
  perSystem =
    {
    ...
    let
      ...
      minimal = pkgs.callPackage ./work4you.nix {
    ...
    in
    {
      packages = {
        ...
        tui = full.work4youTui;
        web = full.work4youWeb;
        desktop = full.work4youDesktop;

        update-npm-lockfile = full.work4youNpmLib.updateNpmLockfile;
      };
    };
}
