"""
Tests for mcp_serve — Work4You MCP server.
...
def _isolate_work4you_home(tmp_path, monkeypatch):
    """Redirect WORK4YOU_HOME to a temp directory."""
...
class TestEventBridgePollE2E:
    ...
    def test_poll_picks_up_new_conversation_on_db_change(
        ...
        # _poll_once reads <WORK4YOU_HOME>/state.db for its mtime gate; the autouse
        # fixture points WORK4YOU_HOME at tmp_path.
        db_path = tmp_path / "state.db"
