...
binary download are exercised manually by `work4you secrets bitwarden
...
def work4you_home(tmp_path, monkeypatch):
    """Point Work4You at an isolated home directory."""
    home = tmp_path / ".work4you"
    home.mkdir()
    monkeypatch.setenv("WORK4YOU_HOME", str(home))
    # Some modules cache get_work4you_home; clear if needed.
    import work4you_constants
    if hasattr(work4you_constants, "_WORK4YOU_HOME_CACHE"):
        work4you_constants._WORK4YOU_HOME_CACHE = None  # type: ignore[attr-defined]
    return home
...
def test_install_bws_happy_path(work4you_home, monkeypatch):
