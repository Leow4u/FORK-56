"""AWS Bedrock Converse API adapter for Work4You.
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install Work4You with Bedrock support: pip install -e '.[bedrock]'"
        )
    # converse() / converse_stream() were added in boto3 1.34.59.
    # When Work4You is installed editable into system Python, the system boto3
