...
Before using the pipeline, verify these are set in `${WORK4YOU_HOME:-~/.work4you}/.env`:
...
work4you teams-pipeline fetch --join-web-url "<url>" --organizer-user-id <id>   # organizer-scoped lookup (required for /meet/ short URLs)
```
