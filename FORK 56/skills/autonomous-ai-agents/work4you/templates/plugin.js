/**
 * Work4You desktop plugin template. Save as:
 *   <work4you home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <work4you home> is ~/.work4you by default, or ~/.work4you/profiles/<name>
 * when running a named profile (`work4you -p <name>`). Run `work4you doctor` (or
 ...
 * Only these imports resolve: @work4you/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@work4you/plugin-sdk'
