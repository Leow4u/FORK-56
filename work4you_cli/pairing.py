...
Usage:
    work4you pairing list              # Show all pending + approved users
    work4you pairing approve <platform> <request-id|code>  # Approve a pairing request
    work4you pairing revoke <platform> <user_id> # Revoke user access
    work4you pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle work4you pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: work4you pairing {list|approve|revoke|clear-pending}")
        print("Run 'work4you pairing --help' for details.")
...
def _cmd_list(store):
    ...
    if pending:
        ...
        print("\n  Approve with: work4you pairing approve <platform> <request-id>")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.work4you/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Pairing request or code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'work4you pairing list' to see pending requests.\n")
