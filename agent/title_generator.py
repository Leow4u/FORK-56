...
# Work4You' own machine-authored openers. A compaction handoff or a resumed
...
def _auto_title_enabled() -> bool:
    ...
    try:
        ...
        # from agent code paths where a module-level work4you_cli import risks
...
def auto_title_session(
    ...
    post-``work4you update`` stale-module window, where this function's lazy
    ...
    try:
        ...
        logger.warning(
            ...
            "restart the running Work4You process): %s",
            e,
        )
...
def _is_real_user_turn(message: Any) -> bool:
    ...
    Work4You persists a lot of machinery under ``role="user"`` — compaction
