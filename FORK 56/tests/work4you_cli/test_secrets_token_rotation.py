"""Tests for `work4you secrets bitwarden token` / `work4you secrets onepassword token`.
...
from work4you_cli import onepassword_secrets_cli as op_cli
from work4you_cli import secrets_cli as bw_cli
