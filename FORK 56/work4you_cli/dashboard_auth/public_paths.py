...
* ``work4you_cli.web_server.auth_middleware`` — loopback / ``--insecure``
  mode, gates on the ephemeral ``_SESSION_TOKEN``.
* ``work4you_cli.dashboard_auth.middleware.gated_auth_middleware`` —
...
liveness probe (``work4you-account-service`` ``fly-provider.ts``
