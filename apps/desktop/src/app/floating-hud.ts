...
// hairline `--stroke-work4you` paired with the soft `--shadow-work4you` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-work4you) bg-(--ui-chat-bubble-background) shadow-work4you [-webkit-app-region:no-drag]'
