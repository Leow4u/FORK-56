...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/work4you')).toBe('~/www/work4you')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/work4you')).toBe('work4you')
    expect(pathLeaf('~/www/work4you')).toBe('work4you')
