...
the contract that subsequent turns echo it back; combined with how Work4You
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; Work4You remaps
the retired IDs in ``work4you_cli.model_normalize``.
"""
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave Work4You, so they are not listed here.
    """
