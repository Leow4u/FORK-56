...
test('generated protocol uses work4you profile list, not the invalid profiles plural', () => {
  assert.match(source, /run `work4you profile list` for the LIVE/)
  assert.doesNotMatch(source, /run `work4you profiles list` for the LIVE/)
})
