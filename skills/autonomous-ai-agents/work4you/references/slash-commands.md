...
Registry of record: `work4you_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Work4You config+state snapshots (CLI)
...
/subscription (/upgrade) Work4You plan info (CLI)
/topup                   Work4You balance / billing
/copy [N]                Copy last response to clipboard (CLI)
/paste                   Attach clipboard image (CLI)
/image <path>            Attach a local image file (CLI)
/update                  Update Work4You to latest
/version (/v)            Show version
/debug [work4you|local]      Upload debug report, get shareable links
```
