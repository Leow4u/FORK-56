...
export interface PetInfo {
  ...
  // the Work4You "run" activity state uses the in-place running row).
 ...
 * WORK4YOU_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'work4you.desktop.pet-roam.v1'
