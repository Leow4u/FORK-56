...
class TestStatusEndpointTopology:
    ...
    def _setup_client(self, monkeypatch, _isolate_work4you_home):
        try:
    ...
    def test_profile_names_and_mode_public_when_auth_gated(self, monkeypatch):
        ...
        # Work4You Cloud Portal reads /api/status over the network (a gated bind)
        ...
        try:
            ...
            # alongside work4you_home / gateway_pid.
            assert "gateways" not in data
            assert "work4you_home" not in data
