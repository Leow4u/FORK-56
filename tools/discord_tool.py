...
Only included in the work4you-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Work4You (https://github.com/Leow4u/FORK-56)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_work4you_home() / "cache" / "discord_capabilities.json"
