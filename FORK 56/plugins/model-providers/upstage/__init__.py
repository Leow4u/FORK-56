...
# When the user hasn't picked a reasoning effort, Work4You passes
...
# ON at this effort — matching the "medium (default)" that Work4You' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Work4You' effort vocabulary onto Solar's accepted set. xhigh/max/
