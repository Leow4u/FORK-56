...
Single-user Work4You memory store plugin.
"""
...
class MemoryStore:
    ...
    def __init__(
        ...
        if db_path is None:
            ...
            db_path = str(get_work4you_home() / "memory_store.db")
    ...
    def _init_db(self) -> None:
        ...
        # gracefully on NFS/SMB/FUSE-mounted WORK4YOU_HOME (same issue as
        # state.db / kanban.db — see work4you_state._WAL_INCOMPAT_MARKERS).
