...
``work4you_subprocess_env`` / ``_sanitize_subprocess_env``, which the factory
...
``WORK4YOU_HOME`` or secret-scrub propagation.
...
SCAN_DIRS = ("agent", "work4you_cli", "tools", "gateway", "cron", "tui_gateway")
SCAN_ROOT_FILES = ("cli.py", "work4you_constants.py")
...
ALLOWED_RAW_SPAWN_ENV_FILES = {
    # THE owner module: _sanitize_subprocess_env / work4you_subprocess_env /
