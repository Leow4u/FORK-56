...
part of the bundled-plugins set; a stock work4you install does not see
an "Example" tab in its sidebar. The ``_install_example_plugin`` pytest
fixture in ``tests/work4you_cli/test_web_server.py`` copies this directory
into ``$WORK4YOU_HOME/plugins/example-dashboard/`` and forces the dashboard
