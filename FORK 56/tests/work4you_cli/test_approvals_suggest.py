"""Tests for ``work4you approvals suggest`` (work4you_cli/approvals_suggest.py).

Approval history in Work4You is implied, not ledgered: the session DB
...
from work4you_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
