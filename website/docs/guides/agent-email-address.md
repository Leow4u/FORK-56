...
Ask Work4You to do this for you — the skill contains the full procedure — or do it manually:
...
- [Email gateway adapter](../user-guide/messaging/email.md) — chat with Work4You over email instead
