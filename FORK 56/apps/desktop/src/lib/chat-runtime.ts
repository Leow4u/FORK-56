...
import type { ModelOptionsResponse, SessionInfo } from '@/types/work4you'
 ...
 *
 * Only the leading status prefix (e.g. "Work4You is thinking...") and the
 ...
 *  resolved comment as JSON (Work4YouPrComment shape); a malformed payload falls
