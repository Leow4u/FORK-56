...
Write path is the CLI (``work4you cron notepad <job_id> set <key> <value>``),
...
NOTEPAD_FILE = get_work4you_home().resolve() / "cron" / "notepad.db"
...
def render_notepad_section(job_id: str) -> str:
    ...
    return (
        ...
        f"`work4you cron notepad {job_id} set <key> <value>` "
        f"(also: get/delete/list; `work4you cron notepad {job_id} delete "
