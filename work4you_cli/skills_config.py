...
`work4you skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.work4you/config.yaml under:
...
from work4you_cli.config import cfg_get, load_config, save_config
from work4you_cli.colors import Colors, color
from work4you_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `work4you skills`."""
    from work4you_cli.curses_ui import curses_checklist
