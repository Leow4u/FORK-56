...
* ``work4you_constants.get_work4you_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_work4you_dir so cache writes land under tmp_path."""
    ...
    with patch("work4you_constants.get_work4you_dir", _fake_get):
        yield cache_dir
