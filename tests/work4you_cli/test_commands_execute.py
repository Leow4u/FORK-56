...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`work4you_cli.slash_exec.EXECUTORS`, and
...
from work4you_cli.commands import COMMAND_REGISTRY, resolve_command
from work4you_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
