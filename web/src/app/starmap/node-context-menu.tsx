...
const ARCHIVE_SKILL_DESCRIPTION =
  "The skill is archived and can be restored with `work4you curator restore`.";

/** Fire-and-forget a mutation whose UI already applied optimistically. */
function fireOptimistic(
  action: Promise<void>,
  rollback: () => void,
...
export function NodeContextMenu({
  ...
  // Bumped on profile switch so an in-flight openEdit fetch from profile A
  // can't reopen the editor with A's node content after switching to B.
          ...
          onConfirm={() => {
            ...
            fireOptimistic(
              deleteLearningNode(id).then((res) => {
                ...
                notify({
                  kind: "success",
                  message: "Restorable via work4you curator restore.",
