"""``work4you verify`` subcommand parser.

Follows the pattern of ``work4you_cli/subcommands/doctor.py``: parser built
...
# avoid paying an extra module import on every `work4you` invocation.
...
def build_verify_parser(subparsers, *, cmd_verify: Callable) -> None:
    ...
    verify_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "(or load the saved manifest at .work4you/environment.json), then "
    ...
    verify_parser.add_argument(
        "--save",
        action="store_true",
        help="Save the recipe as .work4you/environment.json in the project",
    )
    verify_parser.add_argument(
        "--skip-start",
        action="store_true",
