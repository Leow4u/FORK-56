---
title: "Work4You — Use, configure, theme, extend, and orchestrate Work4You"
...
# Work4You
Use, configure, theme, extend, and orchestrate Work4You.
...
| Path | `skills/autonomous-ai-agents/work4you` |
| Version | `3.1.0` |
| Author | Work4You + Teknium |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `work4you`, `setup`, `configuration`, `multi-agent`, `spawning`, `cli`, `gateway`, `themes`, `skins`, `desktop-plugins`, `tui-widgets`, `petdex`, `development` |
...
- User documentation: https://work4you.ai/docs/
