...
import { getGlobalModelInfo } from '@/work4you'
...
describe('useModelControls', () => {
  ...
  it('keeps a live session authoritative when Settings saves a new profile default', async () => {
    ...
    result.current.applySavedMainModel('work4you', 'poolside/laguna-xs-2.1:free')
    await result.current.refreshCurrentModel()
    ...
    expect($currentProvider.get()).toBe('work4you')
  ...
  it('preserves a populated model catalog when painting a saved profile default', () => {
    const queryClient = new QueryClient()
    const providers = [{ models: ['tencent/hy3:free'], name: 'Work4You', slug: 'work4you' }]
