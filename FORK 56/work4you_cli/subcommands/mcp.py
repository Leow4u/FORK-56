"""``work4you mcp`` subcommand parser.
...
def build_mcp_parser(subparsers, *, cmd_mcp: Callable) -> None:
    ...
    # flag is omitted, causing `work4you mcp add ...` to fall through to
    # interactive chat.
    ...
    # ── Catalog (Work4You-approved MCPs shipped with the repo) ─────────────────
    mcp_sub.add_parser(
        "picker",
    ...
    mcp_sub.add_parser(
        "catalog",
        help="List Work4You-approved MCPs available for one-click install",
    )
