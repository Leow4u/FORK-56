...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      retryingRemoteBackend: 'Reconnecting to the remote Work4You backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingWork4YouDesktop: 'Starting Work4You Desktop…'
    },
    errors: {
  ...
  billingBlock: {
    titleWork4You: 'Out of Work4You credits',
  ...
  settings: {
    ...
    plugins: {
      ...
      agent: {
        ...
        updateBackendToManage: 'Update the Work4You backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.work4you/plugins/)`,
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The Work4You runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Work4You gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Work4You Cloud',
      kindLocal: 'Local',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Work4You manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Work4You Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Work4You backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset WORK4YOU_DESKTOP_REMOTE_URL and WORK4YOU_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      ...
      remoteDesc: 'Connect this desktop shell to a remote Work4You backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Work4You Cloud',
      cloudDesc: 'Sign in once to Work4You Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Work4You Cloud',
      cloudSignIn: 'Sign in to Work4You Cloud',
      cloudSignedIn: 'Signed in to Work4You Cloud',
      cloudNeedsSignIn: 'Sign in to Work4You Cloud to discover the agents on your account.',
      ...
      cloudNoAgents: {
        ...
        linkText: 'Work4You portal',
        after: ', then refresh.'
      },
      cloudRefresh: 'Refresh',
      cloudConnect: 'Connect',
      cloudConnecting: 'Connecting…',
      cloudDiscoverFailed: 'Could not load your Work4You Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Work4You Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Work4You Cloud',
      cloudSignedOutMessage: 'Cleared the Work4You Cloud session.',
      ...
      restartingMessage: 'Work4You Desktop will reconnect using the saved settings — the shell stays open.',
      ...
      sshDesc:
        'Work4You is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshWork4YouPathTitle: 'Work4You path (optional)',
      sshWork4YouPathDesc: 'Full path to the remote work4you binary. Blank = auto-detect.',
      sshWork4YouPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Work4You found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Work4You runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Work4You is not installed on the remote host. Install it there (curl -fsSL https://work4you.ai/install.sh | sh) or set the Work4You path.',
      sshErrPlatform:
        'Unsupported remote platform. Work4You Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Work4You on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Work4You. Review the exact configuration below — it comes from the link, not from Work4You.',
    ...
    providers: {
      ...
      localEndpoint: {
        ...
        description: 'Point Work4You at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      work4youAuthFailed: 'Work4You Portal sign-in did not complete',
  ...
  skills: {
    ...
    newSkillCategoryPlaceholder: 'Category (optional)',
    edit: 'Edit',
    archive: 'Archive',
  ...
  commandCenter: {
    ...
    work4youActiveSessions: (version, count) => `Work4You ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    unknown: 'Unknown',
    hintPendingRestart: 'Restart the gateway to apply this change.',
    hintGatewayStopped: 'The gateway is stopped — restart it to connect.',
    hintSetupFirst: 'Add the credentials below and save — the channel turns on and connects after a gateway restart.',
    hintEnableToConnect: 'Credentials are saved. Turn the channel on, then restart the gateway to connect.',
    restartGateway: 'Restart gateway',
    ...
    test: 'Test',
    testing: 'Testing...',
    testPassed: name => `${name} test passed`,
    ...
    telegramQuickSetup: {
      ...
      recommended: 'Recommended',
      intro:
        'Scan a QR code and confirm in Telegram — Work4You creates the bot and detects your Telegram user ID automatically. Prefer your own bot? Use the credential fields below instead.',
      ...
      expired: 'Expired',
      sessionExpired: 'Telegram pairing expired. Start a new QR setup to try again.',
      startFailed: 'Telegram QR setup failed to start',
      ready: 'Ready',
      allowedUsers: 'Allowed users',
      ownerDetected: 'Owner detected',
      addAtLeastOne: 'Add at least one Telegram user ID.',
      userIdPlaceholder: 'Telegram user ID',
      userIdMustBeNumeric: 'Allowed Telegram user IDs must be numeric.',
      add: 'Add',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Work4You did not save that model change.'
    },
  ...
  sidebar: {
    ...
    projects: {
      ...
      ideaLabel: 'Idea',
      ideaPlaceholder: "What's this project about?",
      ...
      worktreeStaleBackend:
        'Update the Work4You backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  updates: {
    ...
    availableBodyInstaller:
      'Work4You downloads this update in the background while you keep working. Click Update when it appears. The app closes briefly and reopens updated.',
    availableBodyChrome:
      'A new Work4You app update is ready. It downloads and unpacks in the background — click Update when the chip is ready. Your existing runtime stays in place.',
    updateNow: 'Update now',
    ...
    applyingBodyChrome:
      'Unpacking the desktop shell. This window stays open until that’s ready, then Work4You restarts for a few seconds. Don’t reopen it yourself.',
    applyingBodyBackend:
    ...
    blockerTitle: 'Close local previews to update Work4You?',
    blockerBody:
      'Work4You needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Work4You',
    foreignBlockerBody:
      'Work4You can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Work4You can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    setupChoiceTitle: 'Set up Work4You Desktop',
    setupChoiceDesc:
      'Connect this app to a Work4You gateway you already run, or install Work4You locally on this computer.',
    connectExistingTitle: 'Connect to existing Work4You',
    ...
    installLocalTitle: 'Install Work4You locally',
    ...
    probeError: 'Could not reach that Work4You gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
  ...
  assistant: {
    ...
    mcpSetup: {
      ...
      connectTitle: server => `Connect ${server}?`,
      ...
      loginRequired: 'Sign in to Work4You to connect this app',
