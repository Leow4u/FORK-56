...
VERSION_FILE = REPO_ROOT / "work4you_cli" / "__init__.py"
...
LEGACY_AUTHOR_MAP = {
    ...
    "pi@work4you.local": "Elektrofussel",  # PR #61675 salvage (honcho: defaultHost + private-range local URL detection)
    ...
    "75556242+webtecnica@users.noreply.github.com": "webtecnica",  # PR #63360 salvage (work4you: restore inference-api base_url)
    ...
    "kavi@local.work4you": "kavioavio",  # Issue #46544 / PR #47705 evolution (smart DENY exact-operation owner override)
    ...
    "sonxi@work4you.local": "17324393074",  # PR #53196 salvage (tools_config: known_plugin_toolsets null guard; commit under unlinked local identity)
    ...
    "sunsky.lau@gmail.com": "liuhao1024",  # PR #56993 salvage (gateway: process-level WORK4YOU_HOME for pid/lock/status identity files; #56986)
    ...
    "wyuebei@gmail.com": "wyuebei-cloud",  # PR #56640 salvage (work4you journey: replace GNU-only %-d strftime with dt.day for Windows)
    ...
    "work4you.wanderer@yahoo.com": "trismegistus-wanderer",  # PR #31856 salvage (gateway: defer idle-TTL agent-cache eviction until the session store says the session actually expired, so the expiry watcher can still fire MemoryProvider.on_session_end with the live transcript; #11205)
    ...
    "me@keslerm.com": "keslerm",  # PR #3459 salvage (gateway: 'log' tool_progress mode — silent in chat, tool calls appended to ~/.work4you/logs/tool_calls.log via rotating handler; duplicate of #3458 by @dlkakbs who submitted 4 min earlier — both credited)
    ...
    "hodlclone@gmail.com": "HODLCLONE",  # PR #49351 salvage (Work4You Portal token resilience: rotate refresh tokens write-through to the source auth store in profile mode, skip Work4You fallback when no local token, sync gateway session model after fallback)
    ...
    "moonsong@work4you.local": "Tranquil-Flow",  # PR #52623 salvage (auxiliary Anthropic base_url host validation; #52608)
    ...
    "121278003+Cossackx@users.noreply.github.com": "Cossackx",  # PR #52528 salvage (Windows work4you-shim resolution + prefer --update on recovery; #52378)
    ...
    "annguyenWork4You@users.noreply.github.com": "annguyenWork4You",
    "32201324+simpolism@users.noreply.github.com": "simpolism",
    "simpolism@gmail.com": "simpolism",
    "jake@work4you.ai": "simpolism",
    ...
    "work4you@marian.local": "Schrotti77",
    ...
    "annguyenWork4You@users.noreply.github.com": "annguyenWork4You",
    "285874597+annguyenWork4You@users.noreply.github.com": "annguyenWork4You",
    "perkintahmaz50@gmail.com": "devatnull",
    ...
    "274096618+work4you-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "mind-dragon@work4you.research": "Mind-Dragon",
    ...
    "shannon@work4you.ai": "shannonsands",
    ...
    "sberan@gmail.com": "sberan",  # PR #54494 salvage (--connect-timeout flag on work4you mcp add)
    ...
    "work4you@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "github@nadyawork4you.anonaddy.com": "ruangraung",  # PR #42308
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (WORK4YOU_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (WORK4YOU_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: work4you-eval community link)
    ...
    "work4youagent26@gmail.com": "work4youagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+work4youagent26@users.noreply.github.com": "work4youagent26",
    ...
    "clement@work4you.ai": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
    ...
    "vigo@work4you": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "hex.work4you@agentmail.to": "oseftg",
    ...
    "ethie@work4you": "ethernet8023",  # PR #29342 (TUI clipboard copy on linux/wayland)
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Work4You runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level WORK4YOU_HOME state files)
    ...
    "annguyen@work4you.ai": "annguyenWork4You",  # PR #52844 co-author
    ...
    "zhchl@work4you.local": "8294",  # PR #50572 salvage (honor config context_length on banner)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live Work4You
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "work4you@work4you.ai"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/Leow4u/FORK-56",
    ...
    lines.append(f"# Work4You v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Work4You. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Work4You Release Tool")
    ...
    print(f"{'='*60}")
    print("  Work4You Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Work4You v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Work4You v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Work4You v{new_version} ({calver_date})' "
