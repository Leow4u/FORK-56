...
def work4you_home(tmp_path, monkeypatch):
    ...
    # Bust the goal-module DB cache so it re-resolves WORK4YOU_HOME.
...
@pytest.fixture()
def server(work4you_home, monkeypatch):
    ...
    # Pin config resolution to the isolated WORK4YOU_HOME. Sibling test
    ...
    # module-level ``_work4you_home = get_work4you_home()`` snapshot freezes
    ...
    monkeypatch.setattr(mod, "_work4you_home", work4you_home)
...
def test_moa_bare_returns_usage(server, session, work4you_home):
    _write_moa_config(work4you_home, """
moa:
