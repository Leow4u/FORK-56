...
The run gets a throwaway WORK4YOU_HOME so no local config leaks in, and the
...
os.environ["WORK4YOU_HOME"] = hh
# Strip web-fetch shortcuts: every arm must drive the browser.
os.environ.pop("BROWSER_USE_API_KEY", None)
for k in ("FIRECRAWL_API_KEY", "WORK4YOU_API_KEY", "TAVILY_API_KEY", "SERPER_API_KEY"):
