...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateWork4You: "Work4You aktualisieren",
    updatingWork4You: "Work4You wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    removeConfirm: "Dieses Plugin aus ~/.work4you/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.work4you/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.work4you/skills/ geladen",
