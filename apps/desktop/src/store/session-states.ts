...
import { registryBackendScopeKey } from '@work4you/shared'
...
const TILES_KEY = 'work4you.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'work4you.desktop.sessionTiles.v1'
...
// Dev hook for automation (mirrors __WORK4YOU_LAYOUT_TREE__).
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__WORK4YOU_SESSION_TILES__ = {
