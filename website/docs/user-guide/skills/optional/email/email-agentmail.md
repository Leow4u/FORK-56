...
| | |
|---|---|
| Source | Optional — install with `work4you skills install official/email/agentmail` |
| Path | `optional-skills/email/agentmail` |
| Version | `1.0.0` |
| Author | teyrebaz33, Work4You |
| License | MIT |
...
1. Create a dedicated inbox:
   - Use `create_inbox` with a username (e.g. `work4you`)
   - The agent gets address: `work4you@agentmail.to`
2. Send an email:
