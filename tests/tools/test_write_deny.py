...
class TestWriteDenyExactPaths:
    ...
    def test_work4you_root_env_when_running_under_profile(self, tmp_path, monkeypatch):
        ...
        ``~/.work4you/.env`` (whose credentials are inherited by every profile)
        could be silently overwritten by ``write_file`` while a profile was
        active.
        """
        root = tmp_path / "work4you_root"
        ...
        # Sanity check: WORK4YOU_HOME does point to the profile dir, not the root.
        from work4you_constants import get_work4you_home, get_default_work4you_root
...
class TestWriteAllowed:
    ...
    def test_work4you_control_files_requested_writable(self):
