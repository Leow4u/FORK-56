 ...
 * across theme x background scenes to <tmpdir>/work4you-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@work4you/ink'
...
// The regenerated slate light_colors block from work4you_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/work4you',
...
const setup = (bgHex: string) => {
  process.env.WORK4YOU_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
