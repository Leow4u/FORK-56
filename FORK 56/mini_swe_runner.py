#!/usr/bin/env python3
"""
SWE Runner with Work4You Trajectory Format

A runner that uses Work4You's built-in execution environments
(local, docker, modal) and outputs trajectories in the Work4You format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Work4You's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Work4You format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Work4You format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Work4You's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Work4You Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Work4You's built-in execution environments
    and outputs trajectories in Work4You format.
    """
    ...
    def _convert_to_work4you_format(
        self,
        ...
        """
        Convert internal message format to Work4You trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Work4You trajectory format
        trajectory = self._convert_to_work4you_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Work4You trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Work4You Trajectory Format")
    print("=" * 60)
