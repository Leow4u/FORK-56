...
_SESSION_CWD: ContextVar = ContextVar("WORK4YOU_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the Work4You
    # source tree itself, which is a legitimate workspace when the user is
    # developing Work4You (per-surface policy for fallback-picked directories
