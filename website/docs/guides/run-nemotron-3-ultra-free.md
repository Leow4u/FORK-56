---
sidebar_position: 0
title: "Run Nemotron 3 Ultra free in Work4You"
description: "Try NVIDIA Nemotron 3 Ultra on Work4You Portal — free June 4–18 — with day 0 support in Work4You"
---

# Run Nemotron 3 Ultra free in Work4You

Work4You has been inducted into the **Nemotron Coalition** of leading AI labs working with **NVIDIA** to advance open frontier foundation models. In honor of this, we've partnered with **Nebius** to provide **Nemotron 3 Ultra** free on [Work4You Portal](https://portal.work4you.ai) for two weeks (**June 4th – June 18th**). Follow the instructions below to try the model in your Work4You today.
...
[Download the Work4You Desktop installer](https://work4you.ai/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).

### 2. Connect Work4You Portal

When the app opens, you'll see a "Let's get you set up" screen. Click **Work4You Portal** (marked **Recommended**). Your browser opens — create a [Work4You Portal](https://portal.work4you.ai) account (or sign in), choose the **Free** plan, and authorize Work4You. The app connects automatically.
...
Prefer to review first? Download [`install.sh`](https://work4you.ai/install.sh), inspect it, then run it.
...
Select **Quick Setup**. Work4You opens a browser tab and waits for you to finish the next steps.

### 3. Create a Work4You Portal account

In the browser, create a [Work4You Portal](https://portal.work4you.ai) account (or sign in) and choose the **Free** plan.

### 4. Connect your account

When prompted to connect your account to Work4You, click **Connect**. You'll see a confirmation once it's linked.
...
- **Don't see the model in the list?** Make sure you finished the Work4You Portal connection and that you're on the **Free** plan. In the CLI, `work4you portal info` confirms you're logged in and routing through Work4You.
...
- **[Run Work4You with Work4You Portal](/guides/run-work4you-with-work4you-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
- **[Work4You Portal integration](/integrations/work4you-portal)** — What's in the subscription
