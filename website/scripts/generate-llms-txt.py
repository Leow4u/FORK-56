#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Work4You docs site.
...
LLM reads to learn what Work4You does.

Both publish at:
  https://work4you.ai/docs/llms.txt
  https://work4you.ai/docs/llms-full.txt
...
SITE_BASE = "https://work4you.ai/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Work4You as a Python Library", None),
        ("guides/use-mcp-with-work4you", "Use MCP with Work4You", None),
        ("guides/use-voice-mode-with-work4you", "Use Voice Mode with Work4You", None),
        ("guides/use-soul-with-work4you", "Use SOUL.md with Work4You", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Work4You"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Work4You")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Work4You. A terminal-native "
        ...
        "backends. Works with Work4You Portal, OpenRouter, OpenAI, Anthropic, Google, or any "
        "OpenAI-compatible endpoint."
    )
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/Work4You/"
        "work4you/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/Leow4u/FORK-56")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Work4You — Full Documentation\n",
        (
            "This file is the entire Work4You documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Work4You, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://work4you.ai/docs\n",
        "Short index: https://work4you.ai/docs/llms.txt\n",
        "\n---\n\n",
    ]
