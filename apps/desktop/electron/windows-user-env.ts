...
// even though a fresh shell — and the Work4You CLI — sees it immediately. The
// desktop's WORK4YOU_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\work4you. Reading
...
//       WORK4YOU_HOME    REG_SZ    F:\Work4You\data
//
