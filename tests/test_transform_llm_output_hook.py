...
def _make_enabled_plugin(work4you_home: Path, name: str, register_body: str) -> Path:
    """Create a plugin under <work4you_home>/plugins/<name> and opt it in."""
    plugin_dir = work4you_home / "plugins" / name
...
def test_no_plugins_returns_empty_results(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("WORK4YOU_HOME", str(tmp_path / "work4you_empty"))
