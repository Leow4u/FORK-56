 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `work4you_cli/web_server.py`.
 */
...
/** Light mode — vivid Work4You-blue accents on a cream canvas. */
export const work4youBlueTheme: DashboardTheme = {
  name: "work4you-blue",
  label: "Work4You Blue",
  description: "Light mode — vivid Work4You-blue accents on cream canvas",
  palette: {
