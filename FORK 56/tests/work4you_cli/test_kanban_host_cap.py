...
1. The standalone daemon path (``work4you kanban daemon --force`` /
   :func:`work4you_cli.kanban_db.run_daemon`) never resolved
...
def test_run_daemon_resolves_and_passes_max_in_progress(
    ...
    ``work4you kanban dispatch`` paths both resolved the memory-derived
    default.
    """
    captured: dict = {}
...
def test_nonspawnable_review_does_not_tax_ready_budget(
    ...
    import work4you_cli.config as cfgmod
    import work4you_cli.profiles as profmod
