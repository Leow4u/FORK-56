...
const config: Config = {
  ...
  organizationName: 'Work4You',
  projectName: 'work4you',
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-work4you-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/Leow4u/FORK-56/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Built by <a href="https://work4you.ai">Work4You</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
