...
const FONT_STORAGE_KEY = "work4you-dashboard-font";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Renamed during the LENS_5I port + Work4You-blue rebrand.
  "lens-5i": "work4you-blue",
};
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `work4you_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "work4you-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-work4you-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-work4you-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. Work4You Blue) doesn't leave its values behind when the user
