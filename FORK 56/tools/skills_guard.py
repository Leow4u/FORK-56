...
Trust levels:
  - builtin:   Ships with Work4You. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.work4you/\.env|\~/\.work4you/\.env',
     "work4you_env_access", "critical", "exfiltration",
    ...
    (r'\.work4you/config\.yaml|\.work4you/SOUL\.md',
     "work4you_config_mod", "critical", "persistence",
...
# scan. `.skillignore` is the Work4You-native name; `.clawhubignore` is honored
