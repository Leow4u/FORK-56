...
class TestOfferOpenclawMigration:
    ...
    def test_skips_when_user_declines(self, tmp_path):
        ...
        openclaw_dir.mkdir()
        script = tmp_path / "openclaw_to_work4you.py"
        script.write_text("# placeholder")
        with (
            patch("work4you_cli.setup.Path.home", return_value=tmp_path),
            patch.object(setup_mod, "_OPENCLAW_SCRIPT", script),
            patch.object(setup_mod, "prompt_yes_no", return_value=False),
        ):
            assert setup_mod._offer_openclaw_migration(tmp_path / ".work4you") is False
    ...
    def test_runs_migration_when_user_accepts(self, tmp_path):
        ...
        # Create a fake work4you home with config
        ...
        fake_mod = ModuleType("openclaw_to_work4you")
        ...
        fake_migrator.migrate.return_value = {
            ...
            "output_dir": str(work4you_home / "migration"),
        }
        ...
        with (
            ...
            result = setup_mod._offer_openclaw_migration(work4you_home)
...
class TestSetupWizardOpenclawIntegration:
    ...
    def test_migration_offered_during_first_time_setup(self, tmp_path):
        ...
        with (
            patch.object(setup_mod, "ensure_work4you_home"),
            patch.object(setup_mod, "load_config", return_value={}),
            patch.object(setup_mod, "get_work4you_home", return_value=tmp_path),
...
class TestSetupWizardSkipsConfiguredSections:
    ...
    def test_sections_skipped_when_migration_imported_settings(self, tmp_path):
        ...
        def fake_migration(work4you_home):
        ...
        # vars via work4you_cli.gateway.get_env_value, NOT setup_mod's. Patch
