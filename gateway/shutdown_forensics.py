    ...
    * Wall-clock and monotonic timestamps for cross-correlating later phases
    ...
    try:
        ...
        if work4you_home_str:
            takeover_path = Path(work4you_home_str) / ".gateway-takeover.json"
            if takeover_path.exists():
                try:
                    ...
                    pass
            planned_stop_path = Path(work4you_home_str) / ".gateway-planned-stop.json"
...
def check_systemd_timing_alignment(drain_timeout: float) -> Optional[Dict[str, Any]]:
    ...
    upgraded work4you but never re-ran ``work4you setup`` to regenerate
    ...
    try:
        # /proc/self/cgroup gives us "0::/user.slice/.../work4you-gateway.service"
    ...
    # that's the common case for work4you.
    ...
    # constant in work4you_cli/gateway.py.
    headroom = 30.0
