"""``work4you verify`` — detect a project's run recipe and smoke-test it.
...
``.work4you/environment.json``), then runs bootstrap/build/test phases and an
...
(:mod:`agent.verification_evidence`), so a passing ``work4you verify`` satisfies
