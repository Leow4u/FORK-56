...
def _isolate_env(tmp_path, monkeypatch):
    """Ensure WORK4YOU_HOME and RETAINDB vars are isolated."""
...
class TestRetainDBMemoryProvider:
    ...
    def test_initialize_creates_client_and_queue(self, tmp_path, monkeypatch):
        ...
        p.initialize("test-session", work4you_home=str(tmp_path / ".work4you"))
...
class TestPrefetch:
    ...
    def _make_initialized_provider(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("WORK4YOU_HOME", str(work4you_home))
        p = RetainDBMemoryProvider()
        p.initialize("test-session", work4you_home=str(work4you_home))
        return p
