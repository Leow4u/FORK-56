"""work4you webhook — manage dynamic webhook subscriptions from the CLI.
...
Subscriptions persist to ~/.work4you/webhook_subscriptions.json and are
...
def _subscriptions_path() -> Path:
    return _work4you_home() / _SUBSCRIPTIONS_FILENAME
...
def webhook_command(args):
    """Entry point for 'work4you webhook' subcommand."""
...
def _cmd_subscribe(args):
    ...
    print("  The gateway must be running to receive events (work4you gateway run).\n")
