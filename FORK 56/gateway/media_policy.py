...
from environment variables:
  ...
  - ``WORK4YOU_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``WORK4YOU_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``WORK4YOU_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``work4you cron run`` in the CLI, ``work4you send``, a
...
_STRICT_ENV = "WORK4YOU_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "WORK4YOU_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "WORK4YOU_MEDIA_TRUST_RECENT_FILES"
