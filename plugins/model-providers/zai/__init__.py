...
request omits ``thinking``.  Work4You' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the Work4You reasoning
...
(per Z.AI / BigModel docs).  Work4You' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(reasoning_config: dict | None) -> str | None:
    """Map Work4You reasoning effort onto GLM-5.2's native ``high``/``max``.
