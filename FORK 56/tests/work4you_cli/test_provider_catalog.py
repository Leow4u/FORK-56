"""Tests for the unified provider catalog (work4you_cli.provider_catalog).

These are invariant tests, not snapshots: they assert the parity *contract*
between what ``work4you model`` shows (``CANONICAL_PROVIDERS``) and what the
...
from work4you_cli.provider_catalog import (
    ProviderDescriptor,
    provider_catalog,
