...
const STORAGE_KEY = 'work4you.desktop.layoutTree.v2'

writeKey('work4you.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('work4you.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('work4you.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'work4you.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'work4you.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'work4you.desktop.hiddenStripTabs.v1'
...
writeKey('work4you.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__WORK4YOU_LAYOUT_TREE__ = {
    close: closeTreePane,
