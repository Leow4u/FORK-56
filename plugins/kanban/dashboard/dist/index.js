/**
 * Work4You Kanban — Dashboard Plugin
 *
 * Board view for the multi-agent collaboration board backed by
 * ~/.work4you/kanban.db. Calls the plugin's backend at /api/plugins/kanban/
 * and tails task_events over a WebSocket for live updates.
 *
 * Plain IIFE, no build step. Uses window.__WORK4YOU_PLUGIN_SDK__ for React +
...
(function () {
  ...
  const SDK = window.__WORK4YOU_PLUGIN_SDK__;
  if (!SDK) return;
  ...
  const COLUMN_DOT = {
    triage: "work4you-kanban-dot-triage",
    todo: "work4you-kanban-dot-todo",
    ready: "work4you-kanban-dot-ready",
    running: "work4you-kanban-dot-running",
    blocked: "work4you-kanban-dot-blocked",
    review: "work4you-kanban-dot-review",
    done: "work4you-kanban-dot-done",
    archived: "work4you-kanban-dot-archived",
  };
  ...
  const MIME_TASK = "text/x-work4you-task";
  ...
  const DOCS_URL = "https://work4you.ai/docs/user-guide/features/kanban";
  const DOCS_TUTORIAL_URL = "https://work4you.ai/docs/user-guide/features/kanban-tutorial";
  ...
  const LS_BOARD_KEY = "work4you.kanban.selectedBoard";
  ...
  function renderMarkdown(src) {
    ...
    html = html.replace(/\u0000CODE(\d+)\u0000/g, (_m, i) =>
      `<pre class="work4you-kanban-md-code"><code>${escapeHtml(blocks[Number(i)])}</code></pre>`,
    );
    return html;
  }
  ...
  function sanitizeMarkdownAttrs(tag, attrs) {
    ...
    if (tag === "pre" && /\sclass=(["'])work4you-kanban-md-code\1/i.test(attrs)) {
      return ' class="work4you-kanban-md-code"';
    }
    return "";
  }
  ...
  function MarkdownBlock(props) {
    ...
    if (!enabled) {
      return h("pre", { className: "work4you-kanban-pre" }, props.source || "");
    }
    return h("div", {
      className: "work4you-kanban-md",
  ...
  // standard `drop` event and our `work4you-kanban:drop` event.
  // -------------------------------------------------------------------------
  ...
  function attachTouchDrag(el, taskId) {
    ...
    function onDown(e) {
      ...
      proxy.classList.add("work4you-kanban-touch-proxy");
      ...
      function move(ev) {
        ...
        if (target !== lastTarget) {
          if (lastTarget) lastTarget.classList.remove("work4you-kanban-column--drop");
          if (target) target.classList.add("work4you-kanban-column--drop");
          lastTarget = target;
        }
      }
      function up() {
        ...
        if (lastTarget) {
          lastTarget.classList.remove("work4you-kanban-column--drop");
          const status = lastTarget.getAttribute("data-kanban-column");
          const isTrash = lastTarget.hasAttribute("data-kanban-trash");
          if (isTrash) {
            lastTarget.dispatchEvent(new CustomEvent("work4you-kanban:delete", {
              detail: { taskId },
              bubbles: true,
            }));
          } else if (status) {
            lastTarget.dispatchEvent(new CustomEvent("work4you-kanban:drop", {
  ...
  function KanbanPage() {
    ...
    useEffect(function () {
      ...
      function openWs() {
        ...
        // loopback. Reading window.__WORK4YOU_SESSION_TOKEN__ directly (the old
   ...
   const deleteTask = useCallback(function (taskId) {
    ...
    return h(ErrorBoundary, null,
      h("div", { className: "work4you-kanban flex flex-col gap-4" },
        h(BoardSwitcher, {
          board: board,
          boardList: boardList,
  ...
  function AttentionStrip(props) {
    ...
    return h("div", {
      className: cn(
        "work4you-kanban-attention",
        "work4you-kanban-attention--" + topSev,
      ),
    },
      h("div", { className: "work4you-kanban-attention-bar" },
        h("span", { className: "work4you-kanban-attention-icon" },
          topSev === "critical" ? "!!!" : topSev === "error" ? "!!" : "⚠"),
        h("span", { className: "work4you-kanban-attention-text" },
          diagTasks.length === 1
      ...
      expanded
        ? h("div", { className: "work4you-kanban-attention-list" },
            diagTasks.map(function (task) {
              ...
              return h("div", {
                key: task.id,
                className: cn(
                  "work4you-kanban-attention-row",
                  "work4you-kanban-attention-row--" + sev,
                ),
              },
                h("span", { className: "work4you-kanban-attention-row-sev" },
                  sev === "critical" ? "!!!" : sev === "error" ? "!!" : "⚠"),
                h("span", { className: "work4you-kanban-attention-row-id" }, task.id),
                h("span", { className: "work4you-kanban-attention-row-title" },
                  task.title || tx(t, "untitled", "(untitled)")),
                h("span", { className: "work4you-kanban-attention-row-meta" },
                  task.assignee ? "@" + task.assignee : tx(t, "unassigned", "unassigned"),
                  " \u00b7 ",
                  kinds.length > 0 ? kinds.join(", ") : tx(t, "diagnostic", "diagnostic"),
                ),
                h("button", {
                  className: "work4you-kanban-attention-row-btn",
  ...
  function DiagnosticActionButton(props) {
    ...
    const cls = cn(
      "work4you-kanban-diag-action-btn",
      action.suggested ? "work4you-kanban-diag-action-btn--suggested" : "",
    );
    ...
    return h("span", { className: cls + " work4you-kanban-diag-action-btn--unknown" },
      label);
  }
  ...
  function DiagnosticCard(props) {
    ...
    const execAction = function (action) {
      ...
      if (action.kind === "comment") {
        ...
        const ta = document.querySelector(".work4you-kanban-drawer-comment-row input, .work4you-kanban-drawer-comment-row textarea");
        if (ta) {
    ...
    const sevClass = "work4you-kanban-diag--" + (diag.severity || "warning");
    return h("div", { className: cn("work4you-kanban-diag", sevClass) },
      h("div", { className: "work4you-kanban-diag-header" },
        h("span", { className: "work4you-kanban-diag-sev" },
          diag.severity === "critical" ? "!!!" :
          diag.severity === "error" ? "!!" : "\u26a0"),
        h("span", { className: "work4you-kanban-diag-title" },
          diag.title),
      ),
      h("div", { className: "work4you-kanban-diag-detail" },
        diag.detail),
      diag.data && Object.keys(diag.data).length > 0
        ? h("div", { className: "work4you-kanban-diag-data" },
            Object.keys(diag.data).map(function (k) {
              const v = diag.data[k];
              if (Array.isArray(v) && v.length > 0 && typeof v[0] === "string" &&
                  v[0].indexOf("t_") === 0) {
                // Task-id list — render as chips.
                return h("div", { key: k, className: "work4you-kanban-diag-data-row" },
                  h("span", { className: "work4you-kanban-diag-data-key" }, k + ":"),
                  v.map(function (x) {
                    return h("code", {
                      key: x, className: "work4you-kanban-event-phantom-chip",
                    }, x);
                  }),
                );
              }
              return h("div", { key: k, className: "work4you-kanban-diag-data-row" },
                h("span", { className: "work4you-kanban-diag-data-key" }, k + ":"),
                h("span", { className: "work4you-kanban-diag-data-val" },
      ...
      reassignAction
        ? h("div", { className: "work4you-kanban-diag-reassign-row" },
            h("span", { className: "work4you-kanban-diag-reassign-label" },
              tx(t, "reassignTo", "Reassign to:")),
            h("select", {
              className: "work4you-kanban-recovery-select",
        ...
        : null,
      h("div", { className: "work4you-kanban-diag-actions" },
      ...
      msg
        ? h("div", {
            className: cn(
              "work4you-kanban-diag-msg",
              msg.ok ? "work4you-kanban-diag-msg--ok" : "work4you-kanban-diag-msg--err",
            ),
          }, msg.text)
        : null,
    );
  ...
  function DiagnosticsSection(props) {
    ...
    return h("div", { className: "work4you-kanban-section" },
      h("div", { className: "work4you-kanban-section-head-row" },
        h("span", { className: "work4you-kanban-section-head" },
          hasOpenDiags
            ? h("span", { className: "work4you-kanban-section-head-warning" },
                `\u26a0 ${tx(t, "diagnostics", "Diagnostics")} (${diags.length})`)
            : tx(t, "diagnostics", "Diagnostics"),
        ),
        h("button", {
          className: "work4you-kanban-section-toggle",
          onClick: function () { setOpen(function (x) { return !x; }); },
          type: "button",
        }, open ? tx(t, "hide", "Hide") : tx(t, "show", "Show")),
      ),
      open
        ? h("div", { className: "work4you-kanban-diag-list" },
  ...
  function DocsLink() {
    return h("a", {
      ...
      className: "work4you-kanban-docs-link",
      title: "Open Work4You Kanban docs in a new tab",
      "aria-label": "Work4You Kanban documentation",
    }, "?");
  }
  ...
  function OrchestrationPanel() {
    ...
    // each triage card (or runs `work4you kanban decompose <id>`) and tasks
    ...
    return h(Card, { className: "p-3" },
      h(CardContent, { className: "p-2 flex flex-col gap-3" },
        ...
        msg ? h("div", {
          className: msg.ok ? "work4you-kanban-msg-ok" : "work4you-kanban-msg-err",
        }, msg.text) : null,
  ...
  function BoardSwitcher(props) {
    ...
    if (!shouldShow) {
      return h("div", {
        className: "work4you-kanban-boardswitcher-compact",
    ...
    return h("div", { className: "work4you-kanban-boardswitcher" },
      h("div", { className: "work4you-kanban-boardswitcher-inner" },
  ...
  function NewBoardDialog(props) {
    ...
    return h("div", {
      className: "work4you-kanban-dialog-backdrop",
      onClick: function (e) { if (e.target === e.currentTarget) props.onCancel(); },
    },
      h("form", {
        className: "work4you-kanban-dialog",
        onSubmit: onSubmit,
      },
        h("div", { className: "work4you-kanban-dialog-title" },
        ...
        h("div", { className: "work4you-kanban-dialog-actions" },
          h(Button, {
            type: "button",
  ...
  function BoardToolbar(props) {
    ...
    return h("div", { className: "flex flex-wrap items-end gap-3" },
      ...
      h("div", { className: "flex flex-col gap-1",
                 title: "Filter by assigned Work4You profile. Profiles are the named agent identities that claim and work on tasks." },
  ...
  function BulkActionBar(props) {
    ...
    return h("div", { className: "work4you-kanban-bulk" },
      h("span", { className: "work4you-kanban-bulk-count" },
      ...
      h("div", { className: "work4you-kanban-bulk-priority",
      ...
      h("div", { className: "work4you-kanban-bulk-reassign",
                 title: "Reassign selected tasks to a different Work4You profile. Pick a profile (or unassign) and click Apply." },
        h(Select, Object.assign({
          value: assignee,
          className: "h-7 text-xs",
      ...
      h("label", { className: "work4you-kanban-bulk-reclaim-first", title: "Reclaim any active claims before reassigning" },
        h(Checkbox, {
  ...
  function TrashDropZone(props) {
    ...
    useEffect(function () {
      ...
      el.addEventListener("work4you-kanban:delete", onTouchDelete);
      return function () { el.removeEventListener("work4you-kanban:delete", onTouchDelete); };
    }, [props.onDelete]);
    ...
    return h("div", {
      ...
      className: cn(
        "work4you-kanban-trash",
        dragOver ? "work4you-kanban-trash--drop" : "",
        props.draggingTaskId ? "work4you-kanban-trash--active" : "",
      ),
      onDragOver: handleDragOver,
      onDragLeave: handleDragLeave,
      onDrop: handleDrop,
    },
      h("span", { className: "work4you-kanban-trash-icon" }, "🗑️"),
      h("span", { className: "work4you-kanban-trash-label" },
  ...
  function BoardColumns(props) {
    ...
    const isPanBlockedTarget = useCallback(function (target) {
      ...
      if (target.closest && target.closest(".work4you-kanban-card")) return true;
      if (target.closest && target.closest(".work4you-kanban-column-add")) return true;
      if (target.closest && target.closest(".work4you-kanban-col-check")) return true;
    ...
    const stopPan = useCallback(function () {
      ...
      if (el) {
        ...
        el.classList.remove("work4you-kanban-columns--panning");
        el.style.userSelect = "";
      }
    ...
    const handleMouseDown = useCallback(function (e) {
      ...
      setIsPanning(true);
      el.classList.add("work4you-kanban-columns--panning");
    ...
    const handleDragStart = useCallback(function (e) {
      const card = e.target.closest && e.target.closest(".work4you-kanban-card");
      if (!card) return;
    ...
    return h("div", {
      ref: columnsRef,
      className: cn(
        "work4you-kanban-columns",
        isScrollable ? "work4you-kanban-columns--scrollable" : "",
        isPanning ? "work4you-kanban-columns--panning" : "",
      ),
      onDragStart: handleDragStart,
      onDragEnd: handleDragEnd,
  ...
  function Column(props) {
    ...
    useEffect(function () {
      ...
      el.addEventListener("work4you-kanban:drop", onTouchDrop);
      return function () { el.removeEventListener("work4you-kanban:drop", onTouchDrop); };
    ...
    return h("div", {
      ...
      className: cn(
        "work4you-kanban-column",
        dragOver ? "work4you-kanban-column--drop" : "",
      ),
      onDragOver: handleDragOver,
      onDragLeave: handleDragLeave,
      onDrop: handleDrop,
    },
      h("div", { className: "work4you-kanban-column-header",
                 title: colHelp || "" },
        h(Checkbox, {
          className: "work4you-kanban-col-check",
        ...
        h("span", { className: cn("work4you-kanban-dot", COLUMN_DOT[props.column.name]) }),
        h("span", { className: "work4you-kanban-column-label" },
          colLabel || props.column.name),
        h("span", { className: "work4you-kanban-column-count",
                    title: `${props.column.tasks.length} task${props.column.tasks.length === 1 ? "" : "s"} in this column` },
          props.column.tasks.length),
        h("button", {
          type: "button",
          className: "work4you-kanban-column-add",
          title: tx(t, "createTask", "Create task in this column"),
          onClick: function () { setShowCreate(function (v) { return !v; }); },
        }, showCreate ? "×" : "+"),
      ),
      h("div", { className: "work4you-kanban-column-sub" },
        colHelp || ""),
      ...
      h("div", { className: "work4you-kanban-column-body" },
        props.column.tasks.length === 0
          ? h("div", { className: "work4you-kanban-empty" }, tx(t, "noTasks", "— no tasks —"))
          : lanes
            ? lanes.map(function (lane) {
                return h("div", { key: lane.assignee, className: "work4you-kanban-lane" },
                  h("div", { className: "work4you-kanban-lane-head" },
                    h("span", { className: "work4you-kanban-lane-name" }, lane.assignee),
                    h("span", { className: "work4you-kanban-lane-count" }, lane.tasks.length),
                  ),
  ...
  function stalenessClass(task) {
    ...
    if (age >= tier.red)   return "work4you-kanban-card--stale-red";
    if (age >= tier.amber) return "work4you-kanban-card--stale-amber";
    return "";
  }
  ...
  function TaskCard(props) {
    ...
    const handleDragStart = function (e) {
      ...
      const selectedCards = document.querySelectorAll(".work4you-kanban-card--selected");
      if (selectedCards.length > 1 && props.selected) {
        const ghost = document.createElement("div");
        ghost.className = "work4you-kanban-drag-ghost";
    ...
    return h("div", {
      ...
      "data-task-id": t.id,
      className: cn(
        "work4you-kanban-card",
        props.selected ? "work4you-kanban-card--selected" : "",
        props.failed ? "work4you-kanban-card--failed" : "",
        props.draggingSource ? "work4you-kanban-card--dragging-source" : "",
        stalenessClass(t),
      ),
      draggable: true,
      tabIndex: 0,
      ...
      h(Card, null,
        h(CardContent, { className: "work4you-kanban-card-content" },
          h("div", { className: "work4you-kanban-card-row" },
            h("label", {
              className: "work4you-kanban-card-check-wrap",
              title: tx(i18n, "selectForBulk", "Select for bulk actions"),
              onClick: function (e) { e.stopPropagation(); },
            },
              h(Checkbox, {
                className: "work4you-kanban-card-check",
            ...
            h("span", { className: "work4you-kanban-card-id",
                        title: `Task id: ${t.id}. Use this id with kanban_show, /kanban show, or work4you kanban show.` }, t.id),
            t.warnings && t.warnings.count > 0
              ? h("span", {
                  className: cn(
                    "work4you-kanban-warning-badge",
                    "work4you-kanban-warning-badge--" + (t.warnings.highest_severity || "warning"),
                  ),
                  title: (
            ...
            needsAssignee
              ? h(Badge, {
                  variant: "outline",
                  className: "work4you-kanban-needs-assignee",
          ...
          h("div", { className: "work4you-kanban-card-title" },
            t.title || tx(i18n, "untitled", "(untitled)")),
          h("div", { className: "work4you-kanban-card-row work4you-kanban-card-meta" },
            t.assignee
              ? h("span", { className: "work4you-kanban-assignee",
                            title: `Assigned to Work4You profile @${t.assignee}` }, "@", t.assignee)
              : h("span", { className: "work4you-kanban-unassigned",
                            title: needsAssignee
            ...
            t.comment_count > 0
              ? h("span", { className: "work4you-kanban-count",
            ...
            t.link_counts && (t.link_counts.parents + t.link_counts.children) > 0
              ...
              : null,
            h("span", { className: "work4you-kanban-ago",
  ...
  // centered modal reusing the work4you-kanban-dialog chrome so the form is
  ...
  function InlineCreate(props) {
    ...
    return h("div", {
      ...
      h("form", {
        className: "work4you-kanban-dialog work4you-kanban-create-dialog",
            ...
            h("div", { className: "flex flex-col gap-1 flex-1" },
              ...
              h(Input, {
                ...
                title: props.columnName === "triage"
                  ? "Work4You profile that will spec this task (default: the dispatcher's configured specifier). Leave blank to let the dispatcher pick."
                  : "Work4You profile to assign. Leave blank and the dispatcher will pick from available profiles when the task is Ready.",
  ...
  function TaskDrawer(props) {
    ...
    return h("div", { className: "work4you-kanban-drawer-shade", onClick: props.onClose },
      h("div", {
        className: "work4you-kanban-drawer",
        onClick: function (e) { e.stopPropagation(); },
      },
        h("div", { className: "work4you-kanban-drawer-head" },
          h("span", { className: "text-xs text-muted-foreground" }, props.taskId),
          h("button", {
            type: "button",
            onClick: props.onClose,
            className: "work4you-kanban-drawer-close",
        ...
        data ? h("div", { className: "work4you-kanban-drawer-comment-foot" },
          h("div", {
            className: "work4you-kanban-comment-hint text-xs text-muted-foreground",
          ...
          h("div", { className: "work4you-kanban-drawer-comment-row" },
            h(Input, {
              value: newComment,
  ...
  function AttachmentsSection(props) {
    ...
    return h("div", { className: "work4you-kanban-section" },
      h("div", { className: "work4you-kanban-section-head" },
      ...
      atts.length === 0
        ...
        : atts.map(function (a) {
            return h("div", {
              ...
              h("button", {
                type: "button",
                className: "work4you-kanban-attachment-link truncate",
                title: a.filename,
  ...
  function TaskDetail(props) {
    ...
    return h("div", { className: "work4you-kanban-drawer-body" },
      h("div", { className: "work4you-kanban-drawer-title" },
        h("span", { className: cn("work4you-kanban-dot", COLUMN_DOT[t.status]) }),
        props.editing
          ? h(TitleEditor, {
              initial: t.title || "",
          ...
          : h("span", {
              className: "work4you-kanban-drawer-title-text",
              title: tx(i18n, "clickToEdit", "Click to edit"),
              onClick: function () { props.setEditing(true); },
            }, t.title || tx(i18n, "untitled", "(untitled)")),
      ),
      h("div", { className: "work4you-kanban-drawer-meta" },
      ...
      (function () {
        ...
        if (finalResult) {
          ...
          return h("div", { className: "work4you-kanban-section" },
            h("div", { className: "work4you-kanban-section-head" }, label),
            h(MarkdownBlock, { source: finalResult, enabled: props.renderMarkdown }),
          );
        }
        if (isDone && isParent) {
          return h("div", { className: "work4you-kanban-section" },
            h("div", { className: "work4you-kanban-section-head" }, tx(i18n, "result", "Result")),
            h("div", { className: "work4you-kanban-done-no-result work4you-kanban-done-parent-note" },
        ...
        if (isDone) {
          return h("div", { className: "work4you-kanban-section" },
            h("div", { className: "work4you-kanban-section-head" }, tx(i18n, "result", "Result")),
            h("div", { className: "work4you-kanban-done-no-result" },
      ...
      childResults.length > 0 ? h("div", { className: "work4you-kanban-section" },
        h("div", { className: "work4you-kanban-section-head" },
        ...
        childResults.map(function (child) {
          ...
          return h("div", { key: child.id, className: "work4you-kanban-comment" },
            h("div", { className: "work4you-kanban-comment-head" },
              h("span", { className: "work4you-kanban-comment-author" },
                `${child.id} · ${child.title || tx(i18n, "untitled", "(untitled)")}`),
              h(Badge, { variant: "outline" }, child.status),
              h("button", {
                type: "button",
                className: "work4you-kanban-diag-action-btn",
      ...
      h("div", { className: "work4you-kanban-section" },
        h("div", { className: "work4you-kanban-section-head" },
        ...
        comments.length === 0
          ...
          : comments.map(function (c) {
              return h("div", { key: c.id, className: "work4you-kanban-comment" },
                h("div", { className: "work4you-kanban-comment-head" },
                  h("span", { className: "work4you-kanban-comment-author" }, c.author || "anon"),
                  h("span", { className: "work4you-kanban-comment-ago" },
      ...
      h("div", { className: "work4you-kanban-section" },
        ...
        events.slice().reverse().slice(0, 20).map(function (e) {
          ...
          return h("div", {
            key: e.id,
            className: cn(
              "work4you-kanban-event",
              isDiag ? "work4you-kanban-event--hallucination" : "",
            ),
          },
            isDiag
              ? h("div", { className: "work4you-kanban-event-header" },
                  h("span", { className: "work4you-kanban-event-warning-icon" }, "⚠"),
                  h("span", { className: "work4you-kanban-event-warning-label" },
                    getDiagnosticEventLabel(i18n, e.kind) || e.kind),
                  h("span", { className: "work4you-kanban-event-ago" },
                    timeAgo ? timeAgo(e.created_at) : ""),
                )
              : h("div", { className: "work4you-kanban-event-header-plain" },
                  h("span", { className: "work4you-kanban-event-kind" }, e.kind),
                  h("span", { className: "work4you-kanban-event-ago" },
                    timeAgo ? timeAgo(e.created_at) : ""),
                ),
            isDiag && phantoms.length > 0
              ? h("div", { className: "work4you-kanban-event-phantom-row" },
                  h("span", { className: "work4you-kanban-event-phantom-label" },
                    tx(i18n, "phantomIds", "Phantom ids:")),
                  phantoms.map(function (pid) {
                    return h("code", {
                      key: pid,
                      className: "work4you-kanban-event-phantom-chip",
                    }, pid);
                  }),
                )
              : null,
            e.payload && !isDiag
              ? h("code", { className: "work4you-kanban-event-payload" },
    ...
    return h("div", { className: "work4you-kanban-section" },
      h("div", { className: "work4you-kanban-section-head-row" },
        ...
        !showAll
          ? h("button", {
              type: "button",
              onClick: function () { setExpanded(true); },
              className: "work4you-kanban-edit-link",
      ...
      visible.map(function (r) {
        const outcomeClass = r.ended_at
          ? `work4you-kanban-run--${r.outcome || r.status || "ended"}`
          : "work4you-kanban-run--active";
        return h("div", { key: r.id, className: cn("work4you-kanban-run", outcomeClass) },
          h("div", { className: "work4you-kanban-run-head" },
            h("span", { className: "work4you-kanban-run-outcome" },
              r.ended_at ? (r.outcome || r.status || tx(t, "ended", "ended")) : tx(t, "active", "active")),
            h("span", { className: "work4you-kanban-run-profile" },
              r.profile ? `@${r.profile}` : tx(t, "noProfile", "(no profile)")),
            h("span", { className: "work4you-kanban-run-elapsed" }, fmtElapsed(r)),
            h("span", { className: "work4you-kanban-run-ago" },
              timeAgo ? timeAgo(r.started_at) : ""),
          ),
          r.summary
            ? h("div", { className: "work4you-kanban-run-summary" }, r.summary)
            : null,
          r.error
            ? h("div", { className: "work4you-kanban-run-error" }, r.error)
            : null,
          (r.metadata && Object.keys(r.metadata).length > 0)
            ? (function () {
                ...
                return h("details", {
                    className: "work4you-kanban-run-meta-block",
                    open: !collapsed,
                  },
                  h("summary", { className: "work4you-kanban-run-meta-label" }, "Metadata"),
                  h("code", { className: "work4you-kanban-run-meta" }, json),
                );
              })()
            : null,
        );
  ...
  function WorkerLogSection(props) {
    ...
    if (state.loading) {
      ...
      body = h("pre", { className: "work4you-kanban-pre work4you-kanban-log" },
        data.content || "(empty)");
    }
  ...
  function MetaRow(props) {
    return h("div", { className: "work4you-kanban-meta-row" },
      h("span", { className: "work4you-kanban-meta-label" }, props.label),
      h("span", { className: "work4you-kanban-meta-value" }, props.value),
    );
  }
  ...
  function TitleEditor(props) {
    ...
    return h("div", { className: "work4you-kanban-edit-row" },
      h(Input, {
  ...
  function AssigneeEditor(props) {
    ...
    if (!editing) {
      return h("div", { className: "work4you-kanban-meta-row" },
        h("span", { className: "work4you-kanban-meta-label" }, tx(t, "assignee", "Assignee")),
        h("span", {
          className: "work4you-kanban-meta-value work4you-kanban-editable",
  ...
  function PriorityEditor(props) {
    ...
    if (!editing) {
      return h("div", { className: "work4you-kanban-meta-row" },
        h("span", { className: "work4you-kanban-meta-label" }, tx(t, "priority", "Priority")),
        h("span", {
          className: "work4you-kanban-meta-value work4you-kanban-editable",
          onClick: function () { setEditing(true); },
  ...
  function ModelEditor(props) {
    ...
    if (!editing) {
      return h("div", { className: "work4you-kanban-meta-row" },
        h("span", { className: "work4you-kanban-meta-label" }, tx(t, "model", "Model")),
        h("span", {
          className: cn(
            "work4you-kanban-meta-value work4you-kanban-editable",
    ...
    return h("div", { className: "work4you-kanban-meta-row" },
      h("span", { className: "work4you-kanban-meta-label" }, tx(t, "model", "Model")),
      loading
        ? h("span", { className: "work4you-kanban-meta-value text-muted-foreground" },
  ...
  function BodyEditor(props) {
    ...
    return h("div", { className: "work4you-kanban-section" },
      h("div", { className: "work4you-kanban-section-head-row" },
        h("span", { className: "work4you-kanban-section-head" }, tx(t, "description", "Description")),
        editing
      ...
      editing
        ? h("textarea", {
            className: "work4you-kanban-textarea",
            value: v,
            rows: 8,
            onChange: function (e) { setV(e.target.value); },
          })
  ...
  function DependencyEditor(props) {
    ...
    return h("div", { className: "work4you-kanban-section" },
      h("div", { className: "work4you-kanban-section-head" }, tx(t, "dependencies", "Dependencies")),
      h("div", { className: "work4you-kanban-deps-row" },
        h("span", { className: "work4you-kanban-deps-label" }, tx(t, "parents", "Parents:")),
        h("div", { className: "work4you-kanban-deps-chips" },
          (links.parents || []).length === 0
            ? h("span", { className: "work4you-kanban-deps-empty" }, tx(t, "none", "none"))
            : (links.parents || []).map(function (id) {
                return h("span", { key: id, className: "work4you-kanban-dep-chip" },
                  id,
                  h("button", {
                    type: "button",
                    className: "work4you-kanban-dep-chip-x",
      ...
      h("div", { className: "work4you-kanban-deps-row" },
        h("span", { className: "work4you-kanban-deps-label" }, tx(t, "children", "Children:")),
        h("div", { className: "work4you-kanban-deps-chips" },
  ...
  function StatusActions(props) {
    ...
    return h("div", null,
      h("div", { className: "work4you-kanban-actions" },
        specifyButton,
        decomposeButton,
      ...
      specifyMsg ? h("div", {
        className: specifyMsg.ok
          ? "work4you-kanban-msg-ok"
          : "work4you-kanban-msg-err",
  ...
  function HomeSubsSection(props) {
    ...
    return h("div", { className: "work4you-kanban-section" },
      ...
      h("div", { className: "work4you-kanban-home-subs" },
        channels.map(function (hc) {
          ...
          return h(Button, {
            ...
            className: hc.subscribed
              ? "work4you-kanban-home-sub work4you-kanban-home-sub--on"
              : "work4you-kanban-home-sub",
          }, label);
        })
      )
    );
  ...
  if (window.__WORK4YOU_PLUGINS__ && typeof window.__WORK4YOU_PLUGINS__.register === "function") {
    window.__WORK4YOU_PLUGINS__.register("kanban", KanbanPage);
  }
})();
