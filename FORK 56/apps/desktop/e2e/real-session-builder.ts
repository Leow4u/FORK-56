 ...
 * AIAgent loop, using the E2E mock provider configured in `work4youHome`.
 *
...
export class RealSessionBuilder {
  ...
  private constructor(work4youHome: string) {
  ...
  static async start(work4youHome: string): Promise<RealSessionBuilder> {
    const builder = new RealSessionBuilder(work4youHome)
