...
``$WORK4YOU_HOME/workspace/meetings/node_token.json``. Subsequent boots
...
def _default_token_path() -> Path:
    return Path(get_work4you_home()) / "workspace" / "meetings" / "node_token.json"
...
class NodeServer:
    ...
    def __init__(
        ...
        display_name: str = "work4you-meet-node",
    ) -> None:
        self.host = host
        self.port = port
